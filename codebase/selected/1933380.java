...
public class FieldMetadata extends ClassAspect implements StoredField {
    ...
    public boolean equals(Object obj) {
        ...
        other.alive();
        alive();
        return other._isPrimitive == _isPrimitive && other._fieldType == _fieldType && other._name.equals(_name);
    }
    ...
    private void checkCorrectTypeForField() {
        ...
        if (Handlers4.isUntyped(currentFieldType.typeHandler()) && Handlers4.isUntyped(_fieldType.typeHandler())) {
            return;
        }
