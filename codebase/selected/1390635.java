package net.sf.dsaman.model.arithmetic.lexer;
...
public class Lexer {
    ...
    Token new1(String text, int line, int pos) {
        return new TStringLitteral(text, line, pos);
    }
    ...
    Token new9(int line, int pos) {
        return new TQuestionMark(line, pos);
    }

    Token new10(int line, int pos) {
        return new TQuoteMark(line, pos);
    }
    ...
    Token new15(int line, int pos) {
        return new TOpPlus(line, pos);
    }

    Token new16(int line, int pos) {
        return new TOpMinus(line, pos);
    }

    Token new17(int line, int pos) {
        return new TOpDiv(line, pos);
    }

    Token new18(int line, int pos) {
        return new TOpMult(line, pos);
    }

    Token new19(int line, int pos) {
        return new TOpExp(line, pos);
    }

    Token new20(int line, int pos) {
        return new TRelOpLt(line, pos);
    }

    Token new21(int line, int pos) {
        return new TRelOpLe(line, pos);
    }

    Token new22(int line, int pos) {
        return new TRelOpGt(line, pos);
    }

    Token new23(int line, int pos) {
        return new TRelOpGe(line, pos);
    }

    Token new24(int line, int pos) {
        return new TRelOpEq(line, pos);
    }

    Token new25(int line, int pos) {
        return new TRelOpNe(line, pos);
    }

    Token new26(int line, int pos) {
        return new TStrRelOpEq(line, pos);
    }

    Token new27(int line, int pos) {
        return new TStrRelOpNe(line, pos);
    }

    Token new28(int line, int pos) {
        return new TBoolOpAnd(line, pos);
    }

    Token new29(int line, int pos) {
        return new TBoolOpOr(line, pos);
    }

    Token new30(int line, int pos) {
        return new TBoolOpNot(line, pos);
    }
    ...
    Token new32(int line, int pos) {
        return new TFuncSqrt(line, pos);
    }

    Token new33(int line, int pos) {
        return new TFuncRound(line, pos);
    }

    Token new34(int line, int pos) {
        return new TFuncCeil(line, pos);
    }

    Token new35(int line, int pos) {
        return new TFuncFloor(line, pos);
    }

    Token new36(int line, int pos) {
        return new TFuncMin(line, pos);
    }

    Token new37(int line, int pos) {
        return new TFuncMax(line, pos);
    }

    Token new38(int line, int pos) {
        return new TFuncHas(line, pos);
    }

    Token new39(String text, int line, int pos) {
        return new TIdentifierPath(text, line, pos);
    }
