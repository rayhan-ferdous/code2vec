...
public final class OnHandlerMethodsOrderTest {
    ...
    public void testWithoutTimeout() throws Exception {
        ...
        final IServer server = new Server(hdl, Executors.newCachedThreadPool(new MyThreadFactory()));
    ...
    public void testIdleTimeout() throws Exception {
        ...
        running = 0;
        MyHandler hdl = new MyHandler();
        IServer server = new Server(hdl, Executors.newCachedThreadPool(new MyThreadFactory()));
