...
public class IndexedPropertyDescriptorTest extends TestCase {
    ...
    public void testIndexedPropertyDescriptorStringClassStringStringStringString_WrongArgumentNumber() throws IntrospectionException {
        IndexedPropertyDescriptor ipd = new IndexedPropertyDescriptor("a", DummyClass.class, null, "setAI", "getAI", "setAI");
        assertNotNull(ipd);
    }
    ...
    public void testInCompatibleGetterSetterBean() {
        try {
            new IndexedPropertyDescriptor("data", InCompatibleGetterSetterBean.class);
            fail("should throw IntrospectionException");
        } catch (IntrospectionException e) {
        }
    }
    ...
    public void testEquals_superClass() throws Exception {
        PropertyDescriptor propertyDescriptor = new PropertyDescriptor("data", NormalBean.class);
        IndexedPropertyDescriptor indexedPropertyDescriptor = new IndexedPropertyDescriptor("data", NormalBean.class);
    ...
    public void testIncompatibleGetterAndIndexedGetterBean() {
        try {
            new IndexedPropertyDescriptor("data", IncompatibleGetterAndIndexedGetterBean.class);
            fail("should throw IntrospectionException");
        } catch (IntrospectionException e) {
        }
    }
