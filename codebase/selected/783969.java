...
public class ResourceLocator {
    ...
    private final ThreadLocal<Map<String, ZipFile>> zipContainers = new ThreadLocal<Map<String, ZipFile>>() {
    ...
    private void setNameParts(String name, ResourcePlace rp) {
        ...
        } else if ("wav.raw".equals(type) || "wav".equals(type) || "ogg".equals(type)) {
            rp.type = ResourceType.AUDIO;
        } else if ("sub".equals(type)) {
            rp.type = ResourceType.SUBTITLE;
        } else if ("ani.gz".equals(type)) {
