...
import attacktree.diagram.edit.parts.AttackTreeEditPart;

/**
 * @generated
 */
public class SeaMonsterDiagramEditorUtil {
    ...
    public static boolean openDiagram(Resource diagram) throws PartInitException {
        ...
        page.openEditor(new URIEditorInput(diagram.getURI()), SeaMonsterDiagramEditor.ID);
        return true;
    }
    ...
    public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
        IDialogSettings pluginDialogSettings = SeaMonsterDiagramEditorPlugin.getInstance().getDialogSettings();
    ...
    public static Resource createDiagram(URI diagramURI, IProgressMonitor progressMonitor) {
        ...
        progressMonitor.beginTask(Messages.SeaMonsterDiagramEditorUtil_CreateDiagramProgressTask, 3);
        final Resource diagramResource = editingDomain.getResourceSet().createResource(diagramURI);
        final String diagramName = diagramURI.lastSegment();
        AbstractTransactionalCommand command = new AbstractTransactionalCommand(editingDomain, Messages.SeaMonsterDiagramEditorUtil_CreateDiagramCommandLabel, Collections.EMPTY_LIST) {

            protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
                SeaMonster.AttackTree model = createInitialModel();
                attachModelToResource(model, diagramResource);
                Diagram diagram = ViewService.createDiagram(model, AttackTreeEditPart.MODEL_ID, SeaMonsterDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
                if (diagram != null) {
                ...
                try {
                    diagramResource.save(attacktree.diagram.part.SeaMonsterDiagramEditorUtil.getSaveOptions());
                } catch (IOException e) {
                    SeaMonsterDiagramEditorPlugin.getInstance().logError("Unable to store model and diagram resources", e);
                }
        ...
        try {
            ...
            SeaMonsterDiagramEditorPlugin.getInstance().logError("Unable to create model and diagram", e);
        }
	 ...
	 * @generated
	 */
    private static SeaMonster.AttackTree createInitialModel() {
        return SeaMonster.SeaMonsterFactory.eINSTANCE.createAttackTree();
    }
	 ...
	 * @generated
	 */
    private static void attachModelToResource(SeaMonster.AttackTree model, Resource resource) {
