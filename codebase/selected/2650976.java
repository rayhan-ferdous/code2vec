    ...
    public DotResult result(oWFNet source) {
        ...
        try {
            ...
            if (System.getProperty("os.name", "").toLowerCase().startsWith("windows")) {
                cmd = "lib" + System.getProperty("file.separator") + "plugins" + System.getProperty("file.separator") + "Fiona" + System.getProperty("file.separator") + "fiona.exe " + options + " \"" + owfnFile.getCanonicalPath() + "\"";
            }
