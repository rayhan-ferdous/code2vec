...
import java.util.*;
import com.creditors.vo.TA826VO;
import com.util.comparator.*;
import com.util.table.*;

public class TA826Model implements ITableModel {

    protected TA826VO fTotal;

    protected TA826VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        TA826VO vo = fTableData[fSortOrder[pRow]];
        ...
        if ("esrReferenceNumber".equals(pColumn)) return vo.getEsrReferenceNumber();
        if ("esrCorrectionCode".equals(pColumn)) return vo.getEsrCorrectionCode();
    ...
    public Object getTotalValueAt(String pColumn) {
        if (fTotal != null) {
            ...
            if ("esrCorrectionCode".equals(pColumn)) return fTotal.getEsrCorrectionCode();
