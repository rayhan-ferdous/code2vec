...
import java.util.*;
import com.be.vo.JournalViewVO;
import com.util.comparator.*;
import com.util.table.*;

public class JournalViewModel implements ITableModel {

    protected JournalViewVO fTotal;

    protected JournalViewVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        JournalViewVO vo = fTableData[fSortOrder[pRow]];
