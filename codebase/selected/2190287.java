 ...
 *   less memory than encoding/decoding an entire xmiFile into memory before writing.</li>
 *  <li>v2.2.1 - Fixed bug using URL_SAFE and ORDERED encodings. Fixed bug
 *   when using very small files (~< 40 bytes).</li>
 *  <li>v2.2 - Added some helper methods for encoding/decoding directly from
 *   one xmiFile to the next. Also added a main() method to support command line
 *   encoding/decoding from one xmiFile to the next. Also added these Base64 dialects:
 *   <ol>
 *   <li>The default is RFC3548 format.</li>
 *   <li>Calling Base64.setFormat(Base64.BASE64_FORMAT.URLSAFE_FORMAT) generates
 *   URL and xmiFile name friendly format as described in Section 4 of RFC3548.
 *   http://www.faqs.org/rfcs/rfc3548.html</li>
 *   <li>Calling Base64.setFormat(Base64.BASE64_FORMAT.ORDERED_FORMAT) generates
 *   URL and xmiFile name friendly format that preserves lexical ordering as described
 ...
 *   data in an otherwise "normal" stream (like an XML xmiFile).</li>  
...
public class Base64 {
    ...
    /**
     * Convenience method for encoding data to a xmiFile.
     *
    ...
    /**
     * Convenience method for decoding data to a xmiFile.
     *
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            System.err.println("Error decoding from xmiFile " + filename);
        } finally {
            try {
                bis.close();
            } catch (Exception e) {
    ...
    /**
     * Convenience method for reading a binary xmiFile
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            System.err.println("Error encoding from xmiFile " + filename);
        } finally {
            try {
                bis.close();
            } catch (Exception e) {
     ...
     *
     * @param infile Input xmiFile
     * @param outfile Output xmiFile
