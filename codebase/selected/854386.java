    ...
    static void shape(char text[], StringBuffer string, int level) {
        ...
        while (p < text.length) {
            ...
            if (join == 0) {
                ...
                curchar.lignum++;
            } else if ((join == 3) && (level & ar_lboxfont) != 0) {
                curchar.lignum++;
            } else if (join == 1) {
            }
        }
