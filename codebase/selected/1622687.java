...
import java.util.*;
import com.be.vo.UserVO;
import com.util.comparator.*;
import com.util.table.*;

public class UserModel implements ITableModel {

    protected UserVO fTotal;

    protected UserVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        UserVO vo = fTableData[fSortOrder[pRow]];
