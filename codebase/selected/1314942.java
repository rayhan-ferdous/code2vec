...
public abstract class SupplierAdminPOA extends org.omg.PortableServer.Servant implements org.omg.CORBA.portable.InvokeHandler, SupplierAdminOperations {
    ...
    static final String[] _ob_ids_ = { "IDL:omg.org/CosNotifyChannelAdmin/SupplierAdmin:1.0", "IDL:omg.org/CosNotification/QoSAdmin:1.0", "IDL:omg.org/CosNotifyComm/NotifyPublish:1.0", "IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0", "IDL:omg.org/CosEventChannelAdmin/SupplierAdmin:1.0" };
    ...
    private org.omg.CORBA.portable.OutputStream _OB_op_get_proxy_consumer(org.omg.CORBA.portable.InputStream in, org.omg.CORBA.portable.ResponseHandler handler) {
        ...
        try {
            ...
            ProxyConsumer _ob_r = get_proxy_consumer(_ob_a0);
            out = handler.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _OB_op_obtain_notification_push_consumer(org.omg.CORBA.portable.InputStream in, org.omg.CORBA.portable.ResponseHandler handler) {
        ...
        try {
            ClientType _ob_a0 = ClientTypeHelper.read(in);
            org.omg.CORBA.IntHolder _ob_ah1 = new org.omg.CORBA.IntHolder();
            ProxyConsumer _ob_r = obtain_notification_push_consumer(_ob_a0, _ob_ah1);
            out = handler.createReply();
            ProxyConsumerHelper.write(out, _ob_r);
            ProxyIDHelper.write(out, _ob_ah1.value);
        } catch (AdminLimitExceeded _ob_ex) {
