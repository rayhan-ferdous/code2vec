...
public class FileModel implements ITableModel {

    protected FileVO fTotal;

    protected FileVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        FileVO vo = fTableData[fSortOrder[pRow]];
        ...
        if ("filePath".equals(pColumn)) return vo.getFilePath();
        if ("fileHash".equals(pColumn)) return vo.getFileHash();
        if ("fileLength".equals(pColumn)) return new Long(vo.getFileLength());
    ...
    public Object getTotalValueAt(String pColumn) {
        if (fTotal != null) {
            ...
            if ("filePath".equals(pColumn)) return fTotal.getFilePath();
            if ("fileHash".equals(pColumn)) return fTotal.getFileHash();
            if ("fileLength".equals(pColumn)) return new Long(fTotal.getFileLength());
    ...
    public void sort(String pColumn, String pSortDirection) {
        ...
        if ("fileLength".equals(pColumn)) {
            ...
            long[] temp = new long[fTableData.length];
            for (int i = 0; i < temp.length; i++) {
                temp[i] = fTableData[i].getFileLength();
            }
            fSortOrder = sorter.sortLong(temp, fSortOrder, up);
        }
