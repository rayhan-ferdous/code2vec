 ...
 * 
 */
public class OSGiAppClassLoader extends WebappClassLoader {

    private static org.apache.juli.logging.Log log = org.apache.juli.logging.LogFactory.getLog(OSGiAppClassLoader.class);
	 ...
	 * ClassLoader.
	 */
    public OSGiAppClassLoader(ClassLoader parent) {
        super(parent);
        this.parent = getParent();
        system = getSystemClassLoader();
        securityManager = System.getSecurityManager();
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("OSGiappClassLoader\r\n");
        sb.append("  delegate: ");
        sb.append(delegate);
        sb.append("\r\n");
