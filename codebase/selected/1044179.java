...
import java.util.*;
import com.creditors.vo.PFViewVO;
import com.util.comparator.*;
import com.util.table.*;

public class PFViewModel implements ITableModel {

    protected PFViewVO fTotal;

    protected PFViewVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        PFViewVO vo = fTableData[fSortOrder[pRow]];
