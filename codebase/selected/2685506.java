...
import java.util.*;
import com.be.vo.UserParameterVO;
import com.util.comparator.*;
import com.util.table.*;

public class UserParameterModel implements ITableModel {

    protected UserParameterVO fTotal;

    protected UserParameterVO[] fTableData;
    ...
    public void setData(Object[] data) {
        fTableData = (UserParameterVO[]) data;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        UserParameterVO vo = fTableData[fSortOrder[pRow]];
