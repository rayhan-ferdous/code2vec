...
import cescs.cescsmodel.CescsmodelFactory;
import cescs.cescsmodel.ModelRoot;
import cescs.cescsmodel.diagram.edit.parts.ModelRootEditPart;

/**
 * @generated
 */
public class CescsmodelDiagramEditorUtil {
    ...
    public static boolean openDiagram(Resource diagram) throws PartInitException {
        ...
        page.openEditor(new URIEditorInput(diagram.getURI()), CescsmodelDiagramEditor.ID);
        return true;
    }
    ...
    public static Resource openModel(Shell shell, String description, TransactionalEditingDomain editingDomain) {
        ...
        try {
            ...
            CescsmodelDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + uri, we);
            MessageDialog.openError(shell, Messages.CescsmodelDiagramEditorUtil_OpenModelResourceErrorDialogTitle, NLS.bind(Messages.CescsmodelDiagramEditorUtil_OpenModelResourceErrorDialogMessage, fileName));
        }
        return resource;
    }
    ...
    public static Resource createDiagram(URI diagramURI, URI modelURI, IProgressMonitor progressMonitor) {
        ...
        progressMonitor.beginTask(Messages.CescsmodelDiagramEditorUtil_CreateDiagramProgressTask, 3);
        final Resource diagramResource = editingDomain.getResourceSet().createResource(diagramURI);
        final Resource modelResource = editingDomain.getResourceSet().createResource(modelURI);
        final String diagramName = diagramURI.lastSegment();
        AbstractTransactionalCommand command = new AbstractTransactionalCommand(editingDomain, Messages.CescsmodelDiagramEditorUtil_CreateDiagramCommandLabel, Collections.EMPTY_LIST) {
        ...
        try {
            ...
            CescsmodelDiagramEditorPlugin.getInstance().logError("Unable to create model and diagram", e);
        }
	 ...
	 * @generated
	 */
    private static ModelRoot createInitialModel() {
        return CescsmodelFactory.eINSTANCE.createModelRoot();
    }
	 ...
	 * @generated
	 */
    private static void attachModelToResource(ModelRoot model, Resource resource) {
