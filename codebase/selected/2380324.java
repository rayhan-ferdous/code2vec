    ...
    public PetriNetResult result(PetriNet pn) {
        ...
        try {
            ...
            if (System.getProperty("os.name", "").toLowerCase().startsWith("windows")) {
                path = System.getProperty("user.dir") + System.getProperty("file.separator") + "lib" + System.getProperty("file.separator") + "plugins" + System.getProperty("file.separator") + "Yasper" + System.getProperty("file.separator");
