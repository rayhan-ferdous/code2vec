...
public class DefaultJdbcNameGenerator implements JdbcNameGenerator {
    ...
    public void addTableName(String name) throws IllegalArgumentException {
        if (tableMap.containsKey(name)) {
            throw BindingSupportImpl.getInstance().illegalArgument("Duplicate table name '" + name + "'");
        }
     ...
     * @see #addTableName
     */
    public String generateLinkTableName(String tableName, String fieldName, String elementTableName) {
        String name;
     ...
     */
    public void addPkConstraintName(String tableName, String pkConstraintName) throws IllegalArgumentException {
        if (constraintNames.contains(pkConstraintName)) {
            throw BindingSupportImpl.getInstance().illegalArgument("Duplicate constraint name: " + pkConstraintName);
        }
     ...
     * @throws IllegalArgumentException if it is invalid
     */
    public void addRefConstraintName(String tableName, String refConstraintName) throws IllegalArgumentException {
        if (constraintNames.contains(refConstraintName)) {
            throw BindingSupportImpl.getInstance().illegalArgument("Duplicate constraint name: " + refConstraintName);
        }
     ...
     */
    public String generateRefConstraintName(String tableName, String refTableName, String[] fkNames, String[] refPkNames) {
        int maxlen = maxConstraintNameLength - refConstraintPrefix.length();
        String name = refConstraintPrefix + shrinkName(tableName + wordBreak + refTableName, maxlen);
        String n = name;
        for (int i = 2; constraintNames.contains(n); i++) {
            n = appendInt(name, i, maxConstraintNameLength);
        }
     ...
     *                                  etc.)
     */
    public void addColumnName(String tableName, String columnName) throws IllegalArgumentException {
    ...
    public boolean isColumnInTable(String tableName, String columnName) {
        ...
        if (cols == null) {
            throw BindingSupportImpl.getInstance().internal("isColumnInTable called with unknown table: '" + tableName + "'");
        }
    ...
    protected String addColumnNameImp(String tableName, String columnName) {
        HashSet cols = (HashSet) tableMap.get(tableName);
        if (cols == null) {
            throw BindingSupportImpl.getInstance().internal("addColumnName called with unknown table: '" + tableName + "'");
        }
        if (cols.contains(columnName)) {
            return "Duplicate column name '" + columnName + "' in table '" + tableName + "'";
        }
        cols.add(columnName);
        return null;
    }
     ...
     */
    public String generateFieldColumnName(String tableName, String fieldName, boolean primaryKey) {
     ...
     * multiple columns.
     */
    protected String getColumnNameForFieldName(String fieldName, int col, int i) {
        fieldName = getJdbcName(fieldName);
     ...
     */
    public void generateRefFieldColumnNames(String tableName, String fieldName, String[] columnNames, String refTableName, String[] refPkNames, boolean otherRefs) {
        if (refTableName == null) {
            columnNames[0] = generateFieldColumnName(tableName, fieldName, false);
            return;
        }
        String prefix;
     ...
     * @throws IllegalArgumentException if any existing names are invalid
     */
    public void generatePolyRefFieldColumnNames(String tableName, String fieldName, String[] columnNames) throws IllegalArgumentException {
     ...
     */
    public void generateLinkTableMainRefNames(String tableName, String[] mainTablePkNames, String[] linkMainRefNames) {
     ...
     */
    public void generateLinkTableValueRefNames(String tableName, String[] valuePkNames, String valueClassName, String[] linkValueRefNames, boolean key) {
        ...
        if (valuePkNames == null) {
            ...
            valueBaseName = shrinkName(getJdbcName(valueClassName), maxColumnNameLength);
        }
     ...
     */
    public String generateLinkTableValueName(String tableName, Class valueCls, boolean key) {
