...
import java.util.*;
import com.creditors.vo.TA832VO;
import com.util.comparator.*;
import com.util.table.*;

public class TA832Model implements ITableModel {

    protected TA832VO fTotal;

    protected TA832VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        TA832VO vo = fTableData[fSortOrder[pRow]];
