...
public class LoginModel implements ITableModel {

    protected LoginVO fTotal;

    protected LoginVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        LoginVO vo = fTableData[fSortOrder[pRow]];
