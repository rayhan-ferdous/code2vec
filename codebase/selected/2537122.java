...
import java.util.*;
import com.creditors.vo.PF22VO;
import com.util.comparator.*;
import com.util.table.*;

public class PF22Model implements ITableModel {

    protected PF22VO fTotal;

    protected PF22VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        PF22VO vo = fTableData[fSortOrder[pRow]];
