...
import java.util.*;
import com.debitors.vo.DiscountVO;
...
public class DiscountModel implements ITableModel {
    ...
    public Object getValueAt(int pRow, String pColumn) {
        ...
        if ("discountRate".equals(pColumn)) return new Double(vo.getDiscountRate());
    ...
    public Object getTotalValueAt(String pColumn) {
        if (fTotal != null) {
            ...
            if ("discountRate".equals(pColumn)) return new Double(fTotal.getDiscountRate());
    ...
    public void sort(String pColumn, String pSortDirection) {
        ...
        if ("discountRate".equals(pColumn)) {
            ...
            for (int i = 0; i < temp.length; i++) {
                temp[i] = fTableData[i].getDiscountRate();
            }
