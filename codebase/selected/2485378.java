...
public class NanoHTTPD {
	 ...
	 */
    public NanoHTTPD(int port, String root) throws IOException {
        myTcpPort = port;
        myFileDir = new File(root);
        running = true;
        System.out.println("Starting the Web server on port " + port + " from \"" + myFileDir.getAbsolutePath() + "\"");
        ...
        t.start();
        System.out.println("The Web server is up and running...");
    }
