...
import java.util.*;
import com.be.vo.LedgerHistVO;
import com.util.comparator.*;
import com.util.table.*;

public class LedgerHistModel implements ITableModel {

    protected LedgerHistVO fTotal;

    protected LedgerHistVO[] fTableData;
    ...
    public LedgerHistModel() {
        super();
    }

    public void setData(Object[] data) {
        fTableData = (LedgerHistVO[]) data;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        LedgerHistVO vo = fTableData[fSortOrder[pRow]];
