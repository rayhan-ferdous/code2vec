...
import java.util.*;
import com.creditors.vo.PF32VO;
import com.util.comparator.*;
import com.util.table.*;

public class PF32Model implements ITableModel {

    protected PF32VO fTotal;

    protected PF32VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        PF32VO vo = fTableData[fSortOrder[pRow]];
