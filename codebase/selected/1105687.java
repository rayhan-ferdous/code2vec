...
import java.util.*;
import com.creditors.vo.TA836VO;
import com.util.comparator.*;
import com.util.table.*;

public class TA836Model implements ITableModel {

    protected TA836VO fTotal;

    protected TA836VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        TA836VO vo = fTableData[fSortOrder[pRow]];
        ...
        if ("message3x35".equals(pColumn)) return vo.getMessage3x35();
    ...
    public Object getTotalValueAt(String pColumn) {
        if (fTotal != null) {
            ...
            if ("message3x35".equals(pColumn)) return fTotal.getMessage3x35();
    ...
    public void sort(String pColumn, String pSortDirection) {
        ...
        if ("message3x35".equals(pColumn)) {
            fComparator = new StringComparator();
            String[] temp = new String[fTableData.length];
            for (int i = 0; i < temp.length; i++) {
                temp[i] = fTableData[i].getMessage3x35();
            }
            sort(temp, 0, temp.length - 1, up);
        }
