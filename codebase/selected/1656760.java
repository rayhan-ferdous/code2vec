...
public abstract class TypedConsumerAdminPOA extends org.omg.PortableServer.Servant implements org.omg.CORBA.portable.InvokeHandler, TypedConsumerAdminOperations {
    ...
    static final String[] _ob_ids_ = { "IDL:omg.org/CosTypedNotifyChannelAdmin/TypedConsumerAdmin:1.0", "IDL:omg.org/CosNotifyChannelAdmin/ConsumerAdmin:1.0", "IDL:omg.org/CosNotification/QoSAdmin:1.0", "IDL:omg.org/CosNotifyComm/NotifySubscribe:1.0", "IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0", "IDL:omg.org/CosEventChannelAdmin/ConsumerAdmin:1.0", "IDL:omg.org/CosTypedEventChannelAdmin/TypedConsumerAdmin:1.0" };
    ...
    private org.omg.CORBA.portable.OutputStream _OB_op_obtain_notification_pull_supplier(org.omg.CORBA.portable.InputStream in, org.omg.CORBA.portable.ResponseHandler handler) {
        ...
        try {
            ...
            org.omg.CosNotifyChannelAdmin.ProxySupplier _ob_r = obtain_notification_pull_supplier(_ob_a0, _ob_ah1);
            out = handler.createReply();
            org.omg.CosNotifyChannelAdmin.ProxySupplierHelper.write(out, _ob_r);
    ...
    private org.omg.CORBA.portable.OutputStream _OB_op_obtain_notification_push_supplier(org.omg.CORBA.portable.InputStream in, org.omg.CORBA.portable.ResponseHandler handler) {
        ...
        try {
            org.omg.CosNotifyChannelAdmin.ClientType _ob_a0 = org.omg.CosNotifyChannelAdmin.ClientTypeHelper.read(in);
            org.omg.CORBA.IntHolder _ob_ah1 = new org.omg.CORBA.IntHolder();
            org.omg.CosNotifyChannelAdmin.ProxySupplier _ob_r = obtain_notification_push_supplier(_ob_a0, _ob_ah1);
            out = handler.createReply();
            org.omg.CosNotifyChannelAdmin.ProxySupplierHelper.write(out, _ob_r);
            org.omg.CosNotifyChannelAdmin.ProxyIDHelper.write(out, _ob_ah1.value);
        } catch (org.omg.CosNotifyChannelAdmin.AdminLimitExceeded _ob_ex) {
    ...
    private org.omg.CORBA.portable.OutputStream _OB_op_obtain_typed_notification_pull_supplier(org.omg.CORBA.portable.InputStream in, org.omg.CORBA.portable.ResponseHandler handler) {
        org.omg.CORBA.portable.OutputStream out = null;
        try {
            String _ob_a0 = KeyHelper.read(in);
            org.omg.CORBA.IntHolder _ob_ah1 = new org.omg.CORBA.IntHolder();
            TypedProxyPullSupplier _ob_r = obtain_typed_notification_pull_supplier(_ob_a0, _ob_ah1);
            out = handler.createReply();
    ...
    private org.omg.CORBA.portable.OutputStream _OB_op_obtain_typed_notification_push_supplier(org.omg.CORBA.portable.InputStream in, org.omg.CORBA.portable.ResponseHandler handler) {
        org.omg.CORBA.portable.OutputStream out = null;
        try {
            String _ob_a0 = KeyHelper.read(in);
            org.omg.CORBA.IntHolder _ob_ah1 = new org.omg.CORBA.IntHolder();
            TypedProxyPushSupplier _ob_r = obtain_typed_notification_push_supplier(_ob_a0, _ob_ah1);
            out = handler.createReply();
            TypedProxyPushSupplierHelper.write(out, _ob_r);
            org.omg.CosNotifyChannelAdmin.ProxyIDHelper.write(out, _ob_ah1.value);
    ...
    private org.omg.CORBA.portable.OutputStream _OB_op_obtain_typed_pull_supplier(org.omg.CORBA.portable.InputStream in, org.omg.CORBA.portable.ResponseHandler handler) {
        ...
        try {
            ...
            org.omg.CosTypedEventChannelAdmin.TypedProxyPullSupplier _ob_r = obtain_typed_pull_supplier(_ob_a0);
            out = handler.createReply();
            org.omg.CosTypedEventChannelAdmin.TypedProxyPullSupplierHelper.write(out, _ob_r);
        } catch (org.omg.CosTypedEventChannelAdmin.InterfaceNotSupported _ob_ex) {
            out = handler.createExceptionReply();
            org.omg.CosTypedEventChannelAdmin.InterfaceNotSupportedHelper.write(out, _ob_ex);
        }
