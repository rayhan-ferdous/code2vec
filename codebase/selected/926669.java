 ...
 *@version    $Id: CertificateUtility.java,v 1.2 2004/11/17 21:00:59 jeremycook Exp $
 */
public class CertificateUtility {
	 ...
	 *@return        boolean true if the array contains an ordered chain
	 *               of Subject/Issuer certificates, false otherwise
	 */
    ...
    /**
	  ...
	  *
	  *@param  algorithm      Key algorithm
	  *@param  provider       Provider specification
	  *@param  length         Key length
	  *@return                Unencrypted private/public key pair
	  *@exception  Exception  Description of the Exception
	  */
	 ...
	 *
	 *@param  cert                      byte array containing certificate in
	 *      DER-format
	 *@return                           X509Certificate
	 *@exception  CertificateException  if the byte array does not contain a
	 *      proper certificate.
	 ...
	 *
	 *@param  certstream                Description of the Parameter
	 *@return                           X509Certificate
    ...
    /**
	 *  Reads a certificate in PEM-format from a file. The file may contain
	 *  other things, the first certificate in the file is read.
	 *
	 *@param  certFile                  the file containing the certificate in
	 *      PEM-format
	 *@return                           X509Certificate
	 ...
	 *@exception  CertificateException  if the byte arrayen does not contani a
	 *      correct CRL.
	 *@exception  CRLException          if the byte arrayen does not contani a
	 *      correct CRL.
	 */
	 ...
	 *
	 *@param  dn      String containing DN, The DN string has the format "C=SE,
	 *      O=xx, OU=yy, CN=zz".
	 *@param  dnpart  String specifying which part of the DN to get, should be
	 *      "CN" or "OU" etc.
    ...
    /**
	 *  Imports a X509Certificate in PEM encoding from a file;
	 *
	 *@param  filename       name of the PEM file
	 */
    ...
    /**
	 *  Imports a X509Certificate in PEM encoding from a byte array;
	 *
	 *@param  bytes array containing the contents of the PEM file
	 */
    ...
    /**
	 *  Checks if a certificate is self signed by verifying if subject and
	 *  issuer are the same.
	 *
	 *@param  cert  the certificate that skall be checked.
	 *@return       boolean true if the certificate has the same issuer and
	 ...
	 *
	 *@param  in  Certificate chain to convert
    ...
    /**
	 *  Creates a (Bouncycastle) X509Name object from a string with a DN. <p>
	 *
	 *  Known OID (with order) are: <pre>
    ...
    /**
	 *  Convert a collection of X509Certificates to a corresponding X509Certificate[] chain
	 *
	 *@param  coll  Collection of X509Certificates to convert
    ...
    /**
	 *  Constructor for the CertificateUtility object
	 */
