...
public class DelaunayOverlap extends Delaunay {
    ...
    public DelaunayOverlap(double[][] samples, int lenx, int leny) throws VisADException {
        if (samples.length < 2) {
    ...
    static final double[][] m_samples = { { 65, 142, 215, 315, 373, 435, 39, 118, 202, 320, 373, 455, 40, 114, 206, 307, 384, 457, 66, 128, 208, 308, 380, 436, 83, 144, 201, 293, 354, 433, 60, 135, 202, 285, 355, 456, 59, 136, 204, 284, 362, 456, 75, 138, 207, 285, 363, 438, 90, 153, 217, 292, 358, 441, 61, 145, 216, 292, 366, 452, 55, 143, 213, 295, 373, 463, 80, 148, 217, 295, 375, 444 }, { 67, 87, 103, 104, 72, 42, 122, 148, 160, 165, 156, 109, 212, 211, 203, 200, 204, 211, 282, 263, 248, 243, 256, 287, 166, 187, 201, 207, 185, 155, 230, 235, 240, 241, 235, 210, 283, 275, 270, 267, 273, 280, 338, 310, 299, 297, 305, 331, 247, 270, 277, 276, 265, 233, 295, 319, 325, 322, 306, 281, 368, 371, 368, 362, 372, 376, 464, 431, 417, 418, 424, 455 } };
    ...
    public static void main(String[] argv) throws VisADException {
        ...
        if (!good) System.out.println("Errors in triangulation!"); else System.out.println("Triangulation was constructed correctly.");
    }
}
