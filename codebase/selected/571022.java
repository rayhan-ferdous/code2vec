...
public class TextCursor implements ITextCursor {
	 ...
	 *             if the submitted OpenOffice.org XTextCursor or XTextDocument
	 ...
	 * 
	 * @param mark
	 *            indicates if the space between the current position and the
	 *            end is to be marked
	 * 
	 ...
	 * 
	 * @param range
	 *            the range that specifies where to got
	 * @param mark
	 *            indicates if the space between the current position and the
	 *            new one is to be marked
	 * 
	 * @author Sebastian R�sgen
	 */
	 ...
	 * @param mark
	 *            mark indicates if the space between the current position and
	 *            the new one is to be marked
	 * 
	 * @author Sebastian R�sgen
	 */
	 ...
	 * 
	 * @param stepNumber
	 *            the number of cursor steps to jump
	 * @param mark
	 *            mark indicates if the space between the current position and
	 *            the new one is to be marked
	 * 
    ...
    /**
	 * Returns the page number of the text cursor start, returns -1 if page
	 * number could not be determined.
	 * 
	 * @return the page number of the text cursor start, returns -1 if page
	 *         number could not be determined
	 * 
	 * @author Markus Kr�ger
	 */
	 ...
	 * 
	 * @throws NOAException
	 *             if the text document can not be inserted
	 * 
	 * @author Andreas Br�ker
	 * @date 27.10.2006
	 */
	 ...
	 * 
	 * @param inputStream
	 *            a file stream to be inserted
	 * @param filter
	 *            the filter that the stream is baes on
	 * 
	 * @throws NOAException
	 *             if the file stream can not be inserted
	 * 
	 * @author Markus Kr�ger
	 * @date 24.05.2007
	 */
	 ...
	 * 
	 * @throws NOAException
	 *             if word cursor operations are not supported
	 * 
	 * @author Markus Kr�ger
	 * @date 13.12.2006
	 */
	 ...
	 * 
	 * @throws NOAException
	 *             if sentence cursor operations are not supported
	 * 
	 * @author Markus Kr�ger
	 * @date 13.12.2006
	 */
