...
public class Downloader implements Runnable {
    ...
    public void run() {
        try {
            ...
            fireIOEvent(new IOEvent(this, IOEvent.getUNKNOWN_SIZE(), IOEvent.getUNKNOWN_SIZE(), ioex, Configuration.getResources().getString("ERROR_IMPORTING_FILE") + "\n" + ioex.getLocalizedMessage()));
        }
    }
   ...
   */
    ...
    private static final int MAXIMUM_TEMP_FILE_ATTEMPTS = 0x10000;
