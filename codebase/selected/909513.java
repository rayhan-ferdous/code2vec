...
public class ClientHttpRequest {
    ...
    private static Log logger = new Log(ClientHttpRequest.class);
   ...
   */
    ...
    public static String post(String url, Map parameters) {
        String response = "";
        try {
            InputStream is = post(new URL(url), parameters);
    ...
    public static String post(String url, CustomAuthenticator a) {
        Authenticator.setDefault(a);
        return post(url);
    }

    public static String post(String url, String usr, String pwd) {
        return post(url, new CustomAuthenticator(usr, pwd));
    }
