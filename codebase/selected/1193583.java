...
import java.util.*;
import com.mat.vo.SupplierVO;
import com.util.comparator.*;
import com.util.table.*;

public class SupplierModel implements ITableModel {

    protected SupplierVO fTotal;

    protected SupplierVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        SupplierVO vo = fTableData[fSortOrder[pRow]];
