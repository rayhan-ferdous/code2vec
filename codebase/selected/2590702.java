 ...
 * @generated
 */
public class SetGlobalVariableImpl extends AsteriskActionStepImpl implements SetGlobalVariable {
   ...
   * <!-- end-user-doc -->
    ...
    public SafiCall getCall1() {
        if (call1 != null && call1.eIsProxy()) {
            ...
            if (call1 != oldCall1) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionstepPackage.SET_GLOBAL_VARIABLE__CALL1, oldCall1, call1));
            }
        }
        return call1;
    }
   ...
   * <!-- end-user-doc -->
    ...
    public void setCall1(SafiCall newCall1) {
        ...
        call1 = newCall1;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.SET_GLOBAL_VARIABLE__CALL1, oldCall1, call1));
    }
   ...
   * <!-- end-user-doc -->
    ...
    public void setVariable(String newVariable) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.SET_GLOBAL_VARIABLE__VARIABLE, oldVariable, variable));
    }
