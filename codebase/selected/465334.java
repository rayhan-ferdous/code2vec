...
import java.util.*;
import com.creditors.vo.PF24VO;
import com.util.comparator.*;
import com.util.table.*;

public class PF24Model implements ITableModel {

    protected PF24VO fTotal;

    protected PF24VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        PF24VO vo = fTableData[fSortOrder[pRow]];
        ...
        if ("flagPersonal".equals(pColumn)) return vo.getFlagPersonal();
    ...
    public Object getTotalValueAt(String pColumn) {
        if (fTotal != null) {
            ...
            if ("flagPersonal".equals(pColumn)) return fTotal.getFlagPersonal();
