...
public class LedgerSaldoModel implements ITableModel {

    protected LedgerSaldoVO fTotal;

    protected LedgerSaldoVO[] fTableData;
    ...
    public LedgerSaldoModel() {
        super();
    }

    public void setData(Object[] data) {
        fTableData = (LedgerSaldoVO[]) data;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        LedgerSaldoVO vo = fTableData[fSortOrder[pRow]];
    ...
    public Object getTotalValueAt(String pColumn) {
        if (fTotal != null) {
            ...
            if ("listType".equals(pColumn)) return new Long(fTotal.getListType());
            if ("listSubType".equals(pColumn)) return new Long(fTotal.getListSubType());
    ...
    public void sort(String pColumn, String pSortDirection) {
        ...
        if ("listType".equals(pColumn)) {
            Sorter sorter = new Sorter();
            long[] temp = new long[fTableData.length];
            for (int i = 0; i < temp.length; i++) {
                temp[i] = fTableData[i].getListType();
            }
            fSortOrder = sorter.sortLong(temp, fSortOrder, up);
        }
        if ("listSubType".equals(pColumn)) {
            Sorter sorter = new Sorter();
            long[] temp = new long[fTableData.length];
            for (int i = 0; i < temp.length; i++) {
