package mindmap.diagram.navigator;

import java.util.Iterator;
import mindmap.diagram.part.MindmapDiagramEditorPlugin;
...
public class MindmapNavigatorLinkHelper implements ILinkHelper {
    ...
    public IStructuredSelection findSelection(IEditorInput anInput) {
        IDiagramDocument document = MindmapDiagramEditorPlugin.getInstance().getDocumentProvider().getDiagramDocument(anInput);
        if (document == null) {
