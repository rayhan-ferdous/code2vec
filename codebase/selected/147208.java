...
import java.util.*;
import com.creditors.vo.TA830VO;
import com.util.comparator.*;
import com.util.table.*;

public class TA830Model implements ITableModel {

    protected TA830VO fTotal;

    protected TA830VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        TA830VO vo = fTableData[fSortOrder[pRow]];
        ...
        if ("message4x30".equals(pColumn)) return vo.getMessage4x30();
        if ("instructions4x30".equals(pColumn)) return vo.getInstructions4x30();
    ...
    public Object getTotalValueAt(String pColumn) {
        if (fTotal != null) {
            ...
            if ("message4x30".equals(pColumn)) return fTotal.getMessage4x30();
            if ("instructions4x30".equals(pColumn)) return fTotal.getInstructions4x30();
    ...
    public void sort(String pColumn, String pSortDirection) {
        ...
        if ("message4x30".equals(pColumn)) {
            fComparator = new StringComparator();
            String[] temp = new String[fTableData.length];
            for (int i = 0; i < temp.length; i++) {
                temp[i] = fTableData[i].getMessage4x30();
            }
            sort(temp, 0, temp.length - 1, up);
        }
