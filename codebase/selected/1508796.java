...
import java.util.*;
import com.creditors.vo.ProcessStateVO;
import com.util.comparator.*;
import com.util.table.*;

public class ProcessStateModel implements ITableModel {

    protected ProcessStateVO fTotal;

    protected ProcessStateVO[] fTableData;
    ...
    public ProcessStateModel() {
        super();
    }

    public void setData(Object[] data) {
        fTableData = (ProcessStateVO[]) data;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        ProcessStateVO vo = fTableData[fSortOrder[pRow]];
