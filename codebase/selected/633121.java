...
public class EJBToolNavigatorLinkHelper implements ILinkHelper {
    ...
    public IStructuredSelection findSelection(IEditorInput anInput) {
        IDiagramDocument document = EJBTool.deployment.part.EJBToolDiagramEditorPlugin.getInstance().getDocumentProvider().getDiagramDocument(anInput);
        if (document == null) {
        ...
        if (file != null) {
            EJBTool.deployment.navigator.EJBToolNavigatorItem item = new EJBTool.deployment.navigator.EJBToolNavigatorItem(diagram, file, false);
