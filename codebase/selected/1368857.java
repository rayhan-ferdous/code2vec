...
public class QueryTemplateModel implements ITableModel {

    protected QueryTemplateVO fTotal;

    protected QueryTemplateVO[] fTableData;
    ...
    public QueryTemplateModel() {
        super();
    }

    public void setData(Object[] data) {
        fTableData = (QueryTemplateVO[]) data;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        QueryTemplateVO vo = fTableData[fSortOrder[pRow]];
