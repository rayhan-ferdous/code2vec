...
/**
 * Copied from NBodyForce. We wanted new ranges for the slider.
 * @author Michelle Bachler (m.s.bachler@open.ac.uk)
 */
public class CohereNBodyForce extends AbstractForce {

    private static String[] pnames = new String[] { "GravitationalConstant", "Distance", "BarnesHutTheta" };

    public static final float DEFAULT_GRAV_CONSTANT = -300f;

    public static final float DEFAULT_MIN_GRAV_CONSTANT = -300f;

    public static final float DEFAULT_MAX_GRAV_CONSTANT = -1f;

    public static final float DEFAULT_DISTANCE = -1f;

    public static final float DEFAULT_MIN_DISTANCE = -1f;

    public static final float DEFAULT_MAX_DISTANCE = 300f;
     ...
     * item mass values.
     */
    public CohereNBodyForce(float gravConstant, float minDistance, float theta) {
