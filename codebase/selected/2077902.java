...
public class TableSorter extends TableMap {
    ...
    public int getMappedRow(int aRow) {
        if (aRow < 0 || aRow >= indexes.length) return -1;
        checkModel();
        return indexes[aRow];
    }
    ...
    public void updateHeaderRenderers(JTableHeader tableHeader, TableColumnModel columnModel, int column, boolean ascending) {
        TableColumn col;
        ...
        for (int i = 0; i < cols; i++) {
            ...
            if (renderer instanceof SortedHeaderRenderer) {
                if (i == column) ((SortedHeaderRenderer) renderer).setState(ascending ? SortedHeaderRenderer.SORTED_ASCENDING : SortedHeaderRenderer.SORTED_DESCENDING); else ((SortedHeaderRenderer) renderer).setState(SortedHeaderRenderer.UNSORTED);
            }
        }
        tableHeader.repaint();
    }
