...
public abstract class ObjectUtils {
    ...
    public static boolean isEmpty(Object obj) {
        ...
        if (obj instanceof Long) return (new Long(0).equals((Long) obj));
        if (obj instanceof Double) return (new Double(0).equals((Double) obj));
        if (obj instanceof Collection) return (obj == null || ((Collection) obj).size() <= 0);
        if (obj instanceof Integer) return (new Integer(0).equals((Integer) obj));
        return false;
    }
