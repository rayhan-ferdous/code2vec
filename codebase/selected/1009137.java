...
import java.util.*;
import com.creditors.vo.PF34VO;
import com.util.comparator.*;
import com.util.table.*;

public class PF34Model implements ITableModel {

    protected PF34VO fTotal;

    protected PF34VO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        PF34VO vo = fTableData[fSortOrder[pRow]];
