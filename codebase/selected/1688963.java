...
public abstract class TypedPullSupplierPOA extends org.omg.PortableServer.Servant implements org.omg.CORBA.portable.InvokeHandler, TypedPullSupplierOperations {

    static final String[] _ob_ids_ = { "IDL:omg.org/CosTypedNotifyComm/TypedPullSupplier:1.0", "IDL:omg.org/CosTypedEventComm/TypedPullSupplier:1.0", "IDL:omg.org/CosEventComm/PullSupplier:1.0", "IDL:omg.org/CosNotifyComm/NotifySubscribe:1.0" };

    public TypedPullSupplier _this() {
        return TypedPullSupplierHelper.narrow(super._this_object());
    }

    public TypedPullSupplier _this(org.omg.CORBA.ORB orb) {
        return TypedPullSupplierHelper.narrow(super._this_object(orb));
    }
