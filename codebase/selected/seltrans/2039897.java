...
private   boolean   onXPOrEarlier  =  System  .  getProperty  (  "os.name"  )  .  toUpperCase  (  )  .  indexOf  (  "XP"  )  !=  -  1  ||  System  .  getProperty  (  "os.name"  )  .  indexOf  (  "2000"  )  !=  -  1  ; 
...
try  { 
rt  .  exec  (  "java -cp "  +  autoUpdateJar  +  " com.rendion.ajl.AutoUpdater"  )  ; 
}  catch  (  Exception   e  )  { 
try  { 
deleteFile  (  autoUpdateJar  )  ; 
}  catch  (  Exception   e1  )  { 
...
attachTo  (  onWindows  ?  TASK_LIST  :  PS_CMD  ,  new   String  [  ]  {  }  ,  false  ,  out  )  ; 
int   waits  =  0  ; 
...
int   nextLineIndex  =  output  .  substring  (  prevLineIndex  +  1  )  .  indexOf  (  "\n"  )  ; 
String   line  =  output  .  substring  (  prevLineIndex  +  1  ,  prevLineIndex  +  1  +  nextLineIndex  )  ; 
lines  .  add  (  line  )  ; 
index  =  output  .  indexOf  (  appProps  .  processKey  ,  nextLineIndex  )  ; 
} 
for  (  int   i  =  0  ;  i  <  lines  .  size  (  )  ;  i  ++  )  { 
lines  .  set  (  i  ,  parsePIDFromPSLine  (  (  String  )  lines  .  get  (  i  )  ,  1  )  )  ; 
} 
...
String   line  =  null  ; 
while  (  (  line  =  br  .  readLine  (  )  )  !=  null  )  if  (  output  !=  null  )  { 
...
frame  .  setSize  (  378  ,  onXPOrEarlier  ?  140  :  133  )  ; 
