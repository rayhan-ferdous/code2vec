...
import   java  .  util  .  *  ; 
import   com  .  be  .  vo  .  LedgerRelationVO  ; 
import   com  .  util  .  comparator  .  *  ; 
import   com  .  util  .  table  .  *  ; 

public   class   LedgerRelationModel   implements   ITableModel  { 

protected   LedgerRelationVO   fTotal  ; 

protected   LedgerRelationVO  [  ]  fTableData  ; 
...
public   LedgerRelationModel  (  )  { 
super  (  )  ; 
} 

public   void   setData  (  Object  [  ]  data  )  { 
fTableData  =  (  LedgerRelationVO  [  ]  )  data  ; 
...
LedgerRelationVO   vo  =  fTableData  [  fSortOrder  [  pRow  ]  ]  ; 
