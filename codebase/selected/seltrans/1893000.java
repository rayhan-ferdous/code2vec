...
public   void   run  (  )  { 
if  (  !  isScaled  )  setImageBitmap  (  bm  )  ;  else   setImageBitmap  (  Bitmap  .  createScaledBitmap  (  bm  ,  width  ,  height  ,  true  )  )  ; 
isDone  =  true  ; 
} 
}  ; 
...
if  (  hasDefaultIcon  )  return   BitmapFactory  .  decodeResource  (  getResources  (  )  ,  defaultIcon  )  ;  else   return   BitmapFactory  .  decodeResource  (  getResources  (  )  ,  R  .  drawable  .  icon  )  ; 
} 
...
if  (  !  isCancelled  )  activity  .  runOnUiThread  (  pinta  )  ; 
} 
} 
