...
static   final   int   MAX_BYTES_PER_SECOND  =  150  ; 
...
public   static   void   start  (  File   rootDir  )  throws   IOException  { 
if  (  singleton  ==  null  )  singleton  =  new   NanoHTTPD  (  PORT  ,  rootDir  )  ; 
} 
...
while  (  e  .  hasMoreElements  (  )  )  { 
String   value  =  (  String  )  e  .  nextElement  (  )  ; 
if  (  log  )  System  .  out  .  println  (  "  PRM: '"  +  value  +  "' = '"  +  parms  .  getProperty  (  value  )  +  "'"  )  ; 
} 
...
public   NanoHTTPD  (  int   port  ,  File   rootDir  )  throws   IOException  { 
myFileDir  =  rootDir  ==  null  ?  new   File  (  NanoHTTPD  .  class  .  getResource  (  "."  )  .  getPath  (  )  )  :  rootDir  ; 
myTcpPort  =  port  ; 
System  .  err  .  println  (  "NanoHTTPD serving on: "  +  myTcpPort  )  ; 
...
File   root  =  new   File  (  "./release/root-working"  )  ; 
...
fis  .  skip  (  startFrom  )  ; 
String   date  =  gmtFrmt  .  format  (  new   Date  (  f  .  lastModified  (  )  )  )  ; 
Response   r  =  new   Response  (  HTTP_OK  ,  mime  ,  fis  )  ; 
System  .  err  .  println  (  "Serving "  +  f  .  getName  (  )  +  " "  +  date  )  ; 
r  .  addHeader  (  "Last-Modified"  ,  date  )  ; 
