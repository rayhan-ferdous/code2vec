...
@  TestTargetClass  (  value  =  ObjectOutputStream  .  class  ,  untestedMethods  =  {  @  TestTargetNew  (  method  =  "annotateClass"  ,  args  =  {  Class  .  class  }  ,  level  =  TestLevel  .  NOT_NECESSARY  ,  notes  =  "According to specification, the implementation "  +  "does nothing."  )  ,  @  TestTargetNew  (  method  =  "annotateProxyClass"  ,  args  =  {  Class  .  class  }  ,  level  =  TestLevel  .  NOT_NECESSARY  ,  notes  =  "According to specification, the implementation "  +  "does nothing."  )  }  ) 
public   class   ObjectOutputStreamTest   extends   junit  .  framework  .  TestCase   implements   Serializable  { 
...
private   static   class   WithUnmatchingSerialPersistentFields   implements   java  .  io  .  Serializable  { 
...
private   static   class   WithMatchingSerialPersistentFields   implements   java  .  io  .  Serializable  { 
...
private   static   final   ObjectStreamField  [  ]  serialPersistentFields  =  {  new   ObjectStreamField  (  SIMULATED_FIELD_NAME  ,  String  .  class  )  }  ; 
...
private   static   class   WriteFieldsWithoutFetchingPutFields   implements   java  .  io  .  Serializable  { 
...
private   static   class   SerialPersistentFieldsWithoutField   implements   java  .  io  .  Serializable  { 
...
public   ObjectOutputStreamWithReplace2  (  OutputStream   out  )  throws   IOException  { 
super  (  out  )  ; 
enableReplaceObject  (  true  )  ; 
} 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  "Verifies the protected ObjectOutputStream() constructor."  ,  method  =  "ObjectOutputStream"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks valid construction, NullPointerException and IOException."  ,  method  =  "ObjectOutputStream"  ,  args  =  {  java  .  io  .  OutputStream  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks SecurityException."  ,  method  =  "ObjectOutputStream"  ,  args  =  {  java  .  io  .  OutputStream  .  class  }  ) 
public   void   test_ConstructorLjava_io_OutputStream_subtest0  (  )  throws   IOException  { 
SecurityManager   sm  =  new   SecurityManager  (  )  { 

final   SerializablePermission   forbidenPermission  =  new   SerializablePermission  (  "enableSubclassImplementation"  )  ; 
...
oos  .  writeInt  (  42  )  ; 
assertTrue  (  "Test 1: Primitive data unexpectedly written to the target stream."  ,  bao  .  size  (  )  ==  outputSize  )  ; 
oos  .  close  (  )  ; 
assertTrue  (  "Test 2: Primitive data has not been written to the the target stream."  ,  bao  .  size  (  )  >  outputSize  )  ; 
try  { 
oos_ioe  .  close  (  )  ; 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  method  =  "drain"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  SUFFICIENT  ,  notes  =  "IOException can not be tested because this method"  +  "always throws a NotActiveException if called directly."  ,  method  =  "defaultWriteObject"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  method  =  "enableReplaceObject"  ,  args  =  {  boolean  .  class  }  ) 
public   void   test_enableReplaceObjectB  (  )  throws   IOException  { 
BasicObjectOutputStream   boos  =  new   BasicObjectOutputStream  (  )  ; 
assertFalse  (  "Test 1: Object resolving must be disabled by default."  ,  boos  .  enableReplaceObject  (  true  )  )  ; 
assertTrue  (  "Test 2: enableReplaceObject did not return the previous value."  ,  boos  .  enableReplaceObject  (  false  )  )  ; 
SecurityManager   sm  =  System  .  getSecurityManager  (  )  ; 
System  .  setSecurityManager  (  new   Support_IOTestSecurityManager  (  )  )  ; 
try  { 
...
@  TestTargetNew  (  level  =  TestLevel  .  SUFFICIENT  ,  notes  =  "Tests against golden file missing. IOException can "  +  "not be checked since is never thrown (primitive data "  +  "is written into a self-expanding buffer)."  ,  method  =  "write"  ,  args  =  {  byte  [  ]  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  SUFFICIENT  ,  notes  =  "Tests against golden file missing. IOException can "  +  "not be checked since is never thrown (primitive data "  +  "is written into a self-expanding buffer)."  ,  method  =  "write"  ,  args  =  {  byte  [  ]  .  class  ,  int  .  class  ,  int  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  SUFFICIENT  ,  notes  =  "Tests against golden file missing. IOException can "  +  "not be checked since is never thrown (primitive data "  +  "is written into a self-expanding buffer)."  ,  method  =  "write"  ,  args  =  {  int  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  SUFFICIENT  ,  notes  =  "Tests against golden file missing. IOException can "  +  "not be checked since is never thrown (primitive data "  +  "is written into a self-expanding buffer)."  ,  method  =  "writeBytes"  ,  args  =  {  java  .  lang  .  String  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  SUFFICIENT  ,  notes  =  "Tests against golden file missing. IOException can "  +  "not be checked since is never thrown (primitive data "  +  "is written into a self-expanding buffer)."  ,  method  =  "writeChars"  ,  args  =  {  java  .  lang  .  String  .  class  }  ) 
...
for  (  int   i  =  0  ;  i  <  avail  ;  ++  i  )  buf  [  i  ]  =  ois  .  readChar  (  )  ; 
ois  .  close  (  )  ; 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  ""  ,  method  =  "writeObject"  ,  args  =  {  java  .  lang  .  Object  .  class  }  ) 
...
assertTrue  (  "serialPersistentFields do not work properly in this implementation"  ,  (  (  SerialPersistentFieldsWithoutField  )  objLoaded  )  .  anInstanceVar  !=  CONST  )  ; 
} 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  "Verifies that writeObjectOverride() throws an IOException."  ,  method  =  "writeObjectOverride"  ,  args  =  {  java  .  lang  .  Object  .  class  }  ) 
public   void   test_writeObjectOverrideLjava_lang_Object  (  )  throws   IOException  { 
BasicObjectOutputStream   boos  =  new   BasicObjectOutputStream  (  new   ByteArrayOutputStream  (  )  )  ; 
try  { 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  "Verifies writeStreamHeader()."  ,  method  =  "writeStreamHeader"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL  ,  notes  =  "IOException checking missed."  ,  method  =  "writeUTF"  ,  args  =  {  java  .  lang  .  String  .  class  }  ) 
...
@  TestTargets  (  {  @  TestTargetNew  (  level  =  TestLevel  .  PARTIAL  ,  notes  =  ""  ,  method  =  "writeInt"  ,  args  =  {  int  .  class  }  )  ,  @  TestTargetNew  (  level  =  TestLevel  .  PARTIAL  ,  notes  =  ""  ,  method  =  "writeObject"  ,  args  =  {  java  .  lang  .  Object  .  class  }  )  ,  @  TestTargetNew  (  level  =  TestLevel  .  PARTIAL  ,  notes  =  ""  ,  method  =  "writeUTF"  ,  args  =  {  java  .  lang  .  String  .  class  }  )  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  ""  ,  method  =  "writeUnshared"  ,  args  =  {  java  .  lang  .  Object  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL  ,  notes  =  "IOException & IllegalStateException checking missed."  ,  method  =  "useProtocolVersion"  ,  args  =  {  int  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  ""  ,  method  =  "replaceObject"  ,  args  =  {  java  .  lang  .  Object  .  class  }  ) 
