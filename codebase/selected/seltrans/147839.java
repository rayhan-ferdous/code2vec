...
int   namePos  ; 
String   shortName  ; 
String   fname  =  m_config  .  getProjectRoot  (  )  +  m_config  .  getProjectName  (  )  +  OConsts  .  TMX_EXTENSION  ; 
try  { 
buildTMXFile  (  fname  )  ; 
}  catch  (  IOException   e  )  { 
...
destFileName  =  m_config  .  getLocRoot  (  )  +  filename  .  substring  (  m_config  .  getSourceRoot  (  )  .  length  (  )  )  ; 
ignore  =  false  ; 
...
System  .  out  .  println  (  OStrings  .  CT_COPY_FILE  +  " '"  +  filename  .  substring  (  m_config  .  getSourceRoot  (  )  .  length  (  )  )  +  "'"  )  ; 
...
System  .  out  .  println  (  OStrings  .  getString  (  "CT_ERROR_CANNOT_FIND_TMX"  )  +  "'"  +  proj  +  "'"  )  ; 
return  ; 
} 
...
System  .  out  .  println  (  OStrings  .  getString  (  "CT_LOADING_FILE"  )  +  "'"  +  filepath  +  "'"  )  ; 
...
try  { 
tmx  .  loadFile  (  fname  )  ; 
if  (  isProject  )  LFileCopy  .  copy  (  fname  ,  fname  +  ".bak"  )  ; 
...
throw   new   IOException  (  OStrings  .  getString  (  "CT_ERROR_PARSEERROR"  )  +  "'"  +  fname  +  "'\n"  +  e  )  ; 
} 
} 
...
ofp  .  write  (  OStrings  .  getString  (  "CT_WORD_REMAINING"  )  +  m_currentWords  +  "\n"  )  ; 
ofp  .  close  (  )  ; 
}  catch  (  IOException   e  )  { 
try  { 
...
return   m_config  .  getProjectName  (  )  ; 
} 
