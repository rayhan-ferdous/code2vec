...
private   boolean   postTaskEnabled  =  true  ; 

private   GuideItem   createdFrom  =  null  ; 

private   Vector  <  String  >  logFiles  =  new   Vector  <  String  >  (  )  ; 

private   Vector  <  File  >  captureFiles  =  new   Vector  <  File  >  (  )  ; 

private   long   dealyUntil  =  0  ; 
...
public   void   setPostTaskEnabled  (  boolean   val  )  { 
postTaskEnabled  =  val  ; 
} 

public   boolean   getPostTaskEnabled  (  )  { 
return   postTaskEnabled  ; 
} 
...
public   Vector  <  File  >  getCaptureFiles  (  )  { 
return   captureFiles  ; 
} 
...
public   boolean   isDealyed  (  )  { 
long   time  =  new   Date  (  )  .  getTime  (  )  ; 
if  (  time  >  dealyUntil  )  return   false  ;  else   return   true  ; 
} 

public   void   delayFor  (  long   sec  )  { 
long   time  =  new   Date  (  )  .  getTime  (  )  ; 
dealyUntil  =  time  +  (  sec  *  1000  )  ; 
} 
