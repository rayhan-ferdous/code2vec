...
private   boolean   carryFlag  =  false  ,  zeroFlag  =  false  ,  interruptsDisabled  =  true  ,  decimalModeFlag  =  false  ,  breakFlag  =  true  ; 
...
return  (  (  negativeFlag  ?  128  :  0  )  +  (  overflowFlag  ?  64  :  0  )  +  (  breakFlag  ?  32  :  0  )  +  (  decimalModeFlag  ?  8  :  0  )  +  (  interruptsDisabled  ?  4  :  0  )  +  (  zeroFlag  ?  2  :  0  )  +  (  carryFlag  ?  1  :  0  )  )  ; 
} 
...
return  " PC:"  +  utils  .  hex  (  PC  )  +  " A:"  +  utils  .  hex  (  A  )  +  " X:"  +  utils  .  hex  (  X  )  +  " Y:"  +  utils  .  hex  (  Y  )  +  " P:"  +  utils  .  hex  (  flagstobyte  (  )  )  +  " SP:"  +  utils  .  hex  (  S  )  ; 
} 
