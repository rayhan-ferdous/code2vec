...
try  { 
if  (  D  )  Log  .  d  (  TAG  ,  "Client thread waiting for next share, sleep for "  +  sSleepTime  )  ; 
...
BluetoothOppSendFileInfo   fileInfo  =  BluetoothOppSendFileInfo  .  generateFileInfo  (  mContext1  ,  mInfo  .  mUri  ,  mInfo  .  mMimetype  ,  mInfo  .  mDestination  )  ; 
