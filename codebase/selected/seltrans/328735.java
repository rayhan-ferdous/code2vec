...
if  (  coerceAttrs  ==  null  )  coerceAttrs  =  new   BasicDicomObject  (  )  ; 
if  (  val  .  length  (  )  ==  0  )  coerceAttrs  .  putNull  (  tag  ,  null  )  ;  else   coerceAttrs  .  putString  (  tag  ,  null  ,  val  )  ; 
} 

public   void   setSuffixUID  (  String  [  ]  suffix  )  { 
if  (  suffix  .  length  >  3  )  throw   new   IllegalArgumentException  (  "suffix.length: "  +  suffix  .  length  )  ; 
...
if  (  suffixUID  !=  null  )  info  .  iuid  =  info  .  iuid  +  suffixUID  [  0  ]  ; 
...
for  (  int   i  =  0  ;  i  <  suffixUID  .  length  ;  i  ++  )  attrs  .  putString  (  uidTags  [  i  ]  ,  VR  .  UI  ,  attrs  .  getString  (  uidTags  [  i  ]  )  +  suffixUID  [  i  ]  )  ; 
} 
} 

private   void   coerceAttrs  (  DicomObject   attrs  )  { 
if  (  coerceAttrs  !=  null  )  coerceAttrs  .  copyTo  (  attrs  )  ; 
} 
