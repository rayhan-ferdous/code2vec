...
static   MessageCenter   msgCenter  =  MessageCenter  .  getMessageCenter  (  RepastEssentials  .  class  )  ; 
...
if  (  (  obj  !=  null  )  &&  (  RepastEdge  .  class  .  isAssignableFrom  (  obj  .  getClass  (  )  )  )  )  { 
list  .  add  (  obj  )  ; 
} 
} 
QueryResults   results  =  model  .  execute  (  list  )  ; 
...
if  (  contextPath  .  startsWith  (  "/"  )  )  contextPath  =  contextPath  .  substring  (  1  ,  contextPath  .  length  (  )  )  ; 
String  [  ]  contextPathParts  =  contextPath  .  split  (  "/"  )  ; 
int   startIndex  =  0  ; 
if  (  currentContext  .  getId  (  )  .  equals  (  contextPathParts  [  0  ]  )  )  { 
if  (  contextPathParts  .  length  ==  1  )  return   currentContext  ;  else  { 
startIndex  =  1  ; 
} 
} 
return   FindContext  (  currentContext  ,  contextPathParts  ,  startIndex  ,  contextPathParts  .  length  )  ; 
} 
...
private   static   Context   FindContext  (  Context   context  ,  String  [  ]  path  ,  BigDecimal   startIndex  ,  BigDecimal   endIndex  )  { 
return   FindContext  (  context  ,  path  ,  startIndex  .  intValue  (  )  ,  endIndex  .  intValue  (  )  )  ; 
} 

private   static   Context   FindContext  (  Context   context  ,  String  [  ]  path  ,  int   startIndex  ,  int   endIndex  )  { 
...
int   startIndex  =  0  ; 
if  (  currentContext  .  getId  (  )  .  equals  (  contextPathParts  [  0  ]  )  )  { 
if  (  contextPathParts  .  length  ==  2  )  return   currentContext  ;  else  { 
startIndex  =  1  ; 
} 
} 
return   FindContext  (  currentContext  ,  contextPathParts  ,  startIndex  ,  contextPathParts  .  length  -  1  )  ; 
} 
...
Context   currentContext  =  RunState  .  getSafeMasterContext  (  )  ; 
if  (  valueLayerPath  .  startsWith  (  "/"  )  )  valueLayerPath  =  valueLayerPath  .  substring  (  1  ,  valueLayerPath  .  length  (  )  )  ; 
String  [  ]  pathParts  =  valueLayerPath  .  split  (  "/"  )  ; 
if  (  pathParts  .  length  ==  1  )  return   currentContext  .  getValueLayer  (  pathParts  [  0  ]  )  ; 
int   startIndex  =  pathParts  [  0  ]  .  equals  (  currentContext  .  getId  (  )  )  ?  1  :  0  ; 
Context   context  =  FindContext  (  currentContext  ,  pathParts  ,  startIndex  ,  pathParts  .  length  -  1  )  ; 
...
return   CreateGridValueLayer  (  contextPath  ,  name  ,  bigDecimalArrayToIntArray  (  dimensions  )  )  ; 
} 
...
return   CreateContinuousValueLayer  (  contextPath  ,  name  ,  bigDecimalArrayToDoubleArray  (  dimensions  )  )  ; 
} 
...
Context   currentContext  =  RunState  .  getSafeMasterContext  (  )  ; 
if  (  projectionPath  .  startsWith  (  "/"  )  )  projectionPath  =  projectionPath  .  substring  (  1  ,  projectionPath  .  length  (  )  )  ; 
String  [  ]  projectionPathParts  =  projectionPath  .  split  (  "/"  )  ; 
if  (  projectionPathParts  .  length  ==  1  )  return   currentContext  .  getProjection  (  projectionPathParts  [  0  ]  )  ; 
int   startIndex  =  projectionPathParts  [  0  ]  .  equals  (  currentContext  .  getId  (  )  )  ?  1  :  0  ; 
Context   context  =  FindContext  (  currentContext  ,  projectionPathParts  ,  startIndex  ,  projectionPathParts  .  length  -  1  )  ; 
return   context  .  getProjection  (  projectionPathParts  [  projectionPathParts  .  length  -  1  ]  )  ; 
} 
...
Context   newContext  =  Contexts  .  createContext  (  Object  .  class  ,  newContextName  )  ; 
...
if  (  subContext  !=  null  )  parentContext  .  removeSubContext  (  subContext  )  ; 
return   subContext  ; 
} 
...
RandomDensityGenerator   gen  =  new   RandomDensityGenerator  (  density  ,  allowSelfLoops  ,  symmetric  )  ; 
return   RepastEssentials  .  CreateNetwork  (  parentContextPath  ,  networkName  ,  directed  ,  gen  )  ; 
} 
...
return   CreateWattsBetaSmallWorldNetwork  (  parentContextPath  ,  networkName  ,  directed  ,  beta  ,  nghSize  .  intValue  (  )  ,  symmetrical  )  ; 
} 
...
WattsBetaSmallWorldGenerator   gen  =  new   WattsBetaSmallWorldGenerator  (  beta  ,  nghSize  ,  symmetrical  )  ; 
return   RepastEssentials  .  CreateNetwork  (  parentContextPath  ,  networkName  ,  directed  ,  gen  )  ; 
} 
...
NetworkBuilder   builder  =  new   NetworkBuilder  (  netName  ,  context  ,  isDirected  )  ; 
Class   clazz  ; 
try  { 
clazz  =  Class  .  forName  (  agentClassName  ,  true  ,  builder  .  getClass  (  )  .  getClassLoader  (  )  )  ; 
...
return  (  Grid  )  RepastEssentials  .  CreateProjection  (  parentContextPath  ,  newProjectionName  ,  "Grid"  ,  borders  ,  dimensions  )  ; 
} 
...
return  (  ContinuousSpace  )  RepastEssentials  .  CreateProjection  (  parentContextPath  ,  newProjectionName  ,  "Continuous"  ,  borders  ,  dimensions  )  ; 
} 
...
public   static   Geography   CreateGeography  (  String   parentContextPath  ,  String   newProjectionName  )  { 
return  (  Geography  )  RepastEssentials  .  CreateProjection  (  parentContextPath  ,  newProjectionName  ,  "GIS"  )  ; 
} 

public   static   Projection   CreateProjection  (  String   parentContextPath  ,  String   newProjectionName  ,  String   newProjectionType  )  { 
return   RepastEssentials  .  CreateProjection  (  parentContextPath  ,  newProjectionName  ,  newProjectionType  ,  true  ,  "WrapAroundBorders"  ,  100  ,  100  )  ; 
} 
...
return   RepastEssentials  .  CreateProjection  (  parentContextPath  ,  newProjectionName  ,  newProjectionType  ,  optionalProjectionKind  ,  "WrapAroundBorders"  ,  100  ,  100  )  ; 
} 
...
return   CreateProjection  (  parentContextPath  ,  newProjectionName  ,  newProjectionType  ,  bigDecimalArrayToIntArray  (  optionalDimensions  )  )  ; 
} 
...
return   RepastEssentials  .  CreateProjection  (  parentContextPath  ,  newProjectionName  ,  newProjectionType  ,  true  ,  "WrapAroundBorders"  ,  optionalDimensions  )  ; 
} 
...
return   CreateProjection  (  parentContextPath  ,  newProjectionName  ,  newProjectionType  ,  optionalBorders  ,  bigDecimalArrayToIntArray  (  optionalDimensions  )  )  ; 
} 
...
return   RepastEssentials  .  CreateProjection  (  parentContextPath  ,  newProjectionName  ,  newProjectionType  ,  true  ,  optionalBorders  ,  optionalDimensions  )  ; 
} 
...
try  { 
gridPointTranslator  =  (  GridPointTranslator  )  Class  .  forName  (  "repast.simphony.space.grid."  +  optionalBorders  )  .  newInstance  (  )  ; 
}  catch  (  Exception   e  )  { 
msgCenter  .  error  (  optionalBorders  ,  e  )  ; 
} 
newProjection  =  GridFactoryFinder  .  createGridFactory  (  null  )  .  createGrid  (  newProjectionName  ,  parentContext  ,  new   GridBuilderParameters  (  gridPointTranslator  ,  new   RandomGridAdder  (  )  ,  optionalProjectionKind  ,  optionalDimensions  )  )  ; 
}  else   if  (  newProjectionType  .  equalsIgnoreCase  (  "Graph"  )  )  { 
newProjection  =  NetworkFactoryFinder  .  createNetworkFactory  (  null  )  .  createNetwork  (  newProjectionName  ,  parentContext  ,  optionalProjectionKind  )  ; 
}  else   if  (  newProjectionType  .  equalsIgnoreCase  (  "Continuous"  )  )  { 
PointTranslator   pointTranslator  =  null  ; 
try  { 
pointTranslator  =  (  PointTranslator  )  Class  .  forName  (  "repast.simphony.space.continuous."  +  optionalBorders  )  .  newInstance  (  )  ; 
}  catch  (  Exception   e  )  { 
msgCenter  .  error  (  optionalBorders  ,  e  )  ; 
} 
...
newProjection  =  ContinuousSpaceFactoryFinder  .  createContinuousSpaceFactory  (  null  )  .  createContinuousSpace  (  newProjectionName  ,  parentContext  ,  new   RandomCartesianAdder  (  )  ,  pointTranslator  ,  dOptionalDimensions  )  ; 
}  else   if  (  newProjectionType  .  equalsIgnoreCase  (  "GIS"  )  )  { 
newProjection  =  GeographyFactoryFinder  .  createGeographyFactory  (  null  )  .  createGeography  (  newProjectionName  ,  parentContext  ,  new   GeographyParameters  (  )  )  ; 
}  else  { 
throw   new   IllegalArgumentException  (  "Projection type '"  +  newProjectionType  +  "' not found."  )  ; 
} 
...
return   RepastEssentials  .  CreateEdge  (  networkProjectionPath  ,  agentSource  ,  agentTarget  ,  0  )  ; 
} 
...
Network   network  =  (  Network  )  FindProjection  (  networkProjectionPath  )  ; 
RepastEdge   edge  =  network  .  getEdge  (  agentSource  ,  agentTarget  )  ; 
if  (  edge  !=  null  )  network  .  removeEdge  (  edge  )  ; 
return   edge  ; 
} 
...
if  (  iter   instanceof   Collection  )  list  .  addAll  (  (  Collection  )  iter  )  ;  else  { 
for  (  Object   obj  :  iter  )  { 
list  .  add  (  obj  )  ; 
} 
} 
...
return   RepastEssentials  .  ScheduleAction  (  agent  ,  1  ,  0  ,  methodName  ,  parameters  )  ; 
} 
...
return   RepastEssentials  .  ScheduleAction  (  agent  ,  optionalStartTime  ,  0  ,  methodName  ,  parameters  )  ; 
} 
...
newAction  =  schedule  .  schedule  (  ScheduleParameters  .  createRepeating  (  optionalStartTime  ,  optionalRepeatInterval  )  ,  agent  ,  methodName  ,  parameters  )  ; 
}  else  { 
newAction  =  schedule  .  schedule  (  ScheduleParameters  .  createOneTime  (  optionalStartTime  )  ,  agent  ,  methodName  ,  parameters  )  ; 
} 
return   newAction  ; 
} 

public   static   IAction   CancelAction  (  ISchedulableAction   actionToCancel  )  { 
RunEnvironment  .  getInstance  (  )  .  getCurrentSchedule  (  )  .  removeAction  (  actionToCancel  )  ; 
...
if  (  results  )  DeleteExternalFile  (  tempFileName  )  ; 
return   results  ; 
} 
...
return   RepastEssentials  .  RandomDrawAgainstThreshold  (  threshold  .  doubleValue  (  )  )  ; 
} 
...
return   RandomHelper  .  getUniform  (  )  .  nextDoubleFromTo  (  lowerBound  ,  upperBound  )  ; 
} 

public   static   double   RandomDraw  (  BigDecimal   lowerBound  ,  BigDecimal   upperBound  )  { 
return   RepastEssentials  .  RandomDraw  (  lowerBound  .  doubleValue  (  )  ,  upperBound  .  doubleValue  (  )  )  ; 
} 

public   static   int   ExecuteProgram  (  String   directory  ,  String   commandLine  )  { 
int   results  =  0  ; 
try  { 
ProcessBuilder   processBuilder  =  new   ProcessBuilder  (  directory  +  "\\"  +  commandLine  )  ; 
