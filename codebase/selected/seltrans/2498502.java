...
import   strudle  .  plugin  .  IRecogPlugin  ; 
import   strudle  .  plugin  .  htk  .  HTKPlugin  ; 

public   class   SoundTabPlugin   extends   CTabItem  { 
...
IRecogPlugin   recogPlugin  =  null  ; 

public   SoundTabPlugin  (  final   CTabFolder   tabFolder  ,  int   style  ,  Patient   patient  ,  String   nomefile  )  { 
...
Image   image1  =  new   Image  (  display  ,  "images\\play.gif"  )  ; 
...
Image   image2  =  new   Image  (  display  ,  "images\\stop.gif"  )  ; 
...
Image   image3  =  new   Image  (  display  ,  "images\\startsel.gif"  )  ; 
...
Image   image4  =  new   Image  (  display  ,  "images\\endsel.gif"  )  ; 
...
Map   configurazionePlugin  =  new   HashMap  (  )  ; 
configurazionePlugin  .  put  (  "patientName"  ,  patient  .  getName  (  )  )  ; 
configurazionePlugin  .  put  (  "patientSurname"  ,  patient  .  getSurname  (  )  )  ; 
recogPlugin  .  Init  (  configurazionePlugin  )  ; 
...
recogPlugin  .  StartWork  (  null  )  ; 
recogPlugin  .  SetAudioInterval  (  null  ,  af  .  getFrameRate  (  )  )  ; 
recogPlugin  .  SetStrudleTest  (  test  ,  recogtest  [  i  ]  )  ; 
recogPlugin  .  GetReady  (  )  ; 
recogPlugin  .  Eval  (  null  )  ; 
recogString  [  i  ]  =  recogPlugin  .  GetResult  (  )  ; 
recogPlugin  .  FinishWork  (  )  ; 
bar  .  setSelection  (  i  )  ; 
} 
shell1  .  dispose  (  )  ; 
