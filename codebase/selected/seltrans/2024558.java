...
public   class   FileAuditedPermissionsItem   extends   ItemType  { 
...
public   FileAuditedPermissionsItem  (  final   int   id  )  { 
this  (  id  ,  null  )  ; 
} 

public   FileAuditedPermissionsItem  (  final   int   id  ,  final   StatusEnumeration   status  )  { 
super  (  id  ,  status  )  ; 
...
public   void   setFilepath  (  final   EntityItemStringType   filepath  )  { 
...
public   void   setPath  (  final   EntityItemStringType   path  )  { 
this  .  path  =  path  ; 
} 
...
public   void   setFilename  (  final   EntityItemStringType   filename  )  { 
...
public   void   setTrusteeName  (  final   EntityItemStringType   trustee_name  )  { 
...
public   void   setStandardDelete  (  final   EntityItemAuditType   standard_delete  )  { 
...
public   void   setStandardReadControl  (  final   EntityItemAuditType   standard_read_control  )  { 
...
public   void   setStandardWriteDac  (  final   EntityItemAuditType   standard_write_dac  )  { 
...
public   void   setStandardWriteOwner  (  final   EntityItemAuditType   standard_write_owner  )  { 
...
public   void   setStandardSyncronize  (  final   EntityItemAuditType   standard_syncronize  )  { 
...
public   void   setAccessSystemSecurity  (  final   EntityItemAuditType   access_system_security  )  { 
...
public   void   setGenericRead  (  final   EntityItemAuditType   generic_read  )  { 
...
public   void   setGenericWrite  (  final   EntityItemAuditType   generic_write  )  { 
...
public   void   setGenericExecute  (  final   EntityItemAuditType   generic_execute  )  { 
...
public   void   setGenericAll  (  final   EntityItemAuditType   generic_all  )  { 
...
public   void   setFileReadData  (  final   EntityItemAuditType   file_read_data  )  { 
...
public   void   setFileWriteData  (  final   EntityItemAuditType   file_write_data  )  { 
...
public   void   setFileAppendData  (  final   EntityItemAuditType   file_append_data  )  { 
...
public   void   setFileReadEa  (  final   EntityItemAuditType   file_read_ea  )  { 
...
public   void   setFileWriteEa  (  final   EntityItemAuditType   file_write_ea  )  { 
...
public   void   setFileExecute  (  final   EntityItemAuditType   file_execute  )  { 
...
public   void   setFileDeleteChild  (  final   EntityItemAuditType   file_delete_child  )  { 
...
public   void   setFileReadAttributes  (  final   EntityItemAuditType   file_read_attributes  )  { 
...
public   void   setFileWriteAttributes  (  final   EntityItemAuditType   file_write_attributes  )  { 
...
public   void   setWindowsView  (  final   EntityItemWindowsViewType   windows_view  )  { 
