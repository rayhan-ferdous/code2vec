...
if  (  bonds  !=  null  )  for  (  int   i  =  bonds  .  length  ;  --  i  >=  0  ;  )  if  (  bonds  [  i  ]  .  isCovalent  (  )  &&  bonds  [  i  ]  .  getOtherAtom  (  this  )  ==  atomOther  )  return   true  ; 
return   false  ; 
} 

public   boolean   isBonded  (  Atom   atomOther  )  { 
if  (  bonds  !=  null  )  for  (  int   i  =  bonds  .  length  ;  --  i  >=  0  ;  )  if  (  bonds  [  i  ]  .  getOtherAtom  (  this  )  ==  atomOther  )  return   true  ; 
return   false  ; 
} 

public   Bond   getBond  (  Atom   atomOther  )  { 
if  (  bonds  !=  null  )  for  (  int   i  =  bonds  .  length  ;  --  i  >=  0  ;  )  if  (  bonds  [  i  ]  .  getOtherAtom  (  atomOther  )  !=  null  )  return   bonds  [  i  ]  ; 
return   null  ; 
} 
...
if  (  bonds  !=  null  )  for  (  int   i  =  bonds  .  length  ;  --  i  >=  0  ;  )  if  (  bonds  [  i  ]  ==  bond  )  { 
deleteBond  (  i  )  ; 
return  ; 
} 
} 
...
if  (  rd  .  factorType  ==  RadiusData  .  EnumType  .  FACTOR  )  f  *=  r  ;  else   f  +=  r  ; 
break  ; 
case   ABSOLUTE  : 
break  ; 
} 
...
int   n  =  0  ; 
Bond   b  ; 
for  (  int   i  =  bonds  .  length  ;  --  i  >=  0  ;  )  if  (  (  (  b  =  bonds  [  i  ]  )  .  order  &  JmolEdge  .  BOND_COVALENT_MASK  )  !=  0  &&  !  b  .  getOtherAtom  (  this  )  .  isDeleted  (  )  )  ++  n  ; 
return   n  ; 
} 
...
if  (  (  bonds  [  i  ]  .  order  &  JmolEdge  .  BOND_COVALENT_MASK  )  ==  0  )  continue  ; 
...
if  (  n  <  0  ||  (  n  %  128  )  >=  Elements  .  elementNumberMax  ||  n  >  Short  .  MAX_VALUE  )  n  =  0  ; 
...
formalChargeAndFlags  =  (  byte  )  (  (  formalChargeAndFlags  &  FLAG_MASK  )  |  (  (  charge  ==  Integer  .  MIN_VALUE  ?  0  :  charge  >  7  ?  7  :  charge  <  -  3  ?  -  3  :  charge  )  <<  2  )  )  ; 
} 
...
if  (  values  ==  null  )  return   Elements  .  getHydrophobicity  (  group  .  getGroupID  (  )  )  ; 
return   values  [  index  ]  ; 
} 
...
int   n  =  valence  ; 
if  (  n  ==  0  &&  bonds  !=  null  )  for  (  int   i  =  bonds  .  length  ;  --  i  >=  0  ;  )  n  +=  bonds  [  i  ]  .  getValence  (  )  ; 
return   n  ; 
} 
...
return  (  Float  .  isNaN  (  userDefinedVanDerWaalRadius  )  ?  viewer  .  getVanderwaalsMar  (  atomicAndIsotopeNumber  %  128  ,  getVdwType  (  type  )  )  /  1000f  :  userDefinedVanDerWaalRadius  )  ; 
} 
...
case   NOJMOL  : 
type  =  group  .  chain  .  model  .  modelSet  .  getDefaultVdwType  (  modelIndex  )  ; 
if  (  type  ==  EnumVdw  .  AUTO_JMOL  )  type  =  EnumVdw  .  AUTO_BABEL  ; 
break  ; 
} 
return   type  ; 
} 
...
return  (  r  ==  0  ?  Elements  .  getBondingRadiusFloat  (  atomicAndIsotopeNumber  ,  getFormalCharge  (  )  )  :  r  )  ; 
} 

float   getVolume  (  Viewer   viewer  ,  EnumVdw   vType  )  { 
float   r1  =  (  vType  ==  null  ?  userDefinedVanDerWaalRadius  :  Float  .  NaN  )  ; 
if  (  Float  .  isNaN  (  r1  )  )  r1  =  viewer  .  getVanderwaalsMar  (  getElementNumber  (  )  ,  getVdwType  (  vType  )  )  /  1000f  ; 
double   volume  =  0  ; 
if  (  bonds  !=  null  )  for  (  int   j  =  0  ;  j  <  bonds  .  length  ;  j  ++  )  { 
...
if  (  Float  .  isNaN  (  r2  )  )  r2  =  viewer  .  getVanderwaalsMar  (  atom2  .  getElementNumber  (  )  ,  atom2  .  getVdwType  (  vType  )  )  /  1000f  ; 
...
return  (  atomID  >  0  ?  JmolConstants  .  getSpecialAtomName  (  atomID  )  :  group  .  chain  .  model  .  modelSet  .  atomNames  [  index  ]  )  ; 
} 
...
if  (  nOps  ==  0  ||  atomSymmetry  ==  null  )  return  ""  ; 
int  [  ]  cellRange  =  f  .  getModelCellRange  (  modelIndex  )  ; 
int   pt  =  nOps  ; 
int   n  =  (  cellRange  ==  null  ?  1  :  cellRange  .  length  )  ; 
for  (  int   i  =  0  ;  i  <  n  ;  i  ++  )  for  (  int   j  =  0  ;  j  <  nOps  ;  j  ++  )  if  (  atomSymmetry  .  get  (  pt  ++  )  )  str  +=  ","  +  (  j  +  1  )  +  ""  +  cellRange  [  i  ]  ; 
...
pt  .  set  (  ptNew  )  ; 
SymmetryInterface   c  =  group  .  chain  .  model  .  modelSet  .  getUnitCell  (  modelIndex  )  ; 
if  (  c  !=  null  )  c  .  toCartesian  (  pt  ,  asAbsolute  &&  !  group  .  chain  .  model  .  isJmolDataFrame  )  ; 
} 
...
return  "Atom: "  +  (  group3  ==  null  ?  getElementSymbol  (  )  :  getAtomName  (  )  )  +  " "  +  getAtomNumber  (  )  +  (  group3  !=  null  &&  group3  .  length  (  )  >  0  ?  (  isHetero  (  )  ?  " Hetero: "  :  " Group: "  )  +  group3  +  " "  +  getResno  (  )  +  (  chainID  !=  0  &&  chainID  !=  ' '  ?  " Chain: "  +  chainID  :  ""  )  :  ""  )  +  " Model: "  +  getModelNumber  (  )  +  " Coordinates: "  +  x  +  " "  +  y  +  " "  +  z  +  (  pt  ==  null  ?  ""  :  " Fractional: "  +  pt  .  x  +  " "  +  pt  .  y  +  " "  +  pt  .  z  )  ; 
} 
...
if  (  !  isInFrame  (  )  ||  group  .  chain  .  model  .  modelSet  .  isAtomHidden  (  index  )  )  return   false  ; 
if  (  flags  !=  0  )  return  (  isShapeVisible  (  flags  )  )  ; 
flags  =  shapeVisibilityFlags  ; 
if  (  group  .  shapeVisibilityFlags  !=  Atom  .  BACKBONE_VISIBILITY_FLAG  ||  isLeadAtom  (  )  )  flags  |=  group  .  shapeVisibilityFlags  ; 
...
return   atom  ; 
case   Token  .  color  : 
return   ColorUtil  .  colorPointFromInt2  (  atom  .  group  .  chain  .  model  .  modelSet  .  viewer  .  getColorArgbOrGray  (  atom  .  getColix  (  )  )  )  ; 
} 
return   null  ; 
} 
...
if  (  modelIndex  !=  atomOther  .  modelIndex  )  return   false  ; 
if  (  isCovalentlyBonded  (  atomOther  )  )  return   true  ; 
Bond  [  ]  bondsOther  =  atomOther  .  bonds  ; 
for  (  int   i  =  0  ;  i  <  bondsOther  .  length  ;  i  ++  )  { 
Atom   atom2  =  bondsOther  [  i  ]  .  getOtherAtom  (  atomOther  )  ; 
if  (  isCovalentlyBonded  (  atom2  )  )  return   true  ; 
for  (  int   j  =  0  ;  j  <  bonds  .  length  ;  j  ++  )  if  (  bonds  [  j  ]  .  getOtherAtom  (  this  )  .  isCovalentlyBonded  (  atom2  )  )  return   true  ; 
} 
return   false  ; 
} 
} 
