...
Header   header  =  method  .  getResponseHeader  (  "location"  )  ; 
if  (  header  ==  null  )  throw   new   CVardbException  (  "the response is invalid and did not provide the new location for the resource"  )  ; 
return   header  .  getValue  (  )  ; 
} 
...
}  else   throw   new   CVardbException  (  "returned statusCode: "  +  this  .  statusCode  )  ; 
}  catch  (  HttpException   e  )  { 
throw   new   CVardbException  (  e  )  ; 
}  catch  (  IOException   e  )  { 
throw   new   CVardbException  (  e  )  ; 
