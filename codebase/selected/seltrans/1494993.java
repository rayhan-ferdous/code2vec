...
try  { 
bos  =  new   Base64  .  B64OutputStream  (  new   java  .  io  .  FileOutputStream  (  filename  )  ,  Base64  .  ENCODE  )  ; 
...
Base64  .  B64OutputStream   bos  =  null  ; 
try  { 
bos  =  new   Base64  .  B64OutputStream  (  new   java  .  io  .  FileOutputStream  (  filename  )  ,  Base64  .  DECODE  )  ; 
...
bis  =  new   Base64  .  B64InputStream  (  new   java  .  io  .  BufferedInputStream  (  new   java  .  io  .  FileInputStream  (  file  )  )  ,  Base64  .  DECODE  )  ; 
...
int   length  =  0  ; 
int   numBytes  =  0  ; 
bis  =  new   Base64  .  B64InputStream  (  new   java  .  io  .  BufferedInputStream  (  new   java  .  io  .  FileInputStream  (  file  )  )  ,  Base64  .  ENCODE  )  ; 
while  (  (  numBytes  =  bis  .  read  (  buffer  ,  length  ,  4096  )  )  >=  0  )  length  +=  numBytes  ; 
