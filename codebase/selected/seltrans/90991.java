...
private   static   MessageFormat   PARAM_VAR_NAME  =  new   MessageFormat  (  "gk_blue_auto{0}"  )  ; 
...
OpcodeList   udos  =  (  OpcodeList  )  ObjectUtilities  .  clone  (  data  .  getOpcodeList  (  )  )  ; 
...
if  (  usingAPI  )  { 
ArrayList   parameters  =  ParameterHelper  .  getAllParameters  (  arrangement  ,  mixer  )  ; 
generatedNotes  =  new   NoteList  (  )  ; 
handleParametersForBlueLive  (  parameters  ,  globalOrcSco  ,  generatedNotes  ,  arrangement  )  ; 
} 
...
int   instrId  =  arrangement  .  addInstrumentAtEnd  (  mixer  .  getMixerInstrument  (  udos  ,  nchnls  )  )  ; 
...
appendCsInstruments  (  data  ,  udos  ,  arrangement  ,  globalOrcSco  ,  score  ,  mixer  ,  true  )  ; 
appendCsScore  (  globalSco  ,  ftables  ,  generatedNotes  ,  totalDur  ,  score  )  ; 
score  .  append  (  "</CsoundSynthesizer>"  )  ; 
CsdRenderResult   renderResult  =  new   CsdRenderResult  (  score  .  toString  (  )  ,  originalParameters  )  ; 
return   renderResult  ; 
} 

public   static   CsdRenderResult   generateCSD  (  BlueData   data  )  throws   SoundObjectException  { 
return   generateCSD  (  data  ,  0.0f  ,  -  1.0f  )  ; 
} 

public   static   CsdRenderResult   generateCSD  (  BlueData   data  ,  float   startTime  ,  float   endTime  )  throws   SoundObjectException  { 
...
float   totalDur  =  blue  .  utility  .  ScoreUtilities  .  getTotalDuration  (  generatedNotes  )  ; 
float   processingStart  =  blue  .  utility  .  ScoreUtilities  .  getProcessingStartTime  (  tempPObj  )  ; 
...
handleParameters  (  parameters  ,  globalOrcSco  ,  generatedNotes  ,  arrangement  ,  startTime  ,  startTime  +  globalDur  ,  isRealTime  )  ; 
if  (  isRealTime  &&  !  (  APIUtilities  .  isCsoundAPIAvailable  (  )  &&  GeneralSettings  .  getInstance  (  )  .  isUsingCsoundAPI  (  )  )  )  { 
...
CSLADSPASettings   csladspaSettings  =  data  .  getProjectProperties  (  )  .  csladspaSettings  ; 
if  (  csladspaSettings  .  isEnabled  (  )  )  { 
csd  .  append  (  csladspaSettings  .  getCSDText  (  )  )  ; 
} 
csd  .  append  (  "<CsoundSynthesizer>\n\n"  )  ; 
appendCsInstruments  (  data  ,  udos  ,  arrangement  ,  globalOrcSco  ,  csd  ,  mixer  ,  isRealTime  )  ; 
appendCsScore  (  globalSco  ,  ftables  ,  generatedNotes  ,  totalDur  ,  csd  )  ; 
csd  .  append  (  "</CsoundSynthesizer>"  )  ; 
CsdRenderResult   renderResult  =  new   CsdRenderResult  (  csd  .  toString  (  )  ,  originalParameters  )  ; 
return   renderResult  ; 
} 
...
private   static   void   createParamNote  (  StrBuilder   paramScore  ,  int   instrId  ,  float   startTime  ,  float   dur  ,  float   startVal  ,  float   endVal  )  { 
paramScore  .  append  (  "i"  )  ; 
...
private   static   float   getGlobalDuration  (  String   globalSco  )  throws   SoundObjectException  { 
...
private   static   void   appendCsScore  (  String   globalSco  ,  String   ftables  ,  NoteList   generatedNotes  ,  float   totalDur  ,  StrBuilder   score  )  { 
...
private   static   void   appendCsInstruments  (  BlueData   data  ,  OpcodeList   udos  ,  Arrangement   arrangement  ,  GlobalOrcSco   globalOrcSco  ,  StrBuilder   score  ,  Mixer   mixer  ,  boolean   isRealTime  )  { 
...
score  .  append  (  "\n"  )  ; 
score  .  append  (  CommandProcessor  .  processCommandBlocks  (  arrangement  .  generateGlobalOrc  (  )  )  )  .  append  (  "\n"  )  ; 
score  .  append  (  "\n"  )  ; 
...
private   static   String   preprocessSco  (  String   in  ,  float   totalDur  ,  float   renderStartTime  ,  float   processingStart  ,  TempoMapper   tempoMapper  )  { 
String   temp  =  blue  .  utility  .  TextUtilities  .  replaceAll  (  in  ,  "<TOTAL_DUR>"  ,  Float  .  toString  (  totalDur  )  )  ; 
temp  =  blue  .  utility  .  TextUtilities  .  replaceAll  (  temp  ,  "<PROCESSING_START>"  ,  Float  .  toString  (  processingStart  )  )  ; 
temp  =  blue  .  utility  .  TextUtilities  .  replaceAll  (  temp  ,  "<RENDER_START>"  ,  Float  .  toString  (  renderStartTime  )  )  ; 
TempoMapper   localTempoMapper  =  tempoMapper  ; 
if  (  localTempoMapper  ==  null  )  { 
localTempoMapper  =  getTempoMapper  (  in  )  ; 
} 
if  (  tempoMapper  !=  null  )  { 
temp  =  blue  .  utility  .  TextUtilities  .  replaceAll  (  temp  ,  "<RENDER_START_ABSOLUTE>"  ,  Float  .  toString  (  tempoMapper  .  beatsToSeconds  (  renderStartTime  )  )  )  ; 
}  else  { 
temp  =  blue  .  utility  .  TextUtilities  .  replaceAll  (  temp  ,  "<RENDER_START_ABSOLUTE>"  ,  Float  .  toString  (  renderStartTime  )  )  ; 
} 
return   temp  ; 
} 
...
private   static   void   appendParameterScore  (  Parameter   param  ,  int   instrId  ,  StrBuilder   paramScore  ,  float   renderStart  ,  float   renderEnd  )  { 
...
int   numSteps  =  Math  .  abs  (  Math  .  round  (  (  endVal  -  startVal  )  /  resolution  )  )  ; 
...
paramScore  .  append  (  "i"  )  ; 
paramScore  .  append  (  instrId  )  .  append  (  "\t"  )  ; 
paramScore  .  append  (  NumberUtilities  .  formatFloat  (  start  -  renderStart  )  )  .  append  (  "\t"  )  ; 
paramScore  .  append  (  ".0001\t"  )  ; 
paramScore  .  append  (  NumberUtilities  .  formatFloat  (  currentVal  )  )  .  append  (  "\n"  )  ; 
} 
start  +=  step  ; 
if  (  renderEnd  >  0  &&  start  >=  renderEnd  )  { 
return  ; 
...
protected   static   String   getTempoScore  (  Tempo   tempo  ,  float   renderStart  ,  float   renderEnd  )  { 
...
private   static   void   handleParameters  (  ArrayList   parameters  ,  GlobalOrcSco   globalOrcSco  ,  NoteList   notes  ,  Arrangement   arrangement  ,  float   startTime  ,  float   endTime  ,  boolean   isRealTime  )  { 
Object  [  ]  varNum  =  new   Object  [  1  ]  ; 
StrBuilder   initStatements  =  new   StrBuilder  (  )  ; 
StrBuilder   paramScore  =  new   StrBuilder  (  )  ; 
boolean   useAPI  =  (  isRealTime  &&  APIUtilities  .  isCsoundAPIAvailable  (  )  &&  GeneralSettings  .  getInstance  (  )  .  isUsingCsoundAPI  (  )  )  ; 
...
private   static   void   handleParametersForBlueLive  (  ArrayList   parameters  ,  GlobalOrcSco   globalOrcSco  ,  NoteList   notes  ,  Arrangement   arrangement  )  { 
Object  [  ]  varNum  =  new   Object  [  1  ]  ; 
StrBuilder   initStatements  =  new   StrBuilder  (  )  ; 
StrBuilder   paramScore  =  new   StrBuilder  (  )  ; 
boolean   useAPI  =  (  APIUtilities  .  isCsoundAPIAvailable  (  )  &&  GeneralSettings  .  getInstance  (  )  .  isUsingCsoundAPI  (  )  )  ; 
StrBuilder   apiParamInstr  =  new   StrBuilder  (  )  ; 
for  (  int   i  =  0  ;  i  <  parameters  .  size  (  )  ;  i  ++  )  { 
Parameter   param  =  (  Parameter  )  parameters  .  get  (  i  )  ; 
varNum  [  0  ]  =  new   Integer  (  i  )  ; 
