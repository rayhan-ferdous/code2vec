package   de  .  mpiwg  .  vspace  .  maps  .  diagram  .  navigator  ; 
...
public   class   OverviewMapsNavigatorLinkHelper   implements   ILinkHelper  { 
...
IDiagramDocument   document  =  OverviewMapsDiagramEditorPlugin  .  getInstance  (  )  .  getDocumentProvider  (  )  .  getDiagramDocument  (  anInput  )  ; 
if  (  document  ==  null  )  { 
...
if  (  file  !=  null  )  { 
OverviewMapsNavigatorItem   item  =  new   OverviewMapsNavigatorItem  (  diagram  ,  file  ,  false  )  ; 
