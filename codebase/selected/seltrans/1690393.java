...
delay  =  -  1  ; 
if  (  (  n  >=  0  )  &&  (  n  <  frameCount  )  )  delay  =  (  (  GifFrame  )  frames  .  get  (  n  )  )  .  delay  ; 
return   delay  ; 
} 
...
if  (  (  n  >=  0  )  &&  (  n  <  frameCount  )  )  im  =  (  (  GifFrame  )  frames  .  get  (  n  )  )  .  image  ; 
return   im  ; 
} 
...
Color   c  =  null  ; 
if  (  transparency  )  c  =  new   Color  (  0  ,  0  ,  0  ,  0  )  ;  else   c  =  new   Color  (  lastBgColor  )  ; 
g  .  setColor  (  c  )  ; 
