...
for  (  int   i  =  0  ;  i  <  NB_SOUND_SAMPLES  ;  i  ++  )  sounds  [  i  ]  =  loadSound  (  "sounds/sample-"  +  i  +  ".wav"  )  ; 
} 
...
if  (  sounds  [  sound_ID  ]  ==  null  )  return  ; 
...
try  { 
if  (  current_music  !=  null  )  sequencer  .  stop  (  )  ; 
if  (  !  loadMidiMusic  (  sound_name  )  )  return  ; 
if  (  channels  !=  null  )  { 
...
if  (  current_music  !=  null  )  sequencer  .  start  (  )  ; 
} 
} 
} 
