...
if  (  !  propertyDescriptorsMap  .  containsKey  (  beanClass  )  )  { 
return   null  ; 
} 
...
propertyDescriptors  [  6  ]  =  new   PropertyDescriptor  (  "translationTable"  ,  String  .  class  ,  Locale  .  class  ,  new   Method  [  ]  {  m  [  0  ]  ,  m  [  1  ]  ,  p  .  getReadMethod  (  )  }  ,  new   Method  [  ]  {  m  [  0  ]  ,  m  [  1  ]  ,  p  .  getWriteMethod  (  )  }  )  ; 
propertyDescriptorsMap  .  put  (  beanClass  ,  propertyDescriptors  )  ; 
beanClass  =  TocStyle  .  class  ; 
propertyDescriptorsMap  .  put  (  beanClass  ,  new   PropertyDescriptor  [  ]  {  newMappedPropertyDescriptor  (  beanClass  ,  "level"  ,  TocLevelStyle  .  class  ,  int  .  class  )  }  )  ; 
...
private   static   PropertyDescriptor   newMappedPropertyDescriptor  (  Class   beanClass  ,  String   property  ,  Class   propertyClass  ,  Class   keyClass  )  throws   NoSuchMethodException  { 
Method  [  ]  readMethods  =  new   Method  [  ]  {  BeanInfo  .  getPropertyDescriptor  (  beanClass  ,  property  +  "s"  )  .  getReadMethod  (  )  ,  SettingMap  .  class  .  getMethod  (  "get"  ,  new   Class  [  ]  {  Object  .  class  }  )  }  ; 
