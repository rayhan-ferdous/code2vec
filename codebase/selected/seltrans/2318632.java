...
if  (  innerClassesAttribute  ==  null  )  return   false  ;  else   return   innerClassesAttribute  .  makesClassNested  (  m_this_class_index  ,  nestedAccessFlags  )  ; 
} 
...
final   Field_info   field  =  new   Field_info  (  access_flags  ,  name_index  ,  descriptor_index  ,  ElementFactory  .  newAttributeCollection  (  0  )  )  ; 
...
public   int   addField  (  final   String   name  ,  final   String   descriptor  ,  final   int   access_flags  ,  final   IAttributeCollection   attributes  )  { 
final   int   name_index  =  addCONSTANT_Utf8  (  name  ,  true  )  ; 
final   int   descriptor_index  =  addCONSTANT_Utf8  (  descriptor  ,  true  )  ; 
...
final   CodeAttribute_info   code  =  new   CodeAttribute_info  (  attribute_name_index  ,  0  ,  0  ,  CodeAttribute_info  .  EMPTY_BYTE_ARRAY  ,  AttributeElementFactory  .  newExceptionHandlerTable  (  0  )  ,  ElementFactory  .  newAttributeCollection  (  0  )  )  ; 
attributes  .  add  (  code  )  ; 
...
if  (  result  ==  0  )  result  =  m_descriptor  .  compareTo  (  rhs  .  m_descriptor  )  ; 
return   result  ; 
} 
