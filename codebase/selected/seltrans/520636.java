...
public   PoolConfigSaver  (  File   f  ,  List  <  DevicePool  >  devicePools  )  { 
this  .  file  =  f  ; 
this  .  devicePools  =  devicePools  ; 
} 

public   PoolsDocument   build  (  IPreferences   prefs  )  { 
currentPreferences  =  prefs  ; 
PoolsDocument   xmlPoolsDoc  =  PoolsDocument  .  Factory  .  newInstance  (  )  ; 
Pools   poolsType  =  xmlPoolsDoc  .  addNewPools  (  )  ; 
for  (  DevicePool   pool  :  devicePools  )  { 
Pool   xmlPool  =  poolsType  .  addNewPool  (  )  ; 
String   name  =  pool  .  getName  (  )  ; 
if  (  name  !=  null  &&  name  .  length  (  )  >  0  &&  name  .  indexOf  (  "/"  )  <  0  )  xmlPool  .  setAlias  (  pool  .  getName  (  )  )  ; 
xmlPool  .  setDeviceName  (  pool  .  getDeviceName  (  )  )  ; 
xmlPool  .  setMachine  (  pool  .  getMachine  (  )  .  toString  (  )  )  ; 
...
public   void   save  (  PoolsDocument   xmlPoolsDoc  )  throws   IOException  { 
...
if  (  loggingLevel  !=  null  )  xmlLogging  .  setLevel  (  loggingLevel  )  ; 
if  (  currLoggingInfo  !=  null  &&  currLoggingInfo  .  length  >  0  )  xmlLogging  .  setCurrentLevel  (  currLoggingInfo  [  0  ]  )  ; 
String  [  ]  targets  =  DevicePoolUtils  .  getLoggingTarget  (  device  )  ; 
if  (  targets  !=  null  &&  targets  .  length  >  0  )  for  (  String   target  :  targets  )  { 
xmlLogging  .  addLoggingTarget  (  target  )  ; 
} 
if  (  currLoggingInfo  !=  null  &&  currLoggingInfo  .  length  >  1  )  for  (  int   i  =  1  ;  i  <  currLoggingInfo  .  length  ;  i  ++  )  { 
...
if  (  !  data  .  is_empty  (  )  )  old_factor  =  data  .  extractString  (  )  ; 
data  =  db  .  get_device_property  (  device  .  getDeviceName  (  )  ,  "poll_ring_depth"  )  ; 
if  (  !  data  .  is_empty  (  )  )  ring_depth  =  data  .  extractString  (  )  ; 
if  (  old_factor  !=  null  ||  ring_depth  !=  null  )  { 
PollConfig   xmlPollConfig  =  xmlDevice  .  addNewPolling  (  )  ; 
if  (  old_factor  !=  null  )  xmlPollConfig  .  setOldfactor  (  old_factor  )  ; 
if  (  ring_depth  !=  null  )  xmlPollConfig  .  setRingdepth  (  ring_depth  )  ; 
} 
}  catch  (  DevFailed   e  )  { 
return  ; 
} 
...
if  (  descr  !=  null  &&  descr  .  length  (  )  >  0  )  xmlLibElement  .  setDescription  (  ctrlClass  .  getDescription  (  )  )  ; 
...
if  (  hasDisplayUnit  )  xmlAttrUnits  .  setDisplayUnit  (  attr  .  display_unit  )  ; 
if  (  hasUnit  )  xmlAttrUnits  .  setUnit  (  attr  .  unit  )  ; 
if  (  hasStandardUnit  )  xmlAttrUnits  .  setStandardUnit  (  attr  .  standard_unit  )  ; 
} 
...
if  (  hasMinValue  )  xmlAttrRange  .  setMin  (  attr  .  min_value  )  ; 
if  (  hasMaxValue  )  xmlAttrRange  .  setMax  (  attr  .  max_value  )  ; 
} 
...
if  (  hasMinWarning  )  xmlAttrAlarms  .  setMinWarning  (  attr  .  alarms  .  min_warning  )  ; 
if  (  hasMaxWarning  )  xmlAttrAlarms  .  setMaxWarning  (  attr  .  alarms  .  max_warning  )  ; 
if  (  hasMinAlarm  )  xmlAttrAlarms  .  setMinAlarm  (  attr  .  alarms  .  min_alarm  )  ; 
if  (  hasMaxAlarm  )  xmlAttrAlarms  .  setMaxAlarm  (  attr  .  alarms  .  max_alarm  )  ; 
if  (  hasDeltaT  )  xmlAttrAlarms  .  setDeltaT  (  attr  .  alarms  .  delta_t  )  ; 
if  (  hasDeltaVal  )  xmlAttrAlarms  .  setDeltaVal  (  attr  .  alarms  .  delta_val  )  ; 
} 
...
if  (  absChangeEvent  )  xmlAttrChangeEvent  .  setAbsolute  (  attr  .  events  .  ch_event  .  abs_change  )  ; 
if  (  relChangeEvent  )  xmlAttrChangeEvent  .  setRelative  (  attr  .  events  .  ch_event  .  rel_change  )  ; 
} 
if  (  anyArchEvent  )  { 
AttrArchiveEvent   xmlAttrArchiveEvent  =  xmlAttrEvents  .  addNewArchiveEvent  (  )  ; 
if  (  absArchEvent  )  xmlAttrArchiveEvent  .  setAbsolute  (  attr  .  events  .  arch_event  .  abs_change  )  ; 
if  (  relArchEvent  )  xmlAttrArchiveEvent  .  setRelative  (  attr  .  events  .  arch_event  .  rel_change  )  ; 
if  (  perArchEvent  )  xmlAttrArchiveEvent  .  setPeriod  (  attr  .  events  .  arch_event  .  period  )  ; 
} 
if  (  anyPerEvent  )  { 
...
if  (  currentDevicePollingInfo  ==  null  ||  currentDevicePollingInfo  .  length  ==  0  )  return  ; 
String  [  ]  attrPollingInfo  =  null  ; 
for  (  String  [  ]  attrPI  :  currentDevicePollingInfo  )  { 
if  (  !  attrPI  [  0  ]  .  equalsIgnoreCase  (  "attribute"  )  )  continue  ; 
if  (  !  attrPI  [  1  ]  .  equalsIgnoreCase  (  attr  .  name  )  )  continue  ; 
...
if  (  xmlStr  !=  null  )  xmlValue  .  set  (  xmlStr  )  ; 
...
}  else   if  (  tangoType  ==  TangoConst  .  Tango_DEV_LONG  ||  tangoType  ==  TangoConst  .  Tango_DEV_ULONG  ||  tangoType  ==  TangoConst  .  Tango_DEV_USHORT  ||  tangoType  ==  TangoConst  .  Tango_DEV_SHORT  )  { 
...
}  else   if  (  tangoType  ==  TangoConst  .  Tango_DEV_DOUBLE  ||  tangoType  ==  TangoConst  .  Tango_DEV_FLOAT  )  { 
...
if  (  saveLevel  ==  IPreferences  .  PoolPropertySaveLevel  .  never  )  return  ; 
...
for  (  String   s  :  v  )  xmlProp  .  addItem  (  s  )  ; 
} 
xmlProp  .  setName  (  prop  .  getName  (  )  )  ; 
} 
} 
...
if  (  !  filter  .  isValid  (  prop  )  )  continue  ; 
...
if  (  saveLevel  ==  IPreferences  .  PoolPropertySaveLevel  .  never  )  return   false  ;  else   if  (  saveLevel  ==  IPreferences  .  PoolPropertySaveLevel  .  essencial  )  return   str  .  equalsIgnoreCase  (  DevicePoolUtils  .  POOL_PROP_POOL_PATH  )  ;  else   if  (  saveLevel  ==  IPreferences  .  PoolPropertySaveLevel  .  exaustive  )  return  !  str  .  equalsIgnoreCase  (  "Controller"  )  ;  else   if  (  saveLevel  ==  IPreferences  .  PoolPropertySaveLevel  .  all  )  return   true  ; 
return   true  ; 
} 
} 
...
if  (  saveLevel  ==  IPreferences  .  ElementPropertySaveLevel  .  never  )  return   false  ;  else   if  (  saveLevel  ==  IPreferences  .  ElementPropertySaveLevel  .  propsWithoutDefaultValue  )  return  !  property  .  hasDefaultValue  (  )  ;  else   if  (  saveLevel  ==  IPreferences  .  ElementPropertySaveLevel  .  propsWithOverwrittenValue  )  return  (  !  property  .  hasDefaultValue  (  )  )  ||  (  !  property  .  getDefaultValue  (  )  .  equals  (  property  .  getValue  (  )  )  )  ;  else   if  (  saveLevel  ==  IPreferences  .  ElementPropertySaveLevel  .  all  )  return   true  ; 
return   true  ; 
} 
} 
...
if  (  saveLevel  ==  IPreferences  .  ElementAttributeSaveLevel  .  never  )  return   false  ;  else   if  (  saveLevel  ==  IPreferences  .  ElementAttributeSaveLevel  .  writable  )  return   attr  .  writable  !=  AttrWriteType  .  READ  ;  else   if  (  saveLevel  ==  IPreferences  .  ElementAttributeSaveLevel  .  exaustive  )  return  !  attr  .  name  .  equalsIgnoreCase  (  "state"  )  &&  !  attr  .  name  .  equalsIgnoreCase  (  "status"  )  ;  else   if  (  saveLevel  ==  IPreferences  .  ElementAttributeSaveLevel  .  all  )  return   true  ; 
return   true  ; 
} 
} 
