...
public   PdfPKCS7Extended  (  byte  [  ]  contentsKey  ,  byte  [  ]  certsKey  ,  String   provider  )  { 
try  { 
...
public   PdfPKCS7Extended  (  byte  [  ]  contentsKey  ,  String   provider  )  { 
try  { 
this  .  provider  =  provider  ; 
...
public   PdfPKCS7Extended  (  PrivateKey   privKey  ,  Certificate  [  ]  certChain  ,  CRL  [  ]  crlList  ,  String   hashAlgorithm  ,  String   provider  ,  boolean   hasRSAdata  )  throws   InvalidKeyException  ,  NoSuchProviderException  ,  NoSuchAlgorithmException  { 
