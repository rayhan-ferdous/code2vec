...
static   final   byte   THREAD_STATE_NEW  =  0  ; 

static   final   byte   THREAD_STATE_DEAD  =  1  ; 

static   final   byte   THREAD_STATE_STARTED  =  2  ; 

static   final   byte   THREAD_STATE_RUNNING  =  3  ; 

static   final   byte   THREAD_STATE_MON_WAITING  =  4  ; 

static   final   byte   THREAD_STATE_CONDVAR_WAITING  =  5  ; 

static   final   byte   THREAD_STATE_SLEEPING  =  6  ; 

static   final   byte   THREAD_STATE_JOIN  =  7  ; 

static   final   byte   THREAD_STATE_SYSTEM_WAITING  =  8  ; 

static   final   byte   THREAD_STATE_SUSPENDED  =  (  byte  )  0x80  ; 
...
static   native   int   getObjectAddress  (  Object   obj  )  ; 
...
static   native   Object   memGetReference  (  int   base  ,  int   offset  )  ; 
...
NXTConnection   conn  =  Bluetooth  .  waitForConnection  (  0  ,  NXTConnection  .  PACKET  )  ; 
...
private   void   sendErrorReply  (  PacketStream   in  ,  short   errorCode  )  throws   ProxyConnectionException  { 
PacketStream   ps  =  new   PacketStream  (  this  ,  in  .  id  (  )  ,  Packet  .  Reply  ,  errorCode  )  ; 
ps  .  send  (  )  ; 
} 
...
while  (  !  stopListener  )  { 
System  .  gc  (  )  ; 
if  (  programStarted  )  setDaemon  (  true  )  ; 
p  =  waitForPacket  (  )  ; 
setDaemon  (  false  )  ; 
if  (  p  ==  null  )  { 
break  ; 
...
ps  .  send  (  )  ; 
handled  =  true  ; 
monitor  .  setEventOptions  (  DBG_PROGRAM_START  ,  DebugInterface  .  DBG_EVENT_ENABLE  )  ; 
monitor  .  setEventOptions  (  DebugInterface  .  DBG_PROGRAM_EXIT  ,  DebugInterface  .  DBG_EVENT_ENABLE  )  ; 
monitor  .  setEventOptions  (  DebugInterface  .  DBG_THREAD_START  ,  DebugInterface  .  DBG_EVENT_ENABLE  )  ; 
monitor  .  setEventOptions  (  DebugInterface  .  DBG_THREAD_STOP  ,  DebugInterface  .  DBG_EVENT_ENABLE  )  ; 
monitor  .  setEventOptions  (  DebugInterface  .  DBG_EXCEPTION  ,  DebugInterface  .  DBG_EVENT_ENABLE  )  ; 
monitor  .  setEventOptions  (  DebugInterface  .  DBG_BREAKPOINT  ,  DebugInterface  .  DBG_EVENT_ENABLE  )  ; 
monitor  .  setEventOptions  (  DebugInterface  .  DBG_SINGLE_STEP  ,  DebugInterface  .  DBG_EVENT_ENABLE  )  ; 
...
if  (  index  <  0  ||  index  >=  vmElements  .  length  (  )  ||  length  <  0  ||  index  +  length  >  vmElements  .  length  (  )  )  { 
...
if  (  object  !=  null  )  fields  =  VM  .  getVM  (  )  .  getFields  (  object  )  ; 
int   count  =  in  .  readInt  (  )  ; 
for  (  int   i  =  0  ;  i  <  count  ;  i  ++  )  { 
try  { 
...
private   void   invokeMethod  (  int   methodId  ,  Thread   thread  ,  Object   thisObject  ,  PacketStream   ps  )  { 
...
switch  (  val  .  type  )  { 
case   VM  .  VM_BOOLEAN  : 
if  (  tagged  )  ps  .  writeByte  (  BOOLEAN_TAG  )  ; 
size  =  1  ; 
break  ; 
case   VM  .  VM_BYTE  : 
if  (  tagged  )  ps  .  writeByte  (  BYTE_TAG  )  ; 
size  =  1  ; 
break  ; 
case   VM  .  VM_CHAR  : 
if  (  tagged  )  ps  .  writeByte  (  CHAR_TAG  )  ; 
size  =  2  ; 
break  ; 
case   VM  .  VM_SHORT  : 
if  (  tagged  )  ps  .  writeByte  (  SHORT_TAG  )  ; 
size  =  2  ; 
break  ; 
case   VM  .  VM_INT  : 
if  (  tagged  )  ps  .  writeByte  (  INT_TAG  )  ; 
size  =  4  ; 
break  ; 
case   VM  .  VM_FLOAT  : 
if  (  tagged  )  ps  .  writeByte  (  FLOAT_TAG  )  ; 
size  =  4  ; 
break  ; 
case   VM  .  VM_OBJECT  : 
int   addr  =  memPeekInt  (  0  ,  val  .  addr  )  ; 
if  (  tagged  )  ps  .  writeByte  (  getTagFromObject  (  memGetReference  (  0  ,  addr  )  )  )  ; 
ps  .  writeObjectId  (  addr  )  ; 
return  ; 
case   VM  .  VM_LONG  : 
if  (  tagged  )  ps  .  writeByte  (  LONG_TAG  )  ; 
size  =  8  ; 
break  ; 
case   VM  .  VM_DOUBLE  : 
if  (  tagged  )  ps  .  writeByte  (  DOUBLE_TAG  )  ; 
size  =  8  ; 
break  ; 
} 
switch  (  size  )  { 
...
if  (  p2  !=  null  )  waitingQueue  .  put  (  idString  ,  null  )  ; 
} 
if  (  p2  ==  null  )  { 
...
if  (  !  p  .  replied  )  throw   new   RuntimeException  (  )  ; 
} 
} 
} 
