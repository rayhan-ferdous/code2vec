...
out  .  append  (  "</td></tr>\n"  )  ; 
value  =  store  .  getProperty  (  "security.protocol"  )  ; 
out  .  append  (  "<tr><td align='left'>Server Protocol</td><td>\n"  )  ; 
options  =  new   HashMap  <  String  ,  String  >  (  )  ; 
options  .  put  (  "http"  ,  "http"  )  ; 
options  .  put  (  "https"  ,  "https"  )  ; 
out  .  append  (  htmlDropMenu  (  options  ,  "security.protocol"  ,  value  ,  ""  )  )  ; 
out  .  append  (  "(changes require service restart)"  )  ; 
out  .  append  (  "</td><td><img style='cursor:hand;cursor:pointer;' border=0 src='/images/help24.png' alt='help' align='absmiddle' onClick=\"showHelp('security.protocol');\" width='24' height='24'>"  )  ; 
out  .  append  (  "</td></tr>\n"  )  ; 
value  =  store  .  getProperty  (  "security.port"  )  ; 
out  .  append  (  "<tr><td align='left'>Server Port</td><td>\n"  )  ; 
out  .  append  (  "<input type='text' name='security.port' value='"  +  value  +  "' size='6'>\n"  )  ; 
out  .  append  (  "(changes require service restart)"  )  ; 
out  .  append  (  "</td><td><img style='cursor:hand;cursor:pointer;' border=0 src='/images/help24.png' alt='help' align='absmiddle' onClick=\"showHelp('security.port');\" width='24' height='24'>"  )  ; 
out  .  append  (  "</td></tr>\n"  )  ; 
