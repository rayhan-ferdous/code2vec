...
screen  [  0  ]  =  new   Screen  (  rootid  ,  colormapid  ,  fgPixel  ,  bgPixel  ,  0  ,  width  ,  height  ,  width  /  3  ,  height  /  3  ,  1  ,  1  ,  defaultv  .  id  ,  0  ,  0  ,  defaultv  .  depth  .  depth  ,  depth  )  ; 
...
screen  [  0  ]  .  defaultColormap  =  Colormap  .  getColormap  (  colormapid  ,  screen  [  0  ]  ,  defaultv  ,  0  ,  serverClient  )  ; 
...
if  (  defaultv  .  clss  ==  0  &&  defaultv  .  depth  .  depth  ==  8  )  { 
for  (  int   i  =  1  ;  i  <  255  ;  i  ++  )  { 
...
System  .  err  .  println  (  "ACL warning: unauthorized access from "  +  socket  .  getInetAddress  (  )  )  ; 
try  { 
socket  .  close  (  )  ; 
}  catch  (  Exception   e  )  { 
} 
...
System  .  out  .  println  (  "protocol: error "  +  Integer  .  toHexString  (  byte_order  [  0  ]  )  )  ; 
continue  ; 
} 
