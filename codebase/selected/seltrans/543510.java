...
if  (  item  .  endsWith  (  "/"  )  )  resourcelist  .  addAll  (  Arrays  .  asList  (  file  .  listFiles  (  )  )  )  ;  else   resourcelist  .  add  (  file  )  ; 
} 
} 
return   resourcelist  ; 
} 
...
for  (  File   source  :  getResourceList  (  iosresources  )  )  if  (  !  blacklist  .  contains  (  source  .  getName  (  )  )  )  FileUtils  .  copyInSync  (  source  ,  new   File  (  outputdir  ,  source  .  getName  (  )  )  )  ; 
} 

private   File   findIcon  (  String   img  ,  String   iosresources  )  { 
img  +=  ".png"  ; 
for  (  File   item  :  getResourceList  (  iosresources  )  )  if  (  item  .  getName  (  )  .  equals  (  img  )  )  return   item  ; 
return   null  ; 
} 
...
if  (  infile  ==  null  )  infile  =  findIcon  (  "Icon"  ,  iosresources  )  ; 
if  (  infile  !=  null  )  if  (  prerender  )  copyFile  (  infile  ,  outfile  )  ;  else   IconPainter  .  createIcon  (  infile  ,  outfile  )  ; 
} 

public   static   void   createFile  (  File   fout  ,  String   content  )  { 
File   parent  =  fout  .  getParentFile  (  )  ; 
parent  .  mkdirs  (  )  ; 
if  (  !  parent  .  isDirectory  (  )  )  throw   new   BuildException  (  "Unable to create directory "  +  parent  .  getPath  (  )  )  ; 
...
if  (  outF  ==  null  )  throw   new   BuildException  (  "Destination file should not be null"  )  ; 
if  (  outF  .  isFile  (  )  )  delete  (  outF  )  ; 
...
if  (  current  .  isDirectory  (  )  )  for  (  File   sub  :  current  .  listFiles  (  )  )  delete  (  sub  )  ; 
if  (  current  .  exists  (  )  &&  (  !  current  .  delete  (  )  )  )  throw   new   BuildException  (  "Unable to remove "  +  current  .  getPath  (  )  )  ; 
} 

public   static   void   copyInSync  (  File   source  ,  File   target  )  { 
if  (  target  .  exists  (  )  &&  source  .  isDirectory  (  )  !=  target  .  isDirectory  (  )  )  FileUtils  .  delete  (  target  )  ; 
if  (  source  .  isDirectory  (  )  )  { 
if  (  (  !  target  .  exists  (  )  )  &&  (  !  target  .  mkdirs  (  )  )  )  throw   new   BuildException  (  "Unable to create directory "  +  target  .  getPath  (  )  )  ; 
for  (  File   item  :  source  .  listFiles  (  )  )  copyInSync  (  item  ,  new   File  (  target  ,  item  .  getName  (  )  )  )  ; 
}  else   if  (  source  .  length  (  )  !=  target  .  length  (  )  )  copyFile  (  source  ,  target  )  ; 
} 

public   static   void   checkFileIsValid  (  File   test  ,  String   type  )  { 
if  (  test  ==  null  )  throw   new   BuildException  (  type  +  " file should not be null"  )  ; 
if  (  !  test  .  isFile  (  )  )  throw   new   BuildException  (  type  +  " '"  +  test  .  getPath  (  )  +  "' is not a file"  )  ; 
if  (  !  test  .  canRead  (  )  )  throw   new   BuildException  (  type  +  " file '"  +  test  .  getPath  (  )  +  "' is not readable"  )  ; 
} 

public   static   String   readFile  (  File   input  )  { 
if  (  input  ==  null  )  throw   new   BuildException  (  "Input file not defined"  )  ; 
...
if  (  output  ==  null  )  throw   new   BuildException  (  "Input file not defined"  )  ; 
