...
if  (  bAppend  )  logicalFileDescriptor  .  readFileHeader  (  this  )  ;  else  { 
if  (  m_bMustWriteFileHeader  )  logicalFileDescriptor  .  writeFileHeader  (  this  )  ; 
} 
} 
return   bOpened  ; 
} 
...
c  =  tBytes  [  n  ]  ; 
if  (  c  >=  0  &&  c  <  32  )  m_out  .  write  (  0  )  ; 
m_out  .  write  (  c  )  ; 
} 
if  (  bEndsWithCRLF  )  { 
m_out  .  write  (  FileEndOfLine  .  CR  )  ; 
m_out  .  write  (  FileEndOfLine  .  LF  )  ; 
}  else   if  (  bEndsWithLF  )  m_out  .  write  (  FileEndOfLine  .  LF  )  ; 
FileIOAccounting  .  endFileIO  (  )  ; 
}  catch  (  IOException   e  )  { 
FileIOAccounting  .  endFileIO  (  )  ; 
e  .  printStackTrace  (  )  ; 
...
c  =  tBytes  [  nPosSource  ]  ; 
if  (  c  >=  0  &&  c  <  32  )  m_tc  [  nPosDest  ++  ]  =  0  ; 
m_tc  [  nPosDest  ++  ]  =  c  ; 
} 
if  (  bEndsWithCRLF  )  { 
m_tc  [  nPosDest  ++  ]  =  FileEndOfLine  .  CR  ; 
m_tc  [  nPosDest  ++  ]  =  FileEndOfLine  .  LF  ; 
}  else   if  (  bEndsWithLF  )  m_tc  [  nPosDest  ++  ]  =  FileEndOfLine  .  LF  ; 
try  { 
FileIOAccounting  .  startFileIO  (  FileIOAccountingType  .  Write  )  ; 
