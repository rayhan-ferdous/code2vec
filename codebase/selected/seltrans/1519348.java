...
synchronized   void   fireCtcpUnknownRequestEventReceived  (  CtcpUnknownRequestEvent   event  )  { 
for  (  Iterator   it  =  ctcpListeners  .  iterator  (  )  ;  it  .  hasNext  (  )  ;  )  { 
try  { 
...
synchronized   void   fireCtcpUnknownReplyEventReceived  (  CtcpUnknownReplyEvent   event  )  { 
for  (  Iterator   it  =  ctcpListeners  .  iterator  (  )  ;  it  .  hasNext  (  )  ;  )  { 
try  { 
