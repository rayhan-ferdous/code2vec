...
import   java  .  util  .  *  ; 
import   com  .  be  .  vo  .  TypeVO  ; 
import   com  .  util  .  comparator  .  *  ; 
import   com  .  util  .  table  .  *  ; 

public   class   TypeModel   implements   ITableModel  { 

protected   TypeVO   fTotal  ; 

protected   TypeVO  [  ]  fTableData  ; 
...
TypeVO   vo  =  fTableData  [  fSortOrder  [  pRow  ]  ]  ; 
...
if  (  "valueNum"  .  equals  (  pColumn  )  )  return   new   Long  (  vo  .  getValueNum  (  )  )  ; 
if  (  "valueText"  .  equals  (  pColumn  )  )  return   vo  .  getValueText  (  )  ; 
...
if  (  "valueNum"  .  equals  (  pColumn  )  )  return   new   Long  (  fTotal  .  getValueNum  (  )  )  ; 
if  (  "valueText"  .  equals  (  pColumn  )  )  return   fTotal  .  getValueText  (  )  ; 
...
if  (  "valueNum"  .  equals  (  pColumn  )  )  { 
Sorter   sorter  =  new   Sorter  (  )  ; 
long  [  ]  temp  =  new   long  [  fTableData  .  length  ]  ; 
for  (  int   i  =  0  ;  i  <  temp  .  length  ;  i  ++  )  { 
temp  [  i  ]  =  fTableData  [  i  ]  .  getValueNum  (  )  ; 
} 
fSortOrder  =  sorter  .  sortLong  (  temp  ,  fSortOrder  ,  up  )  ; 
} 
if  (  "valueText"  .  equals  (  pColumn  )  )  { 
fComparator  =  new   StringComparator  (  )  ; 
String  [  ]  temp  =  new   String  [  fTableData  .  length  ]  ; 
for  (  int   i  =  0  ;  i  <  temp  .  length  ;  i  ++  )  { 
