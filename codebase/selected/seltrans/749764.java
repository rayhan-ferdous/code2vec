...
import   com  .  prolix  .  editor  .  oics  .  data  .  TMEntry  ; 
import   com  .  prolix  .  editor  .  oics  .  data  .  lom  .  datatypes  .  OICSLOMIdentifier  ; 
...
public   class   InsertOICSTMTemplateCommand   extends   Command  { 

private   LearningDesignDataModel   quelle  ; 
...
private   List   tmpOrigActivities  ; 

private   TMEntry   tmQuelle  ; 

private   OICSLOMIdentifier   tmRelation  ; 




public   InsertOICSTMTemplateCommand  (  LearningDesignDataModel   quelle  ,  TMEntry   tmQuelle  )  { 
super  (  "Insert Template: "  +  tmQuelle  .  getTitle  (  )  )  ; 
this  .  quelle  =  quelle  ; 
this  .  tmQuelle  =  tmQuelle  ; 
...
this  .  tmpOrigActivities  =  new   ArrayList  (  )  ; 
} 
...
public   void   setLddm  (  ModelDiagramMain   element  )  { 
this  .  lddm  =  (  LearningDesignDataModel  )  element  .  getLearningDesign  (  )  .  getDataModel  (  )  ; 
} 
...
if  (  tmQuelle  .  getLOMData  (  )  !=  null  )  { 
String   identString  =  tmQuelle  .  getLOMData  (  )  .  getId  (  )  ; 
if  (  identString  !=  null  )  { 
tmRelation  =  new   OICSLOMIdentifier  (  identString  )  ; 
if  (  !  lddm  .  getOics  (  )  .  containsTMRelation  (  tmRelation  )  )  { 
lddm  .  getOics  (  )  .  addTMRelation  (  tmRelation  )  ; 
}  else  { 
tmRelation  =  null  ; 
} 
} 
} 
Iterator   it  =  tmpOrigActivities  .  iterator  (  )  ; 
while  (  it  .  hasNext  (  )  )  { 
ModelDiagramActivity   activity  =  (  ModelDiagramActivity  )  it  .  next  (  )  ; 
this  .  copyActivty  (  activity  )  ; 
} 
it  =  quelle  .  getModel  (  )  .  getChildren  (  )  .  iterator  (  )  ; 
while  (  it  .  hasNext  (  )  )  { 
Object   o  =  it  .  next  (  )  ; 
if  (  o   instanceof   ModelSyncPoint  )  { 
this  .  copySyncPoint  (  (  ModelSyncPoint  )  o  )  ; 
} 
} 
it  =  quelle  .  getModel  (  )  .  getChildren  (  )  .  iterator  (  )  ; 
while  (  it  .  hasNext  (  )  )  { 
Object   o  =  it  .  next  (  )  ; 
if  (  o   instanceof   ModelTextNode  )  { 
copyNodePoint  (  (  ModelTextNode  )  o  )  ; 
} 
} 
...
Iterator   it  =  quelle  .  getModel  (  )  .  getChildren  (  )  .  iterator  (  )  ; 
while  (  it  .  hasNext  (  )  )  { 
Object   o  =  it  .  next  (  )  ; 
if  (  o   instanceof   ModelDiagramActivity  )  { 
tmpOrigActivities  .  add  (  o  )  ; 
} 
} 
it  =  tmpOrigActivities  .  iterator  (  )  ; 
if  (  it  .  hasNext  (  )  )  { 
ModelDiagramActivity   activity  =  (  ModelDiagramActivity  )  it  .  next  (  )  ; 
...
CopyPasteMapRolesDialog   diag  =  new   CopyPasteMapRolesDialog  (  Display  .  getCurrent  (  )  .  getActiveShell  (  )  ,  this  .  lddm  ,  rollen  ,  true  )  ; 
...
if  (  tmRelation  !=  null  )  { 
lddm  .  getOics  (  )  .  removeTMRelation  (  tmRelation  )  ; 
} 
} 
