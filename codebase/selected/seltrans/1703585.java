...
import   static   jonkoshare  .  util  .  SystemProperties  .  SPOOL_MIDI  ; 
...
private   static   final   Logger   log  =  Logger  .  getLogger  (  MidiThread  .  class  .  getName  (  )  )  ; 
...
log  .  throwing  (  getClass  (  )  .  getName  (  )  ,  "failed to hook onto midi device(s)"  ,  ex  )  ; 
return   false  ; 
} 
return   true  ; 
} 
...
log  .  throwing  (  getClass  (  )  .  getName  (  )  ,  "failed to hook onto synthesizer"  ,  ex  )  ; 
return   false  ; 
} 
return   true  ; 
} 
...
log  .  throwing  (  getClass  (  )  .  getName  (  )  ,  "failed to add chord events"  ,  ex  )  ; 
} 
} 
...
log  .  throwing  (  getClass  (  )  .  getName  (  )  ,  "failed to close old metronome device"  ,  ex  )  ; 
} 
} 
metronomeDevice  =  dev  ; 
...
log  .  throwing  (  getClass  (  )  .  getName  (  )  ,  "failed to init new metronome device"  ,  ex  )  ; 
} 
} 
} 
...
log  .  throwing  (  getClass  (  )  .  getName  (  )  ,  "failed to close old out device"  ,  ex  )  ; 
} 
} 
outDevice  =  dev  ; 
...
log  .  throwing  (  getClass  (  )  .  getName  (  )  ,  "failed to open new out device"  ,  ex  )  ; 
} 
} 
} 
