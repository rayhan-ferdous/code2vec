...
IdentityHashMap  <  Class  <  ?  >  ,  RegisteredMapFactory  >  mapMapping  =  new   IdentityHashMap  <  Class  <  ?  >  ,  RegisteredMapFactory  >  (  initialMapSize  )  ; 
...
strategy  =  new   ExplicitIdStrategy  (  collectionMapping  ,  collections  ,  mapMapping  ,  maps  ,  enumMapping  ,  enums  ,  pojoMapping  ,  pojos  ,  delegateMapping  ,  delegates  )  ; 
} 
...
if  (  id  <  1  )  throw   new   IllegalArgumentException  (  "collection ids start at 1."  )  ; 
if  (  id  >=  strategy  .  collections  .  size  (  )  )  grow  (  strategy  .  collections  ,  id  +  1  )  ;  else   if  (  strategy  .  collections  .  get  (  id  )  !=  null  )  { 
...
if  (  strategy  .  collectionMapping  .  put  (  factory  .  typeClass  (  )  ,  rf  )  !=  null  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  factory  .  typeClass  (  )  )  ; 
return   this  ; 
} 
...
if  (  id  <  1  )  throw   new   IllegalArgumentException  (  "map ids start at 1."  )  ; 
if  (  id  >=  strategy  .  maps  .  size  (  )  )  grow  (  strategy  .  maps  ,  id  +  1  )  ;  else   if  (  strategy  .  maps  .  get  (  id  )  !=  null  )  { 
throw   new   IllegalArgumentException  (  "Duplicate id registration: "  +  id  +  " ("  +  factory  .  typeClass  (  )  +  ")"  )  ; 
} 
RegisteredMapFactory   rf  =  new   RegisteredMapFactory  (  id  ,  factory  )  ; 
strategy  .  maps  .  set  (  id  ,  rf  )  ; 
if  (  strategy  .  mapMapping  .  put  (  factory  .  typeClass  (  )  ,  rf  )  !=  null  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  factory  .  typeClass  (  )  )  ; 
return   this  ; 
} 
...
if  (  id  <  1  )  throw   new   IllegalArgumentException  (  "enum ids start at 1."  )  ; 
if  (  id  >=  strategy  .  enums  .  size  (  )  )  grow  (  strategy  .  enums  ,  id  +  1  )  ;  else   if  (  strategy  .  enums  .  get  (  id  )  !=  null  )  { 
...
if  (  strategy  .  enumMapping  .  put  (  clazz  ,  reio  )  !=  null  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  clazz  )  ; 
return   this  ; 
} 
...
RegisteredEnumIO   reio  =  new   RegisteredEnumIO  (  id  ,  eio  )  ; 
strategy  .  enums  .  set  (  id  ,  reio  )  ; 
if  (  strategy  .  enumMapping  .  put  (  eio  .  enumClass  ,  reio  )  !=  null  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  eio  .  enumClass  )  ; 
return   this  ; 
} 
...
if  (  clazz  .  isInterface  (  )  ||  Modifier  .  isAbstract  (  clazz  .  getModifiers  (  )  )  )  throw   new   IllegalArgumentException  (  "Not a concrete class: "  +  clazz  )  ; 
if  (  id  <  1  )  throw   new   IllegalArgumentException  (  "pojo ids start at 1."  )  ; 
if  (  id  >=  strategy  .  pojos  .  size  (  )  )  grow  (  strategy  .  pojos  ,  id  +  1  )  ;  else   if  (  strategy  .  pojos  .  get  (  id  )  !=  null  )  { 
throw   new   IllegalArgumentException  (  "Duplicate id registration: "  +  id  +  " ("  +  clazz  .  getName  (  )  +  ")"  )  ; 
} 
if  (  strategy  .  pojoMapping  .  containsKey  (  clazz  )  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  clazz  )  ; 
...
if  (  strategy  .  pojoMapping  .  containsKey  (  schema  .  typeClass  (  )  )  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  schema  .  typeClass  (  )  )  ; 
...
if  (  strategy  .  pojoMapping  .  containsKey  (  baseClass  )  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  baseClass  )  ; 
BaseHS  <  ?  >  wrapper  =  strategy  .  pojoMapping  .  get  (  implClass  )  ; 
if  (  wrapper  ==  null  )  throw   new   IllegalArgumentException  (  "Must register the impl class first. "  +  implClass  )  ; 
...
if  (  id  <  1  )  throw   new   IllegalArgumentException  (  "delegate ids start at 1."  )  ; 
if  (  id  >=  strategy  .  delegates  .  size  (  )  )  grow  (  strategy  .  delegates  ,  id  +  1  )  ;  else   if  (  strategy  .  delegates  .  get  (  id  )  !=  null  )  { 
...
if  (  strategy  .  delegateMapping  .  put  (  delegate  .  typeClass  (  )  ,  rd  )  !=  null  )  throw   new   IllegalArgumentException  (  "Duplicate registration for: "  +  delegate  .  typeClass  (  )  )  ; 
return   this  ; 
} 
} 
...
if  (  wrapper  ==  null  &&  create  )  throw   new   UnknownTypeException  (  "pojo: "  +  typeClass  )  ; 
return   wrapper  ; 
} 

protected   EnumIO  <  ?  extends   Enum  <  ?  >  >  getEnumIO  (  Class  <  ?  >  enumClass  )  { 
final   RegisteredEnumIO   reio  =  enumMapping  .  get  (  enumClass  )  ; 
if  (  reio  ==  null  )  throw   new   UnknownTypeException  (  "enum: "  +  enumClass  )  ; 
return   reio  .  eio  ; 
} 
...
if  (  rf  ==  null  )  { 
if  (  clazz  .  getName  (  )  .  startsWith  (  "java.util"  )  )  return   CollectionSchema  .  MessageFactories  .  valueOf  (  clazz  .  getSimpleName  (  )  )  ; 
...
if  (  rf  ==  null  )  { 
if  (  clazz  .  getName  (  )  .  startsWith  (  "java.util"  )  )  return   MapSchema  .  MessageFactories  .  valueOf  (  clazz  .  getSimpleName  (  )  )  ; 
...
if  (  factory  ==  null  )  throw   new   UnknownTypeException  (  "collection: "  +  clazz  )  ; 
...
if  (  factory  ==  null  )  throw   new   UnknownTypeException  (  "collection id: "  +  id  +  " (Outdated registry)"  )  ; 
return   factory  ; 
} 
...
if  (  factory  ==  null  )  throw   new   UnknownTypeException  (  "map: "  +  clazz  )  ; 
output  .  writeUInt32  (  fieldNumber  ,  factory  .  id  ,  false  )  ; 
} 
...
if  (  factory  ==  null  )  throw   new   UnknownTypeException  (  "map id: "  +  id  +  " (Outdated registry)"  )  ; 
return   factory  ; 
} 
...
if  (  reio  ==  null  )  throw   new   UnknownTypeException  (  "enum: "  +  clazz  )  ; 
...
if  (  reio  ==  null  )  throw   new   UnknownTypeException  (  "enum id: "  +  id  +  " (Outdated registry)"  )  ; 
return   reio  .  eio  ; 
} 
...
@  SuppressWarnings  (  "unchecked"  ) 
protected  <  T  >  Delegate  <  T  >  tryWriteDelegateIdTo  (  Output   output  ,  int   fieldNumber  ,  Class  <  T  >  clazz  )  throws   IOException  { 
...
if  (  wrapper  ==  null  )  throw   new   UnknownTypeException  (  "pojo: "  +  clazz  )  ; 
...
if  (  wrapper  ==  null  )  throw   new   UnknownTypeException  (  "pojo: "  +  message  .  getClass  (  )  )  ; 
output  .  writeUInt32  (  fieldNumber  ,  wrapper  .  id  ,  false  )  ; 
...
if  (  Map  .  class  .  isAssignableFrom  (  clazz  )  )  return   EnumMap  .  class  .  isAssignableFrom  (  clazz  )  ?  CID_ENUM_MAP  :  mapId  (  clazz  )  ; 
if  (  Collection  .  class  .  isAssignableFrom  (  clazz  )  )  return   EnumSet  .  class  .  isAssignableFrom  (  clazz  )  ?  CID_ENUM_SET  :  collectionId  (  clazz  )  ; 
final   BaseHS  <  ?  >  wrapper  =  pojoMapping  .  get  (  clazz  )  ; 
if  (  wrapper  ==  null  )  throw   new   UnknownTypeException  (  "pojo: "  +  clazz  )  ; 
return  (  wrapper  .  id  <<  5  )  |  CID_POJO  ; 
} 
...
abstract   static   class   BaseHS  <  T  >  extends   HasSchema  <  T  >  { 
