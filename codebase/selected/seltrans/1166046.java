...
private   static   final   String   DESCRIPTION  =  "Query specified remote Application Entity (=Hanging Protocol SCP) "  +  "and optional (s. option -dest) also retrieve matching HP instances. "  +  "If <port> is not specified, DICOM default port 104 is assumed. "  +  "If also no <host> is specified localhost is assumed.\n"  +  "Options:"  ; 

private   static   final   String   EXAMPLE  =  "\nExample: dcmhpqr HPSCP@localhost:11112 "  +  "-qHangingProtocolName NeurosurgeryPlan -user T1234:HOSP1\n"  +  "=> Query Application Entity HPSCP listening on local port 11112 "  +  "for hanging protocol with name 'NeurosurgeryPlan' and user with "  +  "code 'T1234:HOSP1'."  ; 

private   static   char  [  ]  SECRET  =  {  's'  ,  'e'  ,  'c'  ,  'r'  ,  'e'  ,  't'  }  ; 

private   static   final   int  [  ]  RETURN_KEYS  =  {  Tag  .  SOPClassUID  ,  Tag  .  SOPInstanceUID  ,  Tag  .  HangingProtocolName  ,  Tag  .  HangingProtocolDescription  ,  Tag  .  HangingProtocolLevel  ,  Tag  .  HangingProtocolCreator  ,  Tag  .  HangingProtocolCreationDatetime  ,  Tag  .  NumberOfPriorsReferenced  ,  Tag  .  HangingProtocolUserGroupName  ,  Tag  .  NumberOfScreens  }  ; 

private   static   final   int  [  ]  HP_DEF_SEQ_RETURN_KEYS  =  {  Tag  .  Modality  ,  Tag  .  Laterality  }  ; 
...
keys  .  putNestedDicomObject  (  Tag  .  HangingProtocolDefinitionSequence  ,  hpDefKeys  )  ; 
for  (  int   i  =  0  ;  i  <  HP_DEF_SEQ_RETURN_KEYS  .  length  ;  i  ++  )  { 
hpDefKeys  .  putNull  (  HP_DEF_SEQ_RETURN_KEYS  [  i  ]  ,  null  )  ; 
} 
hpDefKeys  .  putNestedDicomObject  (  Tag  .  AnatomicRegionSequence  ,  anatomicRegKeys  )  ; 
hpDefKeys  .  putNestedDicomObject  (  Tag  .  ProcedureCodeSequence  ,  procCodeKeys  )  ; 
hpDefKeys  .  putNestedDicomObject  (  Tag  .  ReasonForRequestedProcedureCodeSequence  ,  reasonForReqProcKeys  )  ; 
keys  .  putNestedDicomObject  (  Tag  .  HangingProtocolUserIdentificationCodeSequence  ,  hpUserIDCodeKeys  )  ; 
keys  .  putNestedDicomObject  (  Tag  .  NominalScreenDefinitionSequence  ,  new   BasicDicomObject  (  )  )  ; 
} 
...
tc  [  0  ]  =  new   TransferCapability  (  UID  .  HangingProtocolInformationModelFIND  ,  ts  ,  TransferCapability  .  SCU  )  ; 
tc  [  1  ]  =  new   TransferCapability  (  UID  .  HangingProtocolInformationModelMOVE  ,  ts  ,  TransferCapability  .  SCU  )  ; 
...
TransferCapability   tc  =  assoc  .  getTransferCapabilityAsSCU  (  UID  .  HangingProtocolInformationModelFIND  )  ; 
if  (  tc  ==  null  )  { 
throw   new   NoPresentationContextException  (  "Hanging Protocol Query not supported by "  +  remoteAE  .  getAETitle  (  )  )  ; 
} 
System  .  out  .  println  (  "Send Query Request:"  )  ; 
System  .  out  .  println  (  keys  .  toString  (  )  )  ; 
DimseRSP   rsp  =  assoc  .  cfind  (  UID  .  HangingProtocolInformationModelFIND  ,  priority  ,  keys  ,  tc  .  getTransferSyntax  (  )  [  0  ]  ,  cancelAfter  )  ; 
...
if  (  moveDest  ==  null  )  throw   new   IllegalStateException  (  "moveDest == null"  )  ; 
TransferCapability   tc  =  assoc  .  getTransferCapabilityAsSCU  (  UID  .  HangingProtocolInformationModelMOVE  )  ; 
if  (  tc  ==  null  )  throw   new   NoPresentationContextException  (  "Hanging Protocol Retrieve not supported by "  +  remoteAE  .  getAETitle  (  )  )  ; 
...
System  .  out  .  println  (  "Send Retrieve Request using "  +  UIDDictionary  .  getDictionary  (  )  .  prompt  (  cuid  )  +  ":"  )  ; 
System  .  out  .  println  (  keys  .  toString  (  )  )  ; 
...
assoc  .  cmove  (  cuid  ,  priority  ,  keys  ,  tc  .  getTransferSyntax  (  )  [  0  ]  ,  moveDest  ,  rspHandler  )  ; 
} 
...
if  (  cl  .  hasOption  (  "connectTO"  )  )  dcmhpqr  .  setConnectTimeout  (  parseInt  (  cl  .  getOptionValue  (  "connectTO"  )  ,  "illegal argument of option -connectTO"  ,  1  ,  Integer  .  MAX_VALUE  )  )  ; 
if  (  cl  .  hasOption  (  "reaper"  )  )  dcmhpqr  .  setAssociationReaperPeriod  (  parseInt  (  cl  .  getOptionValue  (  "reaper"  )  ,  "illegal argument of option -reaper"  ,  1  ,  Integer  .  MAX_VALUE  )  )  ; 
if  (  cl  .  hasOption  (  "rspTO"  )  )  dcmhpqr  .  setDimseRspTimeout  (  parseInt  (  cl  .  getOptionValue  (  "rspTO"  )  ,  "illegal argument of option -rspTO"  ,  1  ,  Integer  .  MAX_VALUE  )  )  ; 
if  (  cl  .  hasOption  (  "acceptTO"  )  )  dcmhpqr  .  setAcceptTimeout  (  parseInt  (  cl  .  getOptionValue  (  "acceptTO"  )  ,  "illegal argument of option -acceptTO"  ,  1  ,  Integer  .  MAX_VALUE  )  )  ; 
if  (  cl  .  hasOption  (  "releaseTO"  )  )  dcmhpqr  .  setReleaseTimeout  (  parseInt  (  cl  .  getOptionValue  (  "releaseTO"  )  ,  "illegal argument of option -releaseTO"  ,  1  ,  Integer  .  MAX_VALUE  )  )  ; 
if  (  cl  .  hasOption  (  "soclosedelay"  )  )  dcmhpqr  .  setSocketCloseDelay  (  parseInt  (  cl  .  getOptionValue  (  "soclosedelay"  )  ,  "illegal argument of option -soclosedelay"  ,  1  ,  10000  )  )  ; 
if  (  cl  .  hasOption  (  "rcvpdulen"  )  )  dcmhpqr  .  setMaxPDULengthReceive  (  parseInt  (  cl  .  getOptionValue  (  "rcvpdulen"  )  ,  "illegal argument of option -rcvpdulen"  ,  1  ,  10000  )  *  KB  )  ; 
if  (  cl  .  hasOption  (  "sndpdulen"  )  )  dcmhpqr  .  setMaxPDULengthSend  (  parseInt  (  cl  .  getOptionValue  (  "sndpdulen"  )  ,  "illegal argument of option -sndpdulen"  ,  1  ,  10000  )  *  KB  )  ; 
if  (  cl  .  hasOption  (  "sosndbuf"  )  )  dcmhpqr  .  setSendBufferSize  (  parseInt  (  cl  .  getOptionValue  (  "sosndbuf"  )  ,  "illegal argument of option -sosndbuf"  ,  1  ,  10000  )  *  KB  )  ; 
if  (  cl  .  hasOption  (  "sorcvbuf"  )  )  dcmhpqr  .  setReceiveBufferSize  (  parseInt  (  cl  .  getOptionValue  (  "sorcvbuf"  )  ,  "illegal argument of option -sorcvbuf"  ,  1  ,  10000  )  *  KB  )  ; 
dcmhpqr  .  setPackPDV  (  !  cl  .  hasOption  (  "pdv1"  )  )  ; 
dcmhpqr  .  setTcpNoDelay  (  !  cl  .  hasOption  (  "tcpdelay"  )  )  ; 
if  (  cl  .  hasOption  (  "C"  )  )  dcmhpqr  .  setCancelAfter  (  parseInt  (  cl  .  getOptionValue  (  "C"  )  ,  "illegal argument of option -C"  ,  1  ,  Integer  .  MAX_VALUE  )  )  ; 
if  (  cl  .  hasOption  (  "lowprior"  )  )  dcmhpqr  .  setPriority  (  CommandUtils  .  LOW  )  ; 
if  (  cl  .  hasOption  (  "highprior"  )  )  dcmhpqr  .  setPriority  (  CommandUtils  .  HIGH  )  ; 
if  (  cl  .  hasOption  (  "q"  )  )  { 
String  [  ]  matchingKeys  =  cl  .  getOptionValues  (  "q"  )  ; 
for  (  int   i  =  1  ;  i  <  matchingKeys  .  length  ;  i  ++  ,  i  ++  )  dcmhpqr  .  addMatchingKey  (  Tag  .  toTagPath  (  matchingKeys  [  i  -  1  ]  )  ,  matchingKeys  [  i  ]  )  ; 
} 
if  (  cl  .  hasOption  (  "r"  )  )  { 
String  [  ]  returnKeys  =  cl  .  getOptionValues  (  "r"  )  ; 
for  (  int   i  =  0  ;  i  <  returnKeys  .  length  ;  i  ++  )  dcmhpqr  .  addReturnKey  (  Tag  .  toTagPath  (  returnKeys  [  i  ]  )  )  ; 
} 
if  (  cl  .  hasOption  (  "mod"  )  )  { 
...
dcmhpqr  .  addAnatomicRegMatchingKey  (  Tag  .  CodingSchemeDesignator  ,  anatomicRegion  [  1  ]  )  ; 
} 
if  (  cl  .  hasOption  (  "pc"  )  )  { 
...
dcmhpqr  .  addReasonForReqProcMatchingKey  (  Tag  .  CodingSchemeDesignator  ,  reasonForReqProc  [  1  ]  )  ; 
} 
...
dcmhpqr  .  addHPUserIDCodeMatchingKey  (  Tag  .  CodingSchemeDesignator  ,  hpUserIDCode  [  1  ]  )  ; 
} 
...
dcmhpqr  .  setKeyStorePassword  (  cl  .  getOptionValue  (  "keystorepw"  )  )  ; 
} 
if  (  cl  .  hasOption  (  "keypw"  )  )  { 
dcmhpqr  .  setKeyPassword  (  cl  .  getOptionValue  (  "keypw"  )  )  ; 
} 
if  (  cl  .  hasOption  (  "truststore"  )  )  { 
dcmhpqr  .  setTrustStoreURL  (  cl  .  getOptionValue  (  "truststore"  )  )  ; 
} 
if  (  cl  .  hasOption  (  "truststorepw"  )  )  { 
dcmhpqr  .  setTrustStorePassword  (  cl  .  getOptionValue  (  "truststorepw"  )  )  ; 
} 
...
System  .  out  .  println  (  "Received "  +  result  .  size  (  )  +  " matching entries in "  +  (  (  t3  -  t2  )  /  1000F  )  +  "s"  )  ; 
if  (  dcmhpqr  .  isMove  (  )  )  { 
dcmhpqr  .  move  (  result  )  ; 
long   t4  =  System  .  currentTimeMillis  (  )  ; 
System  .  out  .  println  (  "Retrieved "  +  dcmhpqr  .  getTotalRetrieved  (  )  +  " objects (warning: "  +  dcmhpqr  .  getWarning  (  )  +  ", failed: "  +  dcmhpqr  .  getFailed  (  )  +  ") in "  +  (  (  t4  -  t3  )  /  1000F  )  +  "s"  )  ; 
} 
}  catch  (  IOException   e  )  { 
e  .  printStackTrace  (  )  ; 
...
OptionBuilder  .  withDescription  (  "set AET and local address of local "  +  "Application Entity, use ANONYMOUS and pick up any valid\n"  +  "local address to bind the socket by default"  )  ; 
...
OptionBuilder  .  hasArg  (  )  ; 
OptionBuilder  .  withDescription  (  "specify matching Anatomic Region Sequence Code Value and Coding Scheme Designator.\n"  +  "Code Value and Coding Scheme Designer are separated by ':'. For example, T1234:DCM4CHE."  )  ; 
opts  .  addOption  (  OptionBuilder  .  create  (  "ar"  )  )  ; 
OptionBuilder  .  withArgName  (  "ProcedureCode"  )  ; 
OptionBuilder  .  hasArg  (  )  ; 
OptionBuilder  .  withDescription  (  "specify matching Procedure Code Sequence Code Value and Coding Scheme Designator.\n"  +  "Code Value and Coding Scheme Designer are separated by ':'. For example, T1234:DCM4CHE."  )  ; 
opts  .  addOption  (  OptionBuilder  .  create  (  "pc"  )  )  ; 
OptionBuilder  .  withArgName  (  "ReasonCode"  )  ; 
OptionBuilder  .  hasArg  (  )  ; 
OptionBuilder  .  withDescription  (  "specify matching Reason for Requested Procedure Sequence Code Value and Coding Scheme Designator.\n"  +  "Code Value and Coding Scheme Designer are separated by ':'. For example, T1234:DCM4CHE."  )  ; 
opts  .  addOption  (  OptionBuilder  .  create  (  "rfrp"  )  )  ; 
OptionBuilder  .  withArgName  (  "HPUserIDCode"  )  ; 
OptionBuilder  .  hasArg  (  )  ; 
OptionBuilder  .  withDescription  (  "specify matching HP User ID Code Sequence Code Value and Coding Scheme Designator.\n"  +  "Code Value and Coding Scheme Designer are separated by ':'. For example, T1234:DCM4CHE."  )  ; 
