...
public   static   int   copyAvailable  (  InputStream   in  ,  OutputStream   out  )  throws   IOException  { 
...
try  { 
ObjectInputStream   o  =  new   ObjectInputStream  (  new   ByteArrayInputStream  (  serialized  )  )  ; 
