...
if  (  current  .  equals  (  -  1  )  )  throw   new   IOException  (  "End of stream"  )  ; 
...
if  (  !  current  .  equals  (  0x00  )  )  throw   new   IOException  (  "Wrong message format"  )  ; 
current  =  in  .  read  (  )  ; 
...
if  (  last  .  equals  (  -  1  )  )  throw   new   IOException  (  "End of stream"  )  ; 
Integer   current  =  in  .  read  (  )  ; 
...
for  (  String   s  :  arr  )  { 
String  [  ]  ar  =  s  .  split  (  "="  ,  2  )  ; 
if  (  ar  [  0  ]  .  equals  (  name  )  )  return   ar  [  1  ]  ; 
} 
...
for  (  String   s  :  arr  )  { 
String  [  ]  ar  =  s  .  split  (  "="  ,  2  )  ; 
if  (  ar  [  0  ]  .  trim  (  )  .  equals  (  name  )  )  return   ar  [  1  ]  ; 
} 
}  catch  (  UnsupportedEncodingException   e  )  { 
e  .  printStackTrace  (  )  ; 
} 
...
if  (  requestLine  .  length  <  2  )  throw   new   IOException  (  "Wrong Request-Line format: "  +  line  )  ; 
...
if  (  parts  .  length  !=  2  )  throw   new   IOException  (  "Wrong field format: "  +  line  )  ; 
String   name  =  parts  [  0  ]  ; 
String   value  =  parts  [  1  ]  ; 
if  (  name  .  equalsIgnoreCase  (  "Upgrade"  )  )  { 
if  (  !  value  .  equalsIgnoreCase  (  "WebSocket"  )  )  throw   new   IOException  (  "Wrong value of upgrade field: "  +  line  )  ; 
upgrade  =  true  ; 
}  else   if  (  name  .  equalsIgnoreCase  (  "Connection"  )  )  { 
if  (  !  value  .  equalsIgnoreCase  (  "Upgrade"  )  )  throw   new   IOException  (  "Wrong value of connection field: "  +  line  )  ; 
connection  =  true  ; 
}  else   if  (  name  .  equalsIgnoreCase  (  "Host"  )  )  { 
host  =  value  ; 
}  else   if  (  name  .  equalsIgnoreCase  (  "Origin"  )  )  { 
origin  =  value  ; 
}  else   if  (  (  name  .  equalsIgnoreCase  (  "Sec-WebSocket-Key1"  )  )  ||  (  name  .  equalsIgnoreCase  (  "Sec-WebSocket-Key2"  )  )  )  { 
...
number  /=  spaces  ; 
if  (  name  .  endsWith  (  "Key1"  )  )  keys  [  0  ]  =  number  ;  else   keys  [  1  ]  =  number  ; 
...
if  (  (  !  upgrade  )  ||  (  !  connection  )  ||  (  host  ==  null  )  ||  (  origin  ==  null  )  ||  (  keys  [  0  ]  ==  null  )  ||  (  keys  [  1  ]  ==  null  )  )  throw   new   IOException  (  "Missing handshake arguments"  )  ; 
...
if  (  cookie  !=  null  )  writeLine  (  "cookie: "  +  cookie  )  ; 
writeLine  (  ""  )  ; 
