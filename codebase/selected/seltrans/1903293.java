...
public   class   PAESCrowding   extends   Algorithm  { 
...
public   PAESCrowding  (  Problem   problem  )  { 
problem_  =  problem  ; 
} 
...
public   Solution   test  (  Solution   solution  ,  Solution   mutatedSolution  )  { 
if  (  solution  .  getCrowdingDistance  (  )  >  mutatedSolution  .  getCrowdingDistance  (  )  )  { 
