...
if  (  parsingItem  )  { 
if  (  qName  .  equalsIgnoreCase  (  "item"  )  )  { 
items  .  add  (  new   Item  (  itemTitle  ,  itemPubDate  ,  itemEnclosure  ,  itemGuid  ,  itemiTunesAuthor  ,  itemiTunesBlock  ,  itemiTunesDuration  ,  itemiTunesExplicit  ,  itemiTunesKeywords  ,  itemiTunesSubtitle  ,  itemiTunesSummary  ,  itemDescription  )  )  ; 
parsingItem  =  false  ; 
return  ; 
} 
...
if  (  parsingChannel  )  { 
if  (  qName  .  equalsIgnoreCase  (  "Channel"  )  )  { 
channel  =  new   Channel  (  channelTitle  ,  channelLink  ,  channelLanguage  ,  channelCopyright  ,  channelDescription  ,  channeliTunesAuthor  ,  channeliTunesBlock  ,  channeliTunesImage  ,  channeliTunesExplicit  ,  channeliTunesNewFeedURL  ,  channeliTunesSubtitle  ,  channeliTunesSummary  )  ; 
