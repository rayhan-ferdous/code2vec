...
if  (  !  (  thisObj   instanceof   NativeString  )  )  throw   incompatibleCallError  (  f  )  ; 
...
if  (  end  !=  end  ||  end  >  target  .  length  (  )  )  end  =  target  .  length  (  )  ;  else   if  (  end  <  0  )  end  =  0  ; 
...
double   end  ; 
if  (  start  <  0  )  start  =  0  ;  else   if  (  start  >  length  )  start  =  length  ; 
