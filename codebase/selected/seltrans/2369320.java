...
public   static   byte  [  ]  readFull  (  InputStream   in  ,  byte  [  ]  bs  ,  int   begin  ,  int   end1  )  throws   IOException  { 
Math2  .  range  (  begin  ,  end1  ,  bs  .  length  )  ; 
for  (  int   n  ;  begin  <  end1  ;  begin  +=  n  )  if  (  (  n  =  in  .  read  (  bs  ,  begin  ,  end1  -  begin  )  )  <=  0  )  throw   new   EOFException  (  )  ; 
return   bs  ; 
} 
...
public   static   class   Line   extends   InputStream  { 
...
if  (  begin  <  end1  )  return   bs  [  begin  ++  ]  &  255  ; 
...
if  (  end1  ==  bs  .  length  )  { 
if  (  begin  ==  0  )  throw   new   InvalidLengthException  (  "line too long : must <= "  +  (  bs  .  length  -  2  )  )  ; 
if  (  read  )  System  .  arraycopy  (  bs  ,  begin  ,  bs  ,  0  ,  end1  -  begin  )  ; 
end1  -=  begin  ; 
x  -=  begin  ; 
begin  =  0  ; 
} 
...
if  (  pre  )  for  (  int   x  =  begin  ;  ;  x  =  more  (  read  ,  x  )  )  for  (  ;  x  +  1  <  end1  ;  x  ++  )  if  (  bs  [  x  ]  ==  preEol  &&  bs  [  x  +  1  ]  ==  eol  )  return   x  ; 
for  (  int   x  =  begin  ;  ;  x  =  more  (  read  ,  x  )  )  for  (  ;  x  <  end1  ;  x  ++  )  if  (  bs  [  x  ]  ==  eol  )  return   x  ; 
} 
...
public   static   class   Upload   extends   InputStream  { 
...
split  [  0  ]  =  '\r'  ; 
split  [  1  ]  =  '\n'  ; 
if  (  split  .  length  >  5  &&  split  [  split  .  length  -  3  ]  ==  '-'  )  part  =  -  1  ; 
} 
...
if  (  part  >  0  )  throw   new   IllegalStateException  (  "current part unfinished"  )  ; 
...
if  (  l  .  length  (  )  >  0  )  { 
if  (  l  .  toLowerCase  (  )  .  startsWith  (  "content-type: "  )  )  type  =  l  .  substring  (  14  )  ; 
...
@  Override 
public   int   available  (  )  throws   IOException  { 
if  (  avail  >  0  ||  part  <=  0  )  return   avail  ; 
if  (  in  .  begin  >=  in  .  end1  )  in  .  more  (  true  ,  0  )  ; 
int   x  =  in  .  begin  ; 
if  (  in  .  bs  [  x  ++  ]  !=  '\r'  )  for  (  ;  ;  x  ++  )  if  (  x  ==  in  .  end1  ||  in  .  bs  [  x  ]  ==  '\r'  )  return   avail  =  x  -  in  .  begin  ; 
int   noMore  =  0  ; 
for  (  int   y  =  1  ;  y  <  split  .  length  ;  x  ++  ,  y  ++  )  { 
if  (  x  ==  in  .  end1  )  x  =  in  .  more  (  true  ,  x  )  ; 
if  (  in  .  bs  [  x  ]  !=  split  [  y  ]  ||  noMore  ==  1  )  if  (  in  .  bs  [  x  ]  ==  '-'  &&  y  ==  split  .  length  -  2  &&  noMore  ++  <  2  )  y  --  ;  else   for  (  ;  ;  x  ++  )  if  (  x  ==  in  .  end1  ||  in  .  bs  [  x  ]  ==  '\r'  )  return   avail  =  x  -  in  .  begin  ; 
} 
in  .  begin  =  x  ; 
part  =  noMore  ==  2  ?  -  1  :  0  ; 
return   avail  =  0  ; 
