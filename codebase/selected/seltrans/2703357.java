...
Statement   statement  =  sysLobSession  .  compileStatement  (  initialiseBlocksSQL  ,  ResultProperties  .  defaultPropsValue  )  ; 
...
Result   result  =  sysLobSession  .  executeCompiledStatement  (  deleteLobCall  ,  params  )  ; 
usageCountChanged  =  true  ; 
return   result  ; 
}  finally  { 
writeLock  .  unlock  (  )  ; 
...
Result   result  =  sysLobSession  .  executeCompiledStatement  (  deleteUnusedLobs  ,  ValuePool  .  emptyObjectArray  )  ; 
...
public   synchronized   Result   getLength  (  long   lobID  )  { 
writeLock  .  lock  (  )  ; 
try  { 
Object  [  ]  data  =  getLobHeader  (  lobID  )  ; 
if  (  data  ==  null  )  { 
...
public   synchronized   int   compare  (  BlobData   a  ,  byte  [  ]  b  )  { 
writeLock  .  lock  (  )  ; 
try  { 
...
return  (  (  (  int  )  aBytes  [  i  ]  )  &  0xff  )  >  (  (  (  int  )  bBytes  [  i  ]  )  &  0xff  )  ?  1  :  -  1  ; 
} 
aOffset  ++  ; 
bOffset  ++  ; 
if  (  aOffset  ==  aAddresses  [  aIndex  ]  [  LOBS  .  BLOCK_COUNT  ]  )  { 
...
public   synchronized   Result   getLob  (  long   lobID  ,  long   offset  ,  long   length  )  { 
...
int  [  ]  [  ]  targetBlocks  =  getBlockAddresses  (  newLobID  ,  0  ,  Integer  .  MAX_VALUE  )  ; 
try  { 
...
public   synchronized   Result   getChars  (  long   lobID  ,  long   offset  ,  int   length  )  { 
...
public   synchronized   Result   setChars  (  long   lobID  ,  long   offset  ,  char  [  ]  chars  )  { 
if  (  chars  .  length  ==  0  )  { 
return   ResultLob  .  newLobSetResponse  (  lobID  ,  0  )  ; 
} 
writeLock  .  lock  (  )  ; 
...
writeLock  .  lock  (  )  ; 
try  { 
Result   result  =  setBytesIS  (  lobID  ,  inputStream  ,  length  *  2  ,  adjustLength  )  ; 
if  (  result  .  isError  (  )  )  { 
return   result  ; 
} 
...
Result   result  =  sysLobSession  .  executeCompiledStatement  (  deleteLobPartCall  ,  params  )  ; 
...
Result   result  =  sysLobSession  .  executeCompiledStatement  (  updateLobLength  ,  params  )  ; 
return   result  ; 
} 
...
Result   result  =  sysLobSession  .  executeCompiledStatement  (  divideLobPartCall  ,  params  )  ; 
} 
...
Result   result  =  sysLobSession  .  executeCompiledStatement  (  createLobPartCall  ,  params  )  ; 
} 
