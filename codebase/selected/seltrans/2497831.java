...
import   java  .  util  .  *  ; 
import   com  .  debitors  .  vo  .  CustomerItemDiscountVO  ; 
import   com  .  util  .  comparator  .  *  ; 
import   com  .  util  .  table  .  *  ; 

public   class   CustomerItemDiscountModel   implements   ITableModel  { 

protected   CustomerItemDiscountVO   fTotal  ; 

protected   CustomerItemDiscountVO  [  ]  fTableData  ; 
...
public   CustomerItemDiscountModel  (  )  { 
super  (  )  ; 
} 

public   void   setData  (  Object  [  ]  data  )  { 
fTableData  =  (  CustomerItemDiscountVO  [  ]  )  data  ; 
...
CustomerItemDiscountVO   vo  =  fTableData  [  fSortOrder  [  pRow  ]  ]  ; 
...
if  (  "discountAmount"  .  equals  (  pColumn  )  )  return   fTotal  .  getDiscountAmount  (  )  ; 
