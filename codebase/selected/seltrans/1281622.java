...
private   final   SysTrayMenu   trayMenu  ; 

private   final   SysTrayMenuListener   trayListener  =  new   SysTrayMenuListener  (  )  { 

public   void   menuItemSelected  (  SysTrayMenuEvent   arg0  )  { 
String   selection  =  arg0  .  getActionCommand  (  )  ; 
if  (  selection  .  equals  (  "Restore"  )  )  { 
if  (  isVisible  (  )  )  setVisible  (  false  )  ;  else  { 
setVisible  (  true  )  ; 
setState  (  0  )  ; 
} 
}  else   if  (  selection  .  equals  (  "About"  )  )  getAboutHC  (  )  ;  else   if  (  selection  .  equals  (  "Modes"  )  )  setMode  (  )  ;  else   if  (  selection  .  equals  (  "Exit"  )  )  { 
dispose  (  )  ; 
System  .  exit  (  0  )  ; 
}  else   if  (  selection  .  equals  (  "Preferences"  )  )  { 
setTray  (  )  ; 
} 
} 
...
private   static   final   SysTrayMenuIcon   trayIcon  =  new   SysTrayMenuIcon  (  "images/md5"  )  ; 

private   static   boolean   isTray  =  false  ; 
...
dialog  .  setSize  (  130  ,  115  )  ; 
dialog  .  setLocationRelativeTo  (  me  )  ; 
dialog  .  setModal  (  true  )  ; 
final   JCheckBox   trayCheckBox  =  new   JCheckBox  (  "<html><center>Select to<br>show application<br>in Tray</center></html>"  )  ; 
trayCheckBox  .  setSelected  (  isTray  )  ; 
dialog  .  add  (  trayCheckBox  ,  BorderLayout  .  NORTH  )  ; 
...
if  (  trayCheckBox  .  isSelected  (  )  )  isTray  =  true  ;  else   isTray  =  false  ; 
if  (  !  isTray  ||  trayMenu  .  isIconVisible  (  )  )  trayMenu  .  hideIcon  (  )  ;  else   trayMenu  .  showIcon  (  )  ; 
dialog  .  dispose  (  )  ; 
} 
}  )  ; 
op  .  add  (  ok  )  ; 
...
op  .  add  (  cancel  )  ; 
dialog  .  add  (  op  ,  BorderLayout  .  SOUTH  )  ; 
...
if  (  content  !=  null  )  obj  =  content  .  getTransferData  (  flavor  )  ; 
return   obj  ; 
} 
...
if  (  arg0  .  getNewState  (  )  ==  1  &&  isTray  )  setVisible  (  false  )  ; 
if  (  arg0  .  getNewState  (  )  ==  0  )  userText  .  requestFocusInWindow  (  )  ; 
} 
}  )  ; 
...
trayMenu  =  new   SysTrayMenu  (  trayIcon  ,  "Hash Calculator "  +  version  +  "\nMade By: Dhruva Sagar"  )  ; 
trayMenu  .  hideIcon  (  )  ; 
setSysTrayMenu  (  )  ; 
trayIcon  .  addSysTrayMenuListener  (  trayListener  )  ; 
} 
...
if  (  option  ==  JFileChooser  .  APPROVE_OPTION  &&  (  fileChooser  .  getSelectedFile  (  )  !=  null  )  )  userText  .  setText  (  fileChooser  .  getSelectedFile  (  )  .  getAbsolutePath  (  )  )  ; 
} 
...
}  else   status  .  setText  (  "Enter Text in Text Field to calculate Hash first"  )  ; 
} 
...
dispose  (  )  ; 
System  .  exit  (  0  )  ; 
}  else   status  .  setText  (  "Cancelled Exit"  )  ; 
} 
...
JOptionPane  .  showMessageDialog  (  me  ,  "<html>"  +  "<font face='Comic Sans MS'>"  +  "<table border='0' cellspacing='0' cellpadding='0'>"  +  "<td><img src="  +  getClass  (  )  .  getResource  (  "../images/md5.gif"  )  +  "></td>"  +  "<td width='25'></td>"  +  "<td><font color='blue' size='5'>Hash Calculator "  +  version  +  "</font></td>"  +  "</table><font><br>"  +  "<hr>"  +  "<center>It calculates the<br>"  +  "MD2<br>MD5<br>SHA-1<br>SHA-256<br>SHA-384<br>SHA-512<br>"  +  "</center>"  +  "Hash of a input text as Selected from the Combo Box<br>"  +  "in the screen and displays it in the following text field.<br><br>"  +  "It automatically copies the hash into the Clip Board.<br><br>"  +  "<center>Made By:<br>"  +  "<font size='4' color='red'>Dhruva Sagar</font></center><br>"  +  "</font>"  +  "</html>"  ,  "About Hash Calculator"  ,  JOptionPane  .  PLAIN_MESSAGE  )  ; 
} 
...
JOptionPane  .  showMessageDialog  (  me  ,  "<html><center><table border='0' cellspacing='0' cellpadding='0'>"  +  "<font face='Comic Sans MS'>"  +  "<td><img src="  +  getClass  (  )  .  getResource  (  "../images/me.jpg"  )  +  "></td>"  +  "<td width='10'></td>"  +  "<td>Contact <font color='red'>Dhruva Sagar</font> at:<br>"  +  "</font><a href=\"mailto:dhruva.sagar@gmail.com?Subject=Hello dude, Here are my Comments\">dhruva.sagar@gmail.com</a><br>"  +  "<font face='Comic Sans MS'>All Comments are welcome<br>"  +  "<center><img src="  +  getClass  (  )  .  getResource  (  "../images/D.gif"  )  +  "</center>"  +  "</font></td></table>"  +  "</center></html>"  ,  "Contact At"  ,  JOptionPane  .  PLAIN_MESSAGE  )  ; 
} 
...
if  (  pasted  .  equals  (  ""  )  )  status  .  setText  (  "Clip Board is Empty"  )  ;  else  { 
if  (  userText  .  getSelectedText  (  )  !=  null  )  userText  .  setText  (  userText  .  getText  (  )  .  replace  (  userText  .  getSelectedText  (  )  ,  pasted  )  )  ;  else   userText  .  setText  (  pasted  )  ; 
...
if  (  option  ==  JFileChooser  .  APPROVE_OPTION  &&  !  fileChooser  .  getSelectedFile  (  )  .  exists  (  )  )  fileName  =  (  fileChooser  .  getSelectedFile  (  )  .  toString  (  )  .  endsWith  (  ".hash"  )  ?  fileChooser  .  getSelectedFile  (  )  .  toString  (  )  :  fileChooser  .  getSelectedFile  (  )  .  toString  (  )  +  ".hash"  )  ;  else   if  (  option  ==  JFileChooser  .  APPROVE_OPTION  )  fileName  =  fileChooser  .  getSelectedFile  (  )  .  toString  (  )  ; 
...
int   i  =  0  ; 
while  (  i  <  data  .  size  (  )  )  { 
out  .  println  (  data  .  get  (  i  )  .  toString  (  )  )  ; 
i  ++  ; 
} 
out  .  println  (  algorithm  .  getSelectedItem  (  )  .  toString  (  )  +  " Hash of "  +  "\""  +  userText  .  getText  (  )  +  "\""  +  " is:"  +  hex  )  ; 
out  .  close  (  )  ; 
...
if  (  textMode  )  status  .  setText  (  "Enter Text in Text Field and click to calculate hash"  )  ;  else   status  .  setText  (  "Select the File to be Hashed"  )  ; 
} 
} 
...
public   void   actionPerformed  (  ActionEvent   ae  )  { 
if  (  hashFile  .  isSelected  (  )  )  textMode  =  false  ;  else   textMode  =  true  ; 
...
public   void   actionPerformed  (  ActionEvent   ae  )  { 
if  (  textMode  )  status  .  setText  (  "Text Mode"  )  ;  else   status  .  setText  (  "File Mode"  )  ; 
options  .  dispose  (  )  ; 
} 
}  )  ; 
if  (  textMode  )  status  .  setText  (  "Text Mode"  )  ;  else   status  .  setText  (  "File Mode"  )  ; 
...
JMenuItem   item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  1  ]  ; 
item  .  setEnabled  (  !  userText  .  getText  (  )  .  equals  (  ""  )  ||  !  hashText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  2  ]  ; 
item  .  setEnabled  (  !  hashText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  3  ]  ; 
item  .  setEnabled  (  !  textMode  )  ; 
item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  4  ]  ; 
item  .  setEnabled  (  textMode  )  ; 
item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  4  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  ; 
item  .  setEnabled  (  !  userText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  4  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  1  ]  ; 
item  .  setEnabled  (  !  userText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  4  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  2  ]  ; 
item  .  setEnabled  (  !  pasteString  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  myContextMenu  .  getSubElements  (  )  [  5  ]  ; 
item  .  setEnabled  (  !  hashText  .  getText  (  )  .  equals  (  ""  )  )  ; 
} 
...
myContextMenu  .  add  (  item  )  ; 
item  =  new   JMenuItem  (  "Preferences"  ,  blankGif  )  ; 
item  .  addActionListener  (  new   ActionListener  (  )  { 
...
JMenuItem   item  =  (  JMenuItem  )  textFieldContextMenu  .  getSubElements  (  )  [  0  ]  ; 
item  .  setEnabled  (  textMode  &&  !  userText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  textFieldContextMenu  .  getSubElements  (  )  [  1  ]  ; 
item  .  setEnabled  (  textMode  &&  !  userText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  textFieldContextMenu  .  getSubElements  (  )  [  2  ]  ; 
...
item  .  setEnabled  (  !  hashText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  menuBar  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  2  ]  ; 
item  .  setEnabled  (  !  textMode  )  ; 
item  =  (  JMenuItem  )  menuBar  .  getSubElements  (  )  [  1  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  ; 
item  .  setEnabled  (  textMode  )  ; 
item  =  (  JMenuItem  )  menuBar  .  getSubElements  (  )  [  1  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  ; 
item  .  setEnabled  (  !  userText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  menuBar  .  getSubElements  (  )  [  1  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  1  ]  ; 
item  .  setEnabled  (  !  userText  .  getText  (  )  .  equals  (  ""  )  )  ; 
item  =  (  JMenuItem  )  menuBar  .  getSubElements  (  )  [  1  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  2  ]  ; 
item  .  setEnabled  (  !  pasteString  (  )  .  equals  (  ""  )  &&  textMode  )  ; 
item  =  (  JMenuItem  )  menuBar  .  getSubElements  (  )  [  1  ]  .  getSubElements  (  )  [  0  ]  .  getSubElements  (  )  [  1  ]  ; 
item  .  setEnabled  (  !  hashText  .  getText  (  )  .  equals  (  ""  )  )  ; 
} 
...
private   void   setSysTrayMenu  (  )  { 
SysTrayMenuItem   item  =  new   SysTrayMenuItem  (  "Exit"  ,  "Exit"  )  ; 
item  .  addSysTrayMenuListener  (  trayListener  )  ; 
trayMenu  .  addItem  (  item  )  ; 
trayMenu  .  addSeparator  (  )  ; 
item  =  new   SysTrayMenuItem  (  "Preferences"  ,  "Preferences"  )  ; 
item  .  addSysTrayMenuListener  (  trayListener  )  ; 
trayMenu  .  addItem  (  item  )  ; 
trayMenu  .  addSeparator  (  )  ; 
item  =  new   SysTrayMenuItem  (  "About"  ,  "About"  )  ; 
item  .  addSysTrayMenuListener  (  trayListener  )  ; 
trayMenu  .  addItem  (  item  )  ; 
item  =  new   SysTrayMenuItem  (  "Modes"  ,  "Modes"  )  ; 
item  .  addSysTrayMenuListener  (  trayListener  )  ; 
trayMenu  .  addItem  (  item  )  ; 
trayMenu  .  addSeparator  (  )  ; 
item  =  new   SysTrayMenuItem  (  "Restore/Hide"  ,  "Restore"  )  ; 
item  .  addSysTrayMenuListener  (  trayListener  )  ; 
trayMenu  .  addItem  (  item  )  ; 
} 
...
btn  =  (  JButton  )  toolBar  .  getComponents  (  )  [  2  ]  ; 
btn  .  setEnabled  (  !  textMode  )  ; 
btn  =  (  JButton  )  toolBar  .  getComponents  (  )  [  4  ]  ; 
btn  .  setEnabled  (  !  hashText  .  getText  (  )  .  equals  (  ""  )  )  ; 
btn  =  (  JButton  )  toolBar  .  getComponents  (  )  [  5  ]  ; 
