package   ca  .  ucalgary  .  cpsc  .  ebe  .  fitClipse  .  render  .  util  ; 
...
File   file  =  files  [  i  ]  ; 
if  (  file  .  isDirectory  (  )  )  deleteFileSystemDirectory  (  file  )  ;  else   deleteFile  (  file  )  ; 
} 
deleteFile  (  current  )  ; 
} 
...
if  (  !  file  .  delete  (  )  )  throw   new   RuntimeException  (  "Could not delete '"  +  file  .  getAbsoluteFile  (  )  +  "'"  )  ; 
...
if  (  files  [  i  ]  .  isDirectory  (  )  )  dirSet  .  add  (  files  [  i  ]  )  ;  else   fileSet  .  add  (  files  [  i  ]  )  ; 
} 
