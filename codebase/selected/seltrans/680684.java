...
if  (  startedOk  &&  isRunning  &&  !  isUCI  )  report  .  reportError  (  context  .  getString  (  R  .  string  .  uci_protocol_error  )  )  ; 
} 
}  )  ; 
startupThread  .  start  (  )  ; 
...
engineProc  .  waitFor  (  )  ; 
isRunning  =  false  ; 
if  (  !  startedOk  )  report  .  reportError  (  context  .  getString  (  R  .  string  .  failed_to_start_engine  )  )  ;  else  { 
...
if  (  (  ep  ==  null  )  ||  Thread  .  currentThread  (  )  .  isInterrupted  (  )  )  return  ; 
...
try  { 
Process   ep  =  engineProc  ; 
if  (  ep  !=  null  )  ep  .  getOutputStream  (  )  .  write  (  data  .  getBytes  (  )  )  ; 
}  catch  (  IOException   e  )  { 
} 
} 
...
if  (  startupThread  !=  null  )  startupThread  .  interrupt  (  )  ; 
