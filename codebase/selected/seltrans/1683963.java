...
import   sjtu  .  llgx  .  util  .  SessionFactory  ; 
import   sjtu  .  llgx  .  vo  .  FieldVO  ; 
import   sjtu  .  llgx  .  vo  .  TableColumnsVO  ; 
import   sjtu  .  llgx  .  vo  .  TableFieldVO  ; 
import   sjtu  .  llgx  .  vo  .  TableStatusVO  ; 
...
t  .  append  (  ","  +  (  usehex  &&  !  value  .  equals  (  ""  )  &&  (  type  .  contains  (  "char"  )  ||  type  .  contains  (  "text"  )  )  ?  "0x"  +  bin2hex  (  value  ,  JavaCenterHome  .  JCH_CHARSET  )  :  "\'"  +  mysqlEscapeString  (  value  )  +  "\'"  )  )  ; 
} 
...
t2  .  append  (  ","  +  (  usehex  &&  !  value  .  equals  (  ""  )  &&  (  type  .  contains  (  "char"  )  ||  type  .  contains  (  "text"  )  )  ?  "0x"  +  bin2hex  (  value  ,  JavaCenterHome  .  JCH_CHARSET  )  :  "\'"  +  mysqlEscapeString  (  value  )  +  "\'"  )  )  ; 
} 
