...
if  (  !  hasAllListeners  (  )  )  throw   new   JGCSException  (  "Must register the missing listeners."  +  " Make sure that you have at least one listener of the membership and another for the block notification."  )  ; 
...
if  (  e  .  type  ==  AppiaEventException  .  CLOSEDCHANNEL  )  throw   new   ClosedSessionException  (  "Session is closed."  ,  e  )  ;  else   throw   new   JGCSException  (  "Error sending Join event."  ,  e  )  ; 
} 
...
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Leaving from Appia Session... [ControlSession.leave()]"  )  ; 
...
if  (  e  .  type  ==  AppiaEventException  .  CLOSEDCHANNEL  )  throw   new   ClosedSessionException  (  "Channel is closed."  ,  e  )  ;  else   throw   new   JGCSException  (  "Error sending Leave event."  ,  e  )  ; 
} 
try  { 
leaveLatch  .  await  (  )  ; 
}  catch  (  InterruptedException   e  )  { 
...
leaveLatch  =  null  ; 
for  (  Channel   ch  :  appiaChannels  )  ch  .  end  (  )  ; 
setMembership  (  null  )  ; 
...
if  (  !  (  event   instanceof   View  )  )  return  ; 
} 
if  (  event   instanceof   BlockOk  )  { 
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Received block event."  )  ; 
...
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Processing first view."  )  ; 
incomingMembership  =  new   AppiaMembership  (  (  View  )  event  )  ; 
incomingMembership  .  setNewMembers  (  null  )  ; 
}  else  { 
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Processing next view."  )  ; 
incomingMembership  =  new   AppiaMembership  (  (  View  )  event  )  ; 
...
if  (  incomingMembership  .  getJoinedMembers  (  )  !=  null  )  for  (  SocketAddress   peer  :  incomingMembership  .  getJoinedMembers  (  )  )  this  .  notifyJoin  (  peer  )  ; 
if  (  incomingMembership  .  getLeavedMembers  (  )  !=  null  )  for  (  SocketAddress   peer  :  incomingMembership  .  getLeavedMembers  (  )  )  this  .  notifyLeave  (  peer  )  ; 
if  (  incomingMembership  .  getFailedMembers  (  )  !=  null  )  for  (  SocketAddress   peer  :  incomingMembership  .  getFailedMembers  (  )  )  this  .  notifyFailed  (  peer  )  ; 
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "currentMembership:"  +  incomingMembership  .  addresses  )  ; 
}  else  { 
...
for  (  int   i  =  0  ;  i  <  failed  .  length  ;  i  ++  )  if  (  failed  [  i  ]  )  failedMembers  .  add  (  addresses  .  get  (  i  )  )  ; 
...
for  (  SocketAddress   peer  :  this  .  addresses  )  newMembersList  .  add  (  peer  )  ; 
}  else   for  (  SocketAddress   peer  :  this  .  addresses  )  if  (  !  oldMembership  .  addresses  .  contains  (  peer  )  )  newMembersList  .  add  (  peer  )  ; 
if  (  newMembersList  .  isEmpty  (  )  )  newMembersList  =  null  ; 
} 
...
for  (  SocketAddress   peer  :  oldMembership  .  addresses  )  if  (  !  this  .  addresses  .  contains  (  peer  )  &&  (  failedmembersList  ==  null  ||  !  failedmembersList  .  contains  (  peer  )  )  )  oldMembersList  .  add  (  peer  )  ; 
if  (  oldMembersList  .  isEmpty  (  )  )  oldMembersList  =  null  ; 
if  (  failedmembersList  !=  null  &&  failedmembersList  .  isEmpty  (  )  )  failedmembersList  =  null  ; 
} 
...
return  (  addresses  ==  null  ?  false  :  addresses  .  contains  (  mbr  )  )  ; 
} 
