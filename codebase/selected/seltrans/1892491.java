...
Component   comp  =  resolver  .  resolveName  (  item  .  getID  (  )  ,  item  .  getProperties  (  )  ,  null  )  ; 
return   comp  ; 
}  else  { 
return   null  ; 
} 
...
if  (  o   instanceof   SeparatorElement  )  menu  .  addSeparator  (  )  ;  else   menu  .  add  (  getComponent  (  o  )  )  ; 
} 
return   menu  ; 
} 
...
if  (  root  ==  null  &&  item  !=  null  &&  item   instanceof   MenubarElement  )  root  =  (  MenubarElement  )  item  ; 
} 
