...
private   static   final   Resources   resources  =  Resources  .  getTemplateBundle  (  "dash.file"  )  ; 
...
if  (  result  .  exists  (  )  )  { 
if  (  checkPostToken  (  )  ||  (  checkReferer  (  )  &&  confirmOpenUnnecessary  (  )  )  )  redirectTo  (  filename  ,  result  )  ;  else   displayNeedInfoForm  (  filename  ,  null  ,  false  ,  OPEN_CONFIRM  ,  file  )  ; 
return  ; 
} 
savePathInfo  (  )  ; 
...
boolean   redirectSetting  =  "redirect"  .  equals  (  Settings  .  getVal  (  "extDoc.openMethod"  )  )  ; 
if  (  !  remoteRequest  &&  !  redirectSetting  &&  DOC_OPENER  .  openDocument  (  result  )  )  { 
out  .  print  (  "Expires: 0\r\n"  )  ; 
super  .  writeHeader  (  )  ; 
...
String   message  =  resources  .  format  (  "No_Such_File_Message_FMT"  ,  filenameDisplayName  )  ; 
out  .  print  (  "<html><head><title>"  +  title  +  "</title></head>\n"  +  "<body><h1>"  +  title  +  "</h1>\n"  +  message  +  "</body></html>"  )  ; 
} 
...
message  =  resources  .  format  (  resPrefix  +  "_File_Message_FMT"  ,  HTMLUtils  .  escapeEntities  (  file  .  getPath  (  )  )  ,  new   Integer  (  isTemplate  ?  1  :  0  )  )  ; 
out  .  println  (  message  )  ; 
out  .  print  (  "<P>"  )  ; 
} 
String   headerInfo  =  getProp  (  e  ,  filename  +  HEADER_PROP  ,  null  )  ; 
if  (  headerInfo  !=  null  )  out  .  println  (  "<p>"  +  HTMLUtils  .  escapeEntities  (  headerInfo  )  +  "</p>"  )  ; 
...
if  (  dotPos  !=  -  1  )  resourceName  =  StringUtils  .  findAndReplace  (  resourceName  ,  "."  ,  "%2e"  )  ; 
} 
