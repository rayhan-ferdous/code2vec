...
comp  .  setBounds  (  (  (  int  )  tk  .  getScreenSize  (  )  .  getWidth  (  )  -  width  )  >  >  1  ,  (  (  int  )  tk  .  getScreenSize  (  )  .  getHeight  (  )  -  height  )  >  >  1  ,  width  ,  height  )  ; 
} 
...
if  (  current  .  isFile  (  )  )  { 
if  (  !  current  .  isHidden  (  )  )  ret  ++  ; 
}  else  { 
if  (  !  current  .  isHidden  (  )  )  ret  +=  countFiles  (  current  )  ; 
} 
} 
return   ret  ; 
} 
...
for  (  String   current  :  modNames  )  if  (  visited  .  get  (  current  )  ==  null  ||  !  visited  .  get  (  current  )  )  tsort  (  current  ,  M  ,  result  ,  visited  )  ; 
...
if  (  visited  .  get  (  w  )  ==  null  ||  !  visited  .  get  (  w  )  )  tsort  (  w  ,  M  ,  result  ,  visited  )  ; 
} 
result  .  push  (  v  )  ; 
} 
} 
