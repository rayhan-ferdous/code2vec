...
public   static   final   LispPackage   PACKAGE_CL  =  Packages  .  createPackage  (  "COMMON-LISP"  ,  1024  )  ; 

public   static   final   LispPackage   PACKAGE_CL_USER  =  Packages  .  createPackage  (  "COMMON-LISP-USER"  ,  1024  )  ; 

public   static   final   LispPackage   PACKAGE_KEYWORD  =  Packages  .  createPackage  (  "KEYWORD"  ,  1024  )  ; 

public   static   final   LispPackage   PACKAGE_SYS  =  Packages  .  createPackage  (  "SYSTEM"  )  ; 

public   static   final   LispPackage   PACKAGE_MOP  =  Packages  .  createPackage  (  "MOP"  )  ; 

public   static   final   LispPackage   PACKAGE_TPL  =  Packages  .  createPackage  (  "TOP-LEVEL"  )  ; 

public   static   final   LispPackage   PACKAGE_EXT  =  Packages  .  createPackage  (  "EXTENSIONS"  )  ; 

public   static   final   LispPackage   PACKAGE_JVM  =  Packages  .  createPackage  (  "JVM"  )  ; 

public   static   final   LispPackage   PACKAGE_LOOP  =  Packages  .  createPackage  (  "LOOP"  )  ; 

public   static   final   LispPackage   PACKAGE_PROF  =  Packages  .  createPackage  (  "PROFILER"  )  ; 

public   static   final   LispPackage   PACKAGE_JAVA  =  Packages  .  createPackage  (  "JAVA"  )  ; 

public   static   final   LispPackage   PACKAGE_LISP  =  Packages  .  createPackage  (  "LISP"  )  ; 

public   static   final   LispPackage   PACKAGE_THREADS  =  Packages  .  createPackage  (  "THREADS"  )  ; 
...
public   static   final   LispObject   macroexpand  (  LispObject   form  ,  final   Environment   env  ,  final   LispThread   thread  )  throws   ConditionThrowable  { 
...
public   static   final   LispObject   macroexpand_1  (  final   LispObject   form  ,  final   Environment   env  ,  final   LispThread   thread  )  throws   ConditionThrowable  { 
...
if  (  profiling  )  if  (  !  sampling  )  expander  .  incrementCallCount  (  )  ; 
LispObject   hook  =  coerceToFunction  (  SymbolConstants  .  MACROEXPAND_HOOK  .  symbolValue  (  thread  )  )  ; 
...
LispObject   obj  =  null  ; 
if  (  symbol  .  isSpecialVariable  (  )  )  obj  =  thread  .  lookupSpecial  (  symbol  )  ;  else   obj  =  env  .  lookup  (  symbol  )  ; 
if  (  obj  ==  null  )  obj  =  symbol  .  getSymbolValue  (  )  ; 
if  (  obj   instanceof   SymbolMacro  )  return   thread  .  setValues  (  (  (  SymbolMacro  )  obj  )  .  getExpansion  (  )  ,  T  )  ; 
} 
return   thread  .  setValues  (  form  ,  NIL  )  ; 
} 

private   static   final   Primitive   INTERACTIVE_EVAL  =  new   Primitive  (  "interactive-eval"  ,  PACKAGE_SYS  ,  true  )  { 
...
if  (  frames  [  i  ]  .  getClassName  (  )  .  startsWith  (  "org.armedbear.lisp.Primitive"  )  )  last  =  i  ; 
} 
while  (  last  >  2  )  { 
...
public   static   final   synchronized   void   setInterrupted  (  boolean   b  )  { 
interrupted  =  b  ; 
} 
...
final   LispThread   thread  =  LispThread  .  currentThread  (  )  ; 
if  (  SymbolConstants  .  LOAD_TRUENAME  .  symbolValue  (  thread  )  !=  NIL  )  return   eval  (  obj  ,  new   Environment  (  )  ,  thread  )  ;  else   return   NIL  ; 
} 
...
public   static   final   LispObject   eval  (  final   LispObject   obj  ,  final   Environment   env  ,  final   LispThread   thread  )  throws   ConditionThrowable  { 
thread  .  _values  =  null  ; 
if  (  interrupted  )  handleInterrupt  (  )  ; 
if  (  thread  .  isDestroyed  (  )  )  throw   new   ThreadDestroyed  (  )  ; 
if  (  obj   instanceof   Symbol  )  { 
LispObject   result  ; 
if  (  obj  .  isSpecialVariable  (  )  )  { 
if  (  obj  .  constantp  (  )  )  return   obj  .  getSymbolValue  (  )  ;  else   result  =  thread  .  lookupSpecial  (  obj  )  ; 
}  else   if  (  env  .  isDeclaredSpecial  (  obj  )  )  result  =  thread  .  lookupSpecial  (  obj  )  ;  else   result  =  env  .  lookup  (  obj  )  ; 
if  (  result  ==  null  )  { 
result  =  obj  .  getSymbolValue  (  )  ; 
if  (  result  ==  null  )  return   error  (  new   UnboundVariable  (  obj  )  )  ; 
} 
if  (  result   instanceof   SymbolMacro  )  return   eval  (  (  (  SymbolMacro  )  result  )  .  getExpansion  (  )  ,  env  ,  thread  )  ; 
return   result  ; 
...
if  (  fun   instanceof   MacroObject  )  return   eval  (  macroexpand  (  obj  ,  env  ,  thread  )  ,  env  ,  thread  )  ; 
if  (  fun   instanceof   Autoload  )  { 
Autoload   autoload  =  (  Autoload  )  fun  ; 
autoload  .  load  (  )  ; 
return   eval  (  obj  ,  env  ,  thread  )  ; 
} 
return   evalCall  (  fun  !=  null  ?  fun  :  first  ,  (  (  Cons  )  obj  )  .  CDR  (  )  ,  env  ,  thread  )  ; 
}  else  { 
if  (  first  .  CAR  (  )  ==  SymbolConstants  .  LAMBDA  )  { 
Closure   closure  =  new   Closure  (  first  ,  env  )  ; 
return   evalCall  (  closure  ,  (  (  Cons  )  obj  )  .  CDR  (  )  ,  env  ,  thread  )  ; 
}  else   return   error  (  new   ProgramError  (  "Illegal function object: "  +  first  .  writeToString  (  )  )  )  ; 
} 
}  else   return   obj  ; 
} 
...
if  (  args  ==  NIL  )  return   thread  .  execute  (  function  )  ; 
...
public   static   final   LispObject   parseBody  (  LispObject   body  ,  boolean   documentationAllowed  )  throws   ConditionThrowable  { 
...
}  else   if  (  form   instanceof   Cons  &&  form  .  CAR  (  )  ==  SymbolConstants  .  DECLARE  )  decls  =  makeCons  (  form  ,  decls  )  ;  else   break  ; 
body  =  body  .  CDR  (  )  ; 
} 
return   list  (  body  ,  decls  .  nreverse  (  )  ,  doc  )  ; 
} 

public   static   final   LispObject   parseSpecials  (  LispObject   forms  )  throws   ConditionThrowable  { 
...
public   static   final   LispObject   preprocessTagBody  (  LispObject   body  ,  Environment   env  )  throws   ConditionThrowable  { 
...
public   static   final   LispObject   processTagBody  (  LispObject   body  ,  LispObject   localTags  ,  Environment   env  )  throws   ConditionThrowable  { 
...
if  (  binding  ==  null  )  return   error  (  new   ControlError  (  "No tag named "  +  tag  .  writeToString  (  )  +  " is currently visible."  )  )  ;  else   if  (  memql  (  tag  ,  localTags  )  )  { 
...
private   static   final   boolean   isSpecial  (  Symbol   sym  ,  LispObject   ownSpecials  ,  Environment   env  )  throws   ConditionThrowable  { 
if  (  ownSpecials  !=  null  )  { 
if  (  sym  .  isSpecialVariable  (  )  )  return   true  ; 
for  (  ;  ownSpecials  !=  NIL  ;  ownSpecials  =  ownSpecials  .  CDR  (  )  )  { 
if  (  sym  ==  ownSpecials  .  CAR  (  )  )  return   true  ; 
} 
} 
return   false  ; 
} 

protected   static   final   void   bindArg  (  LispObject   ownSpecials  ,  Symbol   sym  ,  LispObject   value  ,  Environment   env  ,  LispThread   thread  )  throws   ConditionThrowable  { 
if  (  isSpecial  (  sym  ,  ownSpecials  ,  env  )  )  { 
env  .  declareSpecial  (  sym  )  ; 
thread  .  bindSpecial  (  sym  ,  value  )  ; 
}  else   env  .  bindLispSymbol  (  sym  ,  value  )  ; 
} 
...
for  (  int   i  =  remaining  .  length  -  2  ;  i  >=  0  ;  i  --  )  theList  =  makeCons  (  remaining  [  i  ]  ,  theList  )  ; 
} 
...
return   makeCons  (  obj1  ,  makeCons  (  obj2  ,  makeCons  (  obj3  ,  makeCons  (  obj4  ,  makeCons  (  obj5  ,  makeCons  (  obj6  ,  makeCons  (  obj7  ,  makeCons  (  obj8  )  )  )  )  )  )  )  )  ; 
} 
...
return   makeCons  (  obj1  ,  makeCons  (  obj2  ,  makeCons  (  obj3  ,  makeCons  (  obj4  ,  makeCons  (  obj5  ,  makeCons  (  obj6  ,  makeCons  (  obj7  ,  makeCons  (  obj8  ,  makeCons  (  obj9  )  )  )  )  )  )  )  )  )  ; 
} 

public   static   final   LispObject   multipleValueList  (  LispObject   result  )  throws   ConditionThrowable  { 
LispThread   thread  =  LispThread  .  currentThread  (  )  ; 
LispObject  [  ]  values  =  thread  .  _values  ; 
if  (  values  ==  null  )  return   makeCons  (  result  )  ; 
thread  .  _values  =  null  ; 
LispObject   list  =  NIL  ; 
for  (  int   i  =  values  .  length  ;  i  --  >  0  ;  )  list  =  makeCons  (  values  [  i  ]  ,  list  )  ; 
return   list  ; 
} 
...
LispObject  [  ]  values  =  thread  .  _values  ; 
thread  .  _values  =  null  ; 
if  (  values  ==  null  )  return   thread  .  execute  (  coerceToFunction  (  function  )  ,  result  )  ;  else   return   funcall  (  coerceToFunction  (  function  )  ,  values  ,  thread  )  ; 
} 
...
if  (  obj   instanceof   Symbol  )  return  (  Symbol  )  obj  ; 
return  (  Symbol  )  type_error  (  obj  ,  SymbolConstants  .  SYMBOL  )  ; 
} 

public   static   final   LispInteger   checkInt  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   LispInteger  )  return  (  LispInteger  )  obj  ; 
return  (  LispInteger  )  type_error  (  obj  ,  SymbolConstants  .  INTEGER  )  ; 
} 

public   static   final   Fixnum   checkFixnum  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   LispInteger  )  return  (  Fixnum  )  obj  ; 
...
public   static   final   LispArray   checkArray  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   LispArray  )  return  (  LispArray  )  obj  ; 
return  (  LispArray  )  type_error  (  obj  ,  SymbolConstants  .  ARRAY  )  ; 
} 

public   static   final   LispVector   checkVector  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   LispVector  )  return  (  LispVector  )  obj  ; 
return  (  LispVector  )  type_error  (  obj  ,  SymbolConstants  .  VECTOR  )  ; 
} 

public   static   final   DoubleFloat   checkDoubleFloat  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   DoubleFloat  )  return  (  DoubleFloat  )  obj  ; 
return  (  DoubleFloat  )  type_error  (  obj  ,  SymbolConstants  .  DOUBLE_FLOAT  )  ; 
} 

public   static   final   SingleFloat   checkSingleFloat  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   SingleFloat  )  return  (  SingleFloat  )  obj  ; 
return  (  SingleFloat  )  type_error  (  obj  ,  SymbolConstants  .  SINGLE_FLOAT  )  ; 
} 

public   static   final   StackFrame   checkStackFrame  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   StackFrame  )  return  (  StackFrame  )  obj  ; 
return  (  StackFrame  )  type_error  (  obj  ,  SymbolConstants  .  STACK_FRAME  )  ; 
} 
...
public   static   final   Symbol   gensym  (  String   prefix  ,  LispThread   thread  )  throws   ConditionThrowable  { 
...
if  (  oldValue   instanceof   Fixnum  ||  oldValue   instanceof   Bignum  )  binding  .  value  =  oldValue  .  incr  (  )  ;  else  { 
SymbolConstants  .  GENSYM_COUNTER  .  setSymbolValue  (  Fixnum  .  ZERO  )  ; 
error  (  new   TypeError  (  "The value of *GENSYM-COUNTER* was not a nonnegative integer. Old value: "  +  oldValue  .  writeToString  (  )  +  " New value: 0"  )  )  ; 
} 
}  else  { 
synchronized  (  SymbolConstants  .  GENSYM_COUNTER  )  { 
oldValue  =  SymbolConstants  .  GENSYM_COUNTER  .  getSymbolValue  (  )  ; 
if  (  oldValue   instanceof   Fixnum  ||  oldValue   instanceof   Bignum  )  SymbolConstants  .  GENSYM_COUNTER  .  setSymbolValue  (  oldValue  .  incr  (  )  )  ;  else  { 
SymbolConstants  .  GENSYM_COUNTER  .  setSymbolValue  (  Fixnum  .  ZERO  )  ; 
error  (  new   TypeError  (  "The value of *GENSYM-COUNTER* was not a nonnegative integer. Old value: "  +  oldValue  .  writeToString  (  )  +  " New value: 0"  )  )  ; 
} 
} 
} 
if  (  oldValue   instanceof   Fixnum  )  sb  .  append  (  oldValue  .  intValue  (  )  )  ;  else   if  (  oldValue   instanceof   Bignum  )  sb  .  append  (  oldValue  .  bigIntegerValue  (  )  .  toString  (  )  )  ; 
...
if  (  arg   instanceof   AbstractString  )  return   arg  .  getStringValue  (  )  ; 
if  (  arg   instanceof   Symbol  )  return  (  (  Symbol  )  arg  )  .  getName  (  )  ; 
if  (  arg   instanceof   LispCharacter  )  return   String  .  valueOf  (  new   char  [  ]  {  (  (  LispCharacter  )  arg  )  .  value  }  )  ; 
type_error  (  arg  ,  list  (  SymbolConstants  .  OR  ,  SymbolConstants  .  STRING  ,  SymbolConstants  .  SYMBOL  ,  SymbolConstants  .  CHARACTER  )  )  ; 
return   null  ; 
} 
...
in  .  close  (  )  ; 
if  (  bytesRemaining  >  0  )  Debug  .  trace  (  "bytesRemaining = "  +  bytesRemaining  )  ; 
...
public   static   final   LispObject   makeCompiledClosure  (  LispObject   template  ,  ClosureBinding  [  ]  context  )  throws   ConditionThrowable  { 
...
public   static   final   LispObject   FUNCTION_NAME  =  list  (  SymbolConstants  .  OR  ,  SymbolConstants  .  SYMBOL  ,  list  (  SymbolConstants  .  CONS  ,  list  (  SymbolConstants  .  EQL  ,  SymbolConstants  .  SETF  )  ,  list  (  SymbolConstants  .  CONS  ,  SymbolConstants  .  SYMBOL  ,  SymbolConstants  .  NULL  )  )  )  ; 

public   static   final   LispObject   UNSIGNED_BYTE_8  =  list  (  SymbolConstants  .  UNSIGNED_BYTE  ,  Fixnum  .  constants  [  8  ]  )  ; 

public   static   final   LispObject   UNSIGNED_BYTE_16  =  list  (  SymbolConstants  .  UNSIGNED_BYTE  ,  Fixnum  .  constants  [  16  ]  )  ; 

public   static   final   LispObject   UNSIGNED_BYTE_32  =  list  (  SymbolConstants  .  UNSIGNED_BYTE  ,  Fixnum  .  constants  [  32  ]  )  ; 

public   static   final   LispObject   UNSIGNED_BYTE_32_MAX_VALUE  =  Bignum  .  getInteger  (  4294967296L  )  ; 

public   static   final   LispObject   getUpgradedArrayElementType  (  LispObject   type  )  throws   ConditionThrowable  { 
if  (  type   instanceof   Symbol  )  { 
if  (  type  ==  SymbolConstants  .  CHARACTER  ||  type  ==  SymbolConstants  .  BASE_CHAR  ||  type  ==  SymbolConstants  .  STANDARD_CHAR  )  return   SymbolConstants  .  CHARACTER  ; 
if  (  type  ==  SymbolConstants  .  BIT  )  return   SymbolConstants  .  BIT  ; 
if  (  type  ==  NIL  )  return   NIL  ; 
} 
if  (  type  ==  BuiltInClass  .  CHARACTER  )  return   SymbolConstants  .  CHARACTER  ; 
if  (  type   instanceof   Cons  )  { 
if  (  type  .  equal  (  UNSIGNED_BYTE_8  )  )  return   type  ; 
if  (  type  .  equal  (  UNSIGNED_BYTE_16  )  )  return   type  ; 
if  (  type  .  equal  (  UNSIGNED_BYTE_32  )  )  return   type  ; 
LispObject   car  =  type  .  CAR  (  )  ; 
if  (  car  ==  SymbolConstants  .  INTEGER  )  { 
LispObject   lower  =  type  .  CADR  (  )  ; 
LispObject   upper  =  type  .  CDR  (  )  .  CADR  (  )  ; 
if  (  lower   instanceof   Cons  )  lower  =  lower  .  CAR  (  )  .  incr  (  )  ; 
if  (  upper   instanceof   Cons  )  upper  =  upper  .  CAR  (  )  .  decr  (  )  ; 
...
if  (  u  <=  1  )  return   SymbolConstants  .  BIT  ; 
if  (  u  <=  255  )  return   UNSIGNED_BYTE_8  ; 
if  (  u  <=  65535  )  return   UNSIGNED_BYTE_16  ; 
return   UNSIGNED_BYTE_32  ; 
} 
} 
if  (  lower  .  isGreaterThanOrEqualTo  (  Fixnum  .  ZERO  )  )  { 
if  (  lower  .  isLessThan  (  UNSIGNED_BYTE_32_MAX_VALUE  )  )  { 
if  (  upper  .  isLessThan  (  UNSIGNED_BYTE_32_MAX_VALUE  )  )  return   UNSIGNED_BYTE_32  ; 
} 
} 
} 
...
if  (  val  >=  0  )  { 
if  (  val  <=  1  )  return   SymbolConstants  .  BIT  ; 
if  (  val  <=  255  )  return   UNSIGNED_BYTE_8  ; 
if  (  val  <=  65535  )  return   UNSIGNED_BYTE_16  ; 
return   UNSIGNED_BYTE_32  ; 
} 
}  else   if  (  obj   instanceof   Bignum  )  { 
if  (  obj  .  isGreaterThanOrEqualTo  (  Fixnum  .  ZERO  )  )  { 
if  (  obj  .  isLessThan  (  UNSIGNED_BYTE_32_MAX_VALUE  )  )  return   UNSIGNED_BYTE_32  ; 
} 
} 
...
if  (  obj   instanceof   LispCharacter  )  rest  =  rest  .  CDR  (  )  ;  else   return   T  ; 
} 
...
if  (  obj   instanceof   LispCharacter  )  return  (  LispCharacter  )  obj  ; 
return  (  LispCharacter  )  type_error  (  obj  ,  SymbolConstants  .  CHARACTER  )  ; 
} 

public   static   final   LispPackage   checkPackage  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   LispPackage  )  return  (  LispPackage  )  obj  ; 
return  (  LispPackage  )  type_error  (  obj  ,  SymbolConstants  .  PACKAGE  )  ; 
} 

public   static   final   Function   checkFunction  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   Function  )  return  (  Function  )  obj  ; 
return  (  Function  )  type_error  (  obj  ,  SymbolConstants  .  FUNCTION  )  ; 
} 

public   static   final   Stream   checkStream  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   Stream  )  return  (  Stream  )  obj  ; 
return  (  Stream  )  type_error  (  obj  ,  SymbolConstants  .  STREAM  )  ; 
} 
...
if  (  stream  .  isCharacterInputStream  (  )  )  return   stream  ; 
return  (  Stream  )  error  (  new   TypeError  (  "The value "  +  obj  .  writeToString  (  )  +  " is not a character input stream."  )  )  ; 
} 

public   static   final   Stream   checkCharacterOutputStream  (  LispObject   obj  )  throws   ConditionThrowable  { 
final   Stream   stream  =  checkStream  (  obj  )  ; 
if  (  stream  .  isCharacterOutputStream  (  )  )  return   stream  ; 
return  (  Stream  )  error  (  new   TypeError  (  "The value "  +  obj  .  writeToString  (  )  +  " is not a character output stream."  )  )  ; 
} 

public   static   final   Stream   checkBinaryInputStream  (  LispObject   obj  )  throws   ConditionThrowable  { 
final   Stream   stream  =  checkStream  (  obj  )  ; 
if  (  stream  .  isBinaryInputStream  (  )  )  return   stream  ; 
return  (  Stream  )  error  (  new   TypeError  (  "The value "  +  obj  .  writeToString  (  )  +  " is not a binary input stream."  )  )  ; 
} 

public   static   final   Stream   outSynonymOf  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   Stream  )  return  (  Stream  )  obj  ; 
if  (  obj  ==  T  )  return   checkCharacterOutputStream  (  SymbolConstants  .  TERMINAL_IO  .  symbolValue  (  )  )  ; 
if  (  obj  ==  NIL  )  return   checkCharacterOutputStream  (  SymbolConstants  .  STANDARD_OUTPUT  .  symbolValue  (  )  )  ; 
return  (  Stream  )  type_error  (  obj  ,  SymbolConstants  .  STREAM  )  ; 
} 

public   static   final   Stream   inSynonymOf  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   Stream  )  return  (  Stream  )  obj  ; 
if  (  obj  ==  T  )  return   checkCharacterInputStream  (  SymbolConstants  .  TERMINAL_IO  .  symbolValue  (  )  )  ; 
if  (  obj  ==  NIL  )  return   checkCharacterInputStream  (  SymbolConstants  .  STANDARD_INPUT  .  symbolValue  (  )  )  ; 
return  (  Stream  )  type_error  (  obj  ,  SymbolConstants  .  STREAM  )  ; 
} 

public   static   final   void   writeByte  (  int   n  ,  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  n  <  0  ||  n  >  255  )  type_error  (  Fixnum  .  makeFixnum  (  n  )  ,  UNSIGNED_BYTE_8  )  ; 
checkStream  (  obj  )  .  _writeByte  (  n  )  ; 
} 

public   static   final   Readtable   checkReadtable  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   Readtable  )  return  (  Readtable  )  obj  ; 
return  (  Readtable  )  type_error  (  obj  ,  SymbolConstants  .  READTABLE  )  ; 
} 

public   static   final   AbstractString   checkString  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   AbstractString  )  return  (  AbstractString  )  obj  ; 
return  (  AbstractString  )  type_error  (  obj  ,  SymbolConstants  .  STRING  )  ; 
} 

public   static   final   LispClass   checkClass  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   LispClass  )  return  (  LispClass  )  obj  ; 
return  (  LispClass  )  type_error  (  obj  ,  SymbolConstants  .  CLASS  )  ; 
} 

public   static   final   Layout   checkLayout  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   Layout  )  return  (  Layout  )  obj  ; 
return  (  Layout  )  type_error  (  obj  ,  SymbolConstants  .  LAYOUT  )  ; 
} 

public   static   final   StandardObject   checkStandardObject  (  LispObject   first  )  throws   ConditionThrowable  { 
...
if  (  obj  ==  NIL  )  obj  =  STANDARD_READTABLE  .  symbolValue  (  )  ; 
...
if  (  obj   instanceof   Environment  )  return  (  Environment  )  obj  ; 
return  (  Environment  )  type_error  (  obj  ,  SymbolConstants  .  ENVIRONMENT  )  ; 
} 
...
if  (  obj   instanceof   StandardGenericFunction  )  return   obj  ; 
if  (  obj   instanceof   Symbol  )  { 
LispObject   fun  =  obj  .  getSymbolFunction  (  )  ; 
if  (  fun   instanceof   Function  )  return  (  Function  )  fun  ; 
}  else   if  (  obj   instanceof   Cons  &&  obj  .  CAR  (  )  ==  SymbolConstants  .  LAMBDA  )  return   new   Closure  (  obj  ,  new   Environment  (  )  )  ; 
error  (  new   UndefinedFunction  (  obj  )  )  ; 
return   null  ; 
} 

public   static   final   LispPackage   coerceToPackage  (  LispObject   obj  )  throws   ConditionThrowable  { 
if  (  obj   instanceof   LispPackage  )  return  (  LispPackage  )  obj  ; 
...
if  (  arg   instanceof   Pathname  )  return  (  Pathname  )  arg  ; 
if  (  arg   instanceof   AbstractString  )  return   Pathname  .  parseNamestring  (  (  AbstractString  )  arg  )  ; 
if  (  arg   instanceof   FileStream  )  return  (  (  FileStream  )  arg  )  .  getPathname  (  )  ; 
type_error  (  arg  ,  list  (  SymbolConstants  .  OR  ,  SymbolConstants  .  PATHNAME  ,  SymbolConstants  .  STRING  ,  SymbolConstants  .  FILE_STREAM  )  )  ; 
return   null  ; 
} 

public   static   LispObject   assq  (  LispObject   item  ,  LispObject   alist  )  throws   ConditionThrowable  { 
while  (  alist   instanceof   Cons  )  { 
LispObject   entry  =  (  (  Cons  )  alist  )  .  CAR  (  )  ; 
if  (  entry   instanceof   Cons  )  { 
if  (  (  (  Cons  )  entry  )  .  CAR  (  )  ==  item  )  return   entry  ; 
}  else   if  (  entry  !=  NIL  )  return   type_error  (  entry  ,  SymbolConstants  .  LIST  )  ; 
alist  =  (  (  Cons  )  alist  )  .  CDR  (  )  ; 
} 
if  (  alist  !=  NIL  )  return   type_error  (  alist  ,  SymbolConstants  .  LIST  )  ; 
return   NIL  ; 
} 

public   static   final   boolean   memq  (  LispObject   item  ,  LispObject   list  )  throws   ConditionThrowable  { 
while  (  list   instanceof   Cons  )  { 
if  (  item  ==  (  (  Cons  )  list  )  .  CAR  (  )  )  return   true  ; 
list  =  (  (  Cons  )  list  )  .  CDR  (  )  ; 
} 
if  (  list  !=  NIL  )  type_error  (  list  ,  SymbolConstants  .  LIST  )  ; 
return   false  ; 
} 

public   static   final   boolean   memql  (  LispObject   item  ,  LispObject   list  )  throws   ConditionThrowable  { 
while  (  list   instanceof   Cons  )  { 
if  (  item  .  eql  (  (  (  Cons  )  list  )  .  CAR  (  )  )  )  return   true  ; 
list  =  (  (  Cons  )  list  )  .  CDR  (  )  ; 
} 
if  (  list  !=  NIL  )  type_error  (  list  ,  SymbolConstants  .  LIST  )  ; 
return   false  ; 
...
while  (  list  !=  NIL  )  { 
if  (  list  .  CAR  (  )  ==  indicator  )  return   list  .  CADR  (  )  ; 
if  (  list  .  CDR  (  )  instanceof   Cons  )  list  =  list  .  CDDR  (  )  ;  else   return   error  (  new   TypeError  (  "Malformed property list: "  +  plist  .  writeToString  (  )  )  )  ; 
} 
return   defaultValue  ; 
} 
...
while  (  list  !=  NIL  )  { 
if  (  !  (  list  .  CDR  (  )  instanceof   Cons  )  )  error  (  new   ProgramError  (  "The symbol "  +  symbol  .  writeToString  (  )  +  " has an odd number of items in its property list."  )  )  ; 
if  (  list  .  CAR  (  )  ==  indicator  )  { 
if  (  prev  !=  null  )  prev  .  setCdr  (  list  .  CDDR  (  )  )  ;  else   symbol  .  setPropertyList  (  list  .  CDDR  (  )  )  ; 
return   T  ; 
} 
prev  =  list  .  CDR  (  )  ; 
list  =  list  .  CDDR  (  )  ; 
...
public   static   final   String   format  (  LispObject   formatControl  ,  LispObject   formatArguments  )  throws   ConditionThrowable  { 
final   LispThread   thread  =  LispThread  .  currentThread  (  )  ; 
...
if  (  state  ==  NEUTRAL  )  { 
if  (  c  ==  '~'  )  state  =  TILDE  ;  else   sb  .  append  (  c  )  ; 
}  else   if  (  state  ==  TILDE  )  { 
if  (  c  ==  'A'  ||  c  ==  'a'  )  { 
if  (  j  <  args  .  length  )  { 
...
public   static   final   Symbol   internInPackage  (  String   name  ,  String   packageName  )  throws   ConditionThrowable  { 
LispPackage   pkg  =  Packages  .  findPackage  (  packageName  )  ; 
if  (  pkg  ==  null  )  pkg  =  (  LispPackage  )  error  (  new   LispError  (  packageName  +  " is not the name of a package."  )  )  ; 
return   pkg  .  intern  (  name  )  ; 
} 
...
static   final   Hashtable  <  String  ,  LispObject  >  objectTable  =  new   Hashtable  <  String  ,  LispObject  >  (  )  ; 
...
@  Override 
public   LispObject   execute  (  LispObject   key  ,  LispObject   value  )  throws   ConditionThrowable  { 
objectTable  .  put  (  key  .  getStringValue  (  )  ,  value  )  ; 
return   NIL  ; 
} 
}  ; 

public   static   final   Symbol   internSpecial  (  String   name  ,  LispPackage   pkg  ,  LispObject   value  )  { 
...
public   static   final   Symbol   internConstant  (  String   name  ,  LispPackage   pkg  ,  LispObject   value  )  { 
Symbol   symbol  =  pkg  .  intern  (  name  )  ; 
symbol  .  initializeConstant  (  value  )  ; 
return   symbol  ; 
} 

public   static   final   Symbol   exportSpecial  (  String   name  ,  LispPackage   pkg  ,  LispObject   value  )  { 
Symbol   symbol  =  pkg  .  intern  (  name  )  ; 
try  { 
pkg  .  export  (  symbol  )  ; 
}  catch  (  ConditionThrowable   t  )  { 
...
public   static   final   Symbol   exportConstant  (  String   name  ,  LispPackage   pkg  ,  LispObject   value  )  { 
Symbol   symbol  =  pkg  .  intern  (  name  )  ; 
try  { 
pkg  .  export  (  symbol  )  ; 
}  catch  (  ConditionThrowable   t  )  { 
...
if  (  userDir  .  charAt  (  userDir  .  length  (  )  -  1  )  !=  File  .  separatorChar  )  userDir  =  userDir  .  concat  (  File  .  separator  )  ; 
} 
...
resetIO  (  new   Stream  (  System  .  in  ,  SymbolConstants  .  CHARACTER  ,  true  )  ,  new   Stream  (  System  .  out  ,  SymbolConstants  .  CHARACTER  ,  true  )  )  ; 
} 
...
public   static   final   Symbol   STANDARD_READTABLE  =  internConstant  (  "+STANDARD-READTABLE+"  ,  PACKAGE_SYS  ,  new   Readtable  (  )  )  ; 
...
if  (  interpreter  !=  null  )  interpreter  .  kill  (  status  )  ; 
} 
...
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  UNIX  ,  Keyword  .  LINUX  ,  Keyword  .  CDR6  )  )  ; 
}  else   if  (  osName  .  startsWith  (  "SunOS"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  UNIX  ,  Keyword  .  SUNOS  ,  Keyword  .  CDR6  )  )  ; 
}  else   if  (  osName  .  startsWith  (  "Mac OS X"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  UNIX  ,  Keyword  .  DARWIN  ,  Keyword  .  CDR6  )  )  ; 
}  else   if  (  osName  .  startsWith  (  "FreeBSD"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  UNIX  ,  Keyword  .  FREEBSD  ,  Keyword  .  CDR6  )  )  ; 
}  else   if  (  osName  .  startsWith  (  "OpenBSD"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  UNIX  ,  Keyword  .  OPENBSD  ,  Keyword  .  CDR6  )  )  ; 
}  else   if  (  osName  .  startsWith  (  "NetBSD"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  UNIX  ,  Keyword  .  NETBSD  ,  Keyword  .  CDR6  )  )  ; 
}  else   if  (  osName  .  startsWith  (  "Windows"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  WINDOWS  ,  Keyword  .  CDR6  )  )  ; 
}  else  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  list  (  Keyword  .  ARMEDBEAR  ,  Keyword  .  ABCL  ,  Keyword  .  COMMON_LISP  ,  Keyword  .  ANSI_CL  ,  Keyword  .  CDR6  )  )  ; 
} 
} 
...
SymbolConstants  .  FEATURES  .  setSymbolValue  (  makeCons  (  Keyword  .  JAVA_1_5  ,  SymbolConstants  .  FEATURES  .  getSymbolValue  (  )  )  )  ; 
}  else   if  (  version  .  startsWith  (  "1.6"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  makeCons  (  Keyword  .  JAVA_1_6  ,  SymbolConstants  .  FEATURES  .  getSymbolValue  (  )  )  )  ; 
}  else   if  (  version  .  startsWith  (  "1.7"  )  )  { 
SymbolConstants  .  FEATURES  .  setSymbolValue  (  makeCons  (  Keyword  .  JAVA_1_7  ,  SymbolConstants  .  FEATURES  .  getSymbolValue  (  )  )  )  ; 
} 
} 
...
if  (  os_arch  !=  null  )  { 
if  (  os_arch  .  equals  (  "amd64"  )  )  SymbolConstants  .  FEATURES  .  setSymbolValue  (  makeCons  (  Keyword  .  X86_64  ,  SymbolConstants  .  FEATURES  .  getSymbolValue  (  )  )  )  ;  else   if  (  os_arch  .  equals  (  "x86"  )  )  SymbolConstants  .  FEATURES  .  setSymbolValue  (  makeCons  (  Keyword  .  X86  ,  SymbolConstants  .  FEATURES  .  getSymbolValue  (  )  )  )  ; 
} 
} 
...
public   static   final   Symbol   _LOAD_DEPTH_  =  internSpecial  (  "*LOAD-DEPTH*"  ,  PACKAGE_SYS  ,  Fixnum  .  ZERO  )  ; 

public   static   final   Symbol   _LOAD_STREAM_  =  internSpecial  (  "*LOAD-STREAM*"  ,  PACKAGE_SYS  ,  NIL  )  ; 

public   static   final   Symbol   _SOURCE_  =  exportSpecial  (  "*SOURCE*"  ,  PACKAGE_SYS  ,  NIL  )  ; 

public   static   final   Symbol   _SOURCE_POSITION_  =  exportSpecial  (  "*SOURCE-POSITION*"  ,  PACKAGE_SYS  ,  NIL  )  ; 

public   static   final   Symbol   _AUTOLOAD_VERBOSE_  =  exportSpecial  (  "*AUTOLOAD-VERBOSE*"  ,  PACKAGE_EXT  ,  NIL  )  ; 

public   static   final   String   COMPILE_FILE_TYPE  =  "abcl"  ; 

public   static   final   Symbol   _COMPILE_FILE_TYPE_  =  internConstant  (  "*COMPILE-FILE-TYPE*"  ,  PACKAGE_SYS  ,  new   SimpleString  (  COMPILE_FILE_TYPE  )  )  ; 

public   static   final   Symbol   _COMPILE_FILE_ZIP_  =  exportSpecial  (  "*COMPILE-FILE-ZIP*"  ,  PACKAGE_SYS  ,  T  )  ; 
...
public   static   final   Symbol   _PRINT_STRUCTURE_  =  exportSpecial  (  "*PRINT-STRUCTURE*"  ,  PACKAGE_EXT  ,  T  )  ; 

public   static   final   Symbol   _CURRENT_PRINT_LENGTH_  =  exportSpecial  (  "*CURRENT-PRINT-LENGTH*"  ,  PACKAGE_SYS  ,  Fixnum  .  ZERO  )  ; 

public   static   final   Symbol   _CURRENT_PRINT_LEVEL_  =  exportSpecial  (  "*CURRENT-PRINT-LEVEL*"  ,  PACKAGE_SYS  ,  Fixnum  .  ZERO  )  ; 

public   static   final   Symbol   _PRINT_FASL_  =  internSpecial  (  "*PRINT-FASL*"  ,  PACKAGE_SYS  ,  NIL  )  ; 
...
public   static   final   Symbol   CALL_REGISTERS_LIMIT  =  exportConstant  (  "CALL-REGISTERS-LIMIT"  ,  PACKAGE_SYS  ,  Fixnum  .  constants  [  CALL_REGISTERS_MAX  ]  )  ; 

public   static   final   Symbol   _WARN_ON_REDEFINITION_  =  exportSpecial  (  "*WARN-ON-REDEFINITION*"  ,  PACKAGE_EXT  ,  T  )  ; 

public   static   final   Symbol   _SAVED_BACKTRACE_  =  exportSpecial  (  "*SAVED-BACKTRACE*"  ,  PACKAGE_EXT  ,  NIL  )  ; 

public   static   final   Symbol   _BATCH_MODE_  =  exportSpecial  (  "*BATCH-MODE*"  ,  PACKAGE_EXT  ,  NIL  )  ; 

public   static   final   Symbol   _NOINFORM_  =  exportSpecial  (  "*NOINFORM*"  ,  PACKAGE_SYS  ,  NIL  )  ; 

public   static   final   Symbol   _DISASSEMBLER_  =  exportSpecial  (  "*DISASSEMBLER*"  ,  PACKAGE_EXT  ,  new   SimpleString  (  "jad -a -p"  )  )  ; 

public   static   final   Symbol   _SPEED_  =  exportSpecial  (  "*SPEED*"  ,  PACKAGE_SYS  ,  Fixnum  .  ONE  )  ; 

public   static   final   Symbol   _SPACE_  =  exportSpecial  (  "*SPACE*"  ,  PACKAGE_SYS  ,  Fixnum  .  ONE  )  ; 

public   static   final   Symbol   _SAFETY_  =  exportSpecial  (  "*SAFETY*"  ,  PACKAGE_SYS  ,  Fixnum  .  ONE  )  ; 

public   static   final   Symbol   _DEBUG_  =  exportSpecial  (  "*DEBUG*"  ,  PACKAGE_SYS  ,  Fixnum  .  ONE  )  ; 

public   static   final   Symbol   _EXPLAIN_  =  exportSpecial  (  "*EXPLAIN*"  ,  PACKAGE_SYS  ,  NIL  )  ; 

public   static   final   Symbol   _ENABLE_INLINE_EXPANSION_  =  exportSpecial  (  "*ENABLE-INLINE-EXPANSION*"  ,  PACKAGE_EXT  ,  T  )  ; 

public   static   final   Symbol   _REQUIRE_STACK_FRAME_  =  exportSpecial  (  "*REQUIRE-STACK-FRAME*"  ,  PACKAGE_EXT  ,  NIL  )  ; 

static  { 
SymbolConstants  .  SUPPRESS_COMPILER_WARNINGS  .  initializeSpecial  (  NIL  )  ; 
} 

public   static   final   Symbol   _COMPILE_FILE_ENVIRONMENT_  =  exportSpecial  (  "*COMPILE-FILE-ENVIRONMENT*"  ,  PACKAGE_SYS  ,  NIL  )  ; 
...
public   static   final   Symbol   _SLOT_UNBOUND_  =  exportConstant  (  "+SLOT-UNBOUND+"  ,  PACKAGE_SYS  ,  UNBOUND_VALUE  )  ; 

public   static   final   Symbol   _CL_PACKAGE_  =  exportConstant  (  "+CL-PACKAGE+"  ,  PACKAGE_SYS  ,  PACKAGE_CL  )  ; 

public   static   final   Symbol   _KEYWORD_PACKAGE_  =  exportConstant  (  "+KEYWORD-PACKAGE+"  ,  PACKAGE_SYS  ,  PACKAGE_KEYWORD  )  ; 

public   static   final   Symbol   _BACKQUOTE_COUNT_  =  internSpecial  (  "*BACKQUOTE-COUNT*"  ,  PACKAGE_SYS  ,  Fixnum  .  ZERO  )  ; 

public   static   final   Symbol   _BQ_VECTOR_FLAG_  =  internSpecial  (  "*BQ-VECTOR-FLAG*"  ,  PACKAGE_SYS  ,  list  (  makeSymbol  (  "bqv"  )  )  )  ; 
...
public   static   final   EqHashTable   documentationHashTable  =  new   EqHashTable  (  11  ,  NIL  ,  NIL  )  ; 
...
public   static   LispObject   findLispClass  (  LispObject   name  ,  boolean   errorp  )  throws   ConditionThrowable  { 
