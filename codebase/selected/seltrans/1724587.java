...
if  (  this  .  mDefaultExt  !=  null  &&  file_name  .  indexOf  (  '.'  )  <  0  )  full_name  =  full_name  +  '.'  +  this  .  mDefaultExt  ; 
if  (  this  .  mBaseDir  !=  null  )  full_name  =  this  .  mBaseDir  +  full_name  ; 
return   full_name  ; 
} 

public   File   getFile  (  String   file_name  )  { 
File   file  =  new   File  (  getFullPath  (  file_name  )  )  ; 
if  (  file  .  exists  (  )  )  return   file  ;  else  { 
if  (  this  .  mExtraPathList  ==  null  )  return   null  ;  else  { 
...
if  (  this  .  mExtraPathList  ==  null  )  throw   ex  ;  else  { 
Iterator   it  =  this  .  mExtraPathList  .  iterator  (  )  ; 
while  (  it  .  hasNext  (  )  )  { 
CompositeLoader   ld  =  (  CompositeLoader  )  it  .  next  (  )  ; 
try  { 
...
if  (  resource_name  .  indexOf  (  ':'  )  >  0  )  return   loadByURL  (  resource_name  )  ; 
...
if  (  file  ==  null  )  need_stream  =  true  ;  else  { 
File   f  =  new   File  (  file  )  ; 
if  (  !  f  .  exists  (  )  )  need_stream  =  true  ; 
} 
if  (  need_stream  )  { 
stream  =  mClassLoader  .  getResourceAsStream  (  path  )  ; 
if  (  stream  ==  null  )  throw   new   IOException  (  "Can't get resource from "  +  path  )  ; 
return   parse  (  stream  )  ; 
}  else  { 
...
if  (  base_dir  .  charAt  (  len  -  1  )  !=  '\\'  &&  base_dir  .  charAt  (  len  -  1  )  !=  '/'  )  this  .  mBaseDir  =  base_dir  +  File  .  separatorChar  ;  else   this  .  mBaseDir  =  base_dir  ; 
} 
...
mCache  =  cache  ; 
if  (  mSourceFileManager  ==  null  )  mSourceFileManager  =  SourceFileManager  .  getInstance  (  )  ; 
} 
