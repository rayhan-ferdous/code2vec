...
protected   static   final   Logger   logger  =  LogManager  .  getLogger  (  GenbankAdapter  .  class  )  ; 
...
if  (  op  .  equals  (  ApolloDataAdapterI  .  OP_WRITE_DATA  )  ||  op  .  equals  (  ApolloDataAdapterI  .  OP_READ_DATA  )  )  return   new   GenbankAdapterGUI  (  op  )  ;  else   return   null  ; 
} 
...
if  (  (  getInputType  (  )  ==  null  )  ||  (  getInputType  (  )  !=  null  &&  getInputType  (  )  .  equals  (  DataInputType  .  DIR  )  )  )  { 
...
public   SequenceI   getSequence  (  DbXref   dbxref  ,  int   start  ,  int   end  )  throws   apollo  .  dataadapter  .  ApolloAdapterException  { 
throw   new   NotImplementedException  (  )  ; 
} 
...
public   Vector   getSequences  (  DbXref  [  ]  dbxref  ,  int  [  ]  start  ,  int  [  ]  end  )  throws   apollo  .  dataadapter  .  ApolloAdapterException  { 
throw   new   NotImplementedException  (  )  ; 
} 
...
if  (  wantTabular  )  saveTabular  (  curation  ,  out  )  ;  else   GenbankReport  .  save  (  curation  ,  out  )  ; 
} 

private   void   saveTabular  (  CurationSet   curation  ,  File   dir  )  { 
boolean   okay_commit  =  (  dir  .  isDirectory  (  )  &&  dir  .  canWrite  (  )  )  ; 
if  (  !  okay_commit  )  { 
logger  .  warn  (  "GenbankAdapter.saveTabular: directory "  +  dir  +  " is not writeable--can't save."  )  ; 
return  ; 
} 
logger  .  info  (  "Saving GenBank tabular format to directory "  +  dir  )  ; 
String   report_file  =  (  commit_acc  ?  outputFileStem  (  curation  )  +  ".acc.rpt"  :  outputFileStem  (  curation  )  +  ".annot.rpt"  )  ; 
...
DataOutputStream   dos  =  openGenbankFile  (  dir  ,  outputFileStem  (  curation  )  +  ".fsa"  )  ; 
try  { 
...
DataOutputStream   dos  =  openGenbankFile  (  dir  ,  outputFileStem  (  curation  )  +  ".acc"  )  ; 
try  { 
...
try  { 
if  (  !  genbank_file  .  exists  (  )  )  genbank_file  .  createNewFile  (  )  ; 
...
if  (  index  >  0  )  arm  =  arm  .  substring  (  0  ,  index  )  ; 
chrom  =  "[chromosome="  +  arm  +  "] "  ; 
}  else  { 
chrom  =  ""  ; 
} 
String   org  =  (  organism  .  equals  (  ""  )  ?  ""  :  "[organism="  +  organism  +  "] "  )  ; 
String   geno  =  (  genotype  .  equals  (  ""  )  ?  ""  :  "[genotype=\""  +  genotype  +  "\"]"  )  ; 
String   techno  =  (  tech  .  equals  (  ""  )  ?  ""  :  "[tech="  +  tech  +  "] "  )  ; 
String   header  =  (  ">"  +  getGenomeId  (  curation  )  +  " "  +  org  +  chrom  +  techno  +  geno  +  "\n"  )  ; 
String   dna  =  curation  .  getResidues  (  )  ; 
if  (  dna  !=  null  &&  !  dna  .  equals  (  ""  )  )  buf  .  append  (  FastaFile  .  format  (  header  ,  dna  ,  50  )  )  ; 
return   buf  .  toString  (  )  ; 
} 

protected   static   String   getGenbankType  (  String   type  )  { 
String   gb_type  =  ""  ; 
if  (  type  .  equalsIgnoreCase  (  "gene"  )  ||  type  .  equalsIgnoreCase  (  "pseudogene"  )  )  { 
gb_type  =  "gene"  ; 
}  else   if  (  type  .  equals  (  "snRNA"  )  ||  type  .  equals  (  "snoRNA"  )  ||  type  .  equals  (  "tRNA"  )  ||  type  .  equals  (  "rRNA"  )  )  { 
gb_type  =  type  ; 
}  else   if  (  type  .  equalsIgnoreCase  (  "transposable_element"  )  )  { 
gb_type  =  "repeat_region"  ; 
}  else   if  (  type  .  equalsIgnoreCase  (  "misc. non-coding RNA"  )  )  { 
gb_type  =  "misc_RNA"  ; 
}  else   if  (  (  type  .  equalsIgnoreCase  (  "miscellaneous curator's observation"  )  )  ||  (  type  .  equalsIgnoreCase  (  "misc. curator's observation"  )  )  )  { 
...
return  (  "\t\t\ttranscript_id\t"  +  getSequenceId  (  gene  ,  transcript  .  get_cDNASequence  (  )  ,  transcript  )  +  "\n"  +  "\t\t\tprotein_id\t"  +  getProteinId  (  gene  ,  transcript  .  getPeptideSequence  (  )  ,  transcript  )  +  "\n"  )  ; 
} 
...
int   phase  =  0  ; 
if  (  (  (  FeatureSetI  )  gene  )  .  isMissing5prime  (  )  ||  (  (  FeatureSetI  )  transcript  )  .  isMissing5prime  (  )  )  { 
phase  =  transcript  .  getFeaturePosition  (  tss  )  -  1  ; 
} 
SeqFeatureI   start_span  =  transcript  .  getFeatureContaining  (  tss  )  ; 
int   start_index  =  (  start_span  !=  null  ?  transcript  .  getFeatureIndex  (  start_span  )  :  0  )  ; 
...
if  (  contains_tss  &&  phase  ==  0  )  buf  .  append  (  CDS_start  +  (  tss  -  offset  )  +  "\t"  )  ;  else   if  (  contains_tss  &&  phase  >  0  )  buf  .  append  (  CDS_start  +  (  exon  .  getStart  (  )  -  offset  )  +  "\t"  )  ;  else   buf  .  append  (  (  exon  .  getStart  (  )  -  offset  )  +  "\t"  )  ; 
if  (  na_except_pos  >  0  &&  exon  .  contains  (  na_except_pos  )  )  { 
buf  .  append  (  ""  +  (  na_except_pos  -  transcript  .  getStrand  (  )  )  )  ; 
if  (  contains_tss  )  buf  .  append  (  "\tCDS\n"  )  ;  else   buf  .  append  (  "\n"  )  ; 
buf  .  append  (  (  na_except_pos  +  transcript  .  getStrand  (  )  )  +  "\t"  )  ; 
contains_tss  =  false  ; 
except  =  validator  .  getException  (  transcript  )  ; 
} 
if  (  found_end  )  buf  .  append  (  CDS_stop  +  (  end_base  -  offset  )  )  ;  else   buf  .  append  (  exon  .  getEnd  (  )  -  offset  )  ; 
if  (  contains_tss  )  buf  .  append  (  "\tCDS\n"  )  ;  else   buf  .  append  (  "\n"  )  ; 
} 
buf  .  append  (  "\t\t\tproduct\t"  +  getSequenceName  (  gene  ,  pep  ,  transcript  )  +  "\n"  )  ; 
buf  .  append  (  getIds  (  gene  ,  transcript  )  )  ; 
buf  .  append  (  "\t\t\tprot_desc\t"  +  getProteinDesc  (  gene  ,  transcript  )  +  "\n"  )  ; 
if  (  phase  >  0  )  { 
buf  .  append  (  "\t\t\tcodon_start\t"  +  (  phase  +  1  )  +  "\n"  )  ; 
} 
if  (  !  except  .  equals  (  ""  )  )  buf  .  append  (  except  )  ; 
return   buf  .  toString  (  )  ; 
} 
...
return  (  gene_has_start  +  (  gene  .  getStart  (  )  -  offset  )  +  "\t"  +  gene_has_stop  +  (  gene  .  getEnd  (  )  -  offset  )  +  "\t"  +  gb_type  +  "\n"  )  ; 
} 
...
buf  .  append  (  getGeneInterval  (  gene  ,  gene_has_start  ,  gene_has_stop  ,  gb_type  )  )  ; 
buf  .  append  (  getLocus  (  gene  ,  "transposon"  )  )  ; 
}  else  { 
buf  .  append  (  getGeneInterval  (  gene  ,  gene_has_start  ,  gene_has_stop  ,  "gene"  )  )  ; 
buf  .  append  (  getLocus  (  gene  ,  "gene"  )  )  ; 
} 
if  (  gb_type  .  equals  (  "gene"  )  )  { 
if  (  gene  .  getFeatureType  (  )  .  equalsIgnoreCase  (  "pseudogene"  )  )  buf  .  append  (  "\t\t\tpseudo\n"  )  ; 
} 
...
if  (  !  aa  .  equals  (  ""  )  )  buf  .  append  (  "\t\t\tproduct\ttRNA-"  +  aa  +  "\n"  )  ; 
}  else  { 
...
if  (  date_note  !=  null  &&  !  date_note  .  equals  (  ""  )  )  buf  .  append  (  "\t\t\tnote\tlast curated on "  +  date_note  +  "\n"  )  ; 
} 
if  (  gb_type  .  equals  (  "gene"  )  )  { 
...
String   CDS_start  =  (  gene_has_start  .  equals  (  ""  )  ?  get5primeStart  (  transcript  )  :  gene_has_start  )  ; 
String   CDS_stop  =  (  gene_has_stop  .  equals  (  ""  )  ?  get3primeStop  (  transcript  )  :  gene_has_stop  )  ; 
Vector   exons  =  transcript  .  getFeatures  (  )  ; 
for  (  int   j  =  0  ;  j  <  exons  .  size  (  )  ;  j  ++  )  { 
Exon   exon  =  (  Exon  )  exons  .  elementAt  (  j  )  ; 
if  (  j  ==  0  )  buf  .  append  (  CDS_start  )  ; 
buf  .  append  (  (  exon  .  getStart  (  )  -  offset  )  +  "\t"  )  ; 
if  (  j  ==  exons  .  size  (  )  -  1  )  buf  .  append  (  CDS_stop  )  ; 
buf  .  append  (  exon  .  getEnd  (  )  -  offset  )  ; 
if  (  j  ==  0  )  buf  .  append  (  "\tmRNA\n"  )  ;  else   buf  .  append  (  "\n"  )  ; 
} 
buf  .  append  (  "\t\t\tproduct\t"  +  getSequenceName  (  gene  ,  transcript  .  get_cDNASequence  (  )  ,  transcript  )  +  "\n"  )  ; 
...
buf  .  append  (  getGeneProduct  (  gene  ,  transcript  ,  CDS_start  ,  CDS_stop  ,  except  ,  na_except_pos  )  )  ; 
}  else   if  (  gene  .  getFeatureType  (  )  .  equalsIgnoreCase  (  "pseudogene"  )  )  buf  .  append  (  "\t\t\tpseudo\n"  )  ;  else   buf  .  append  (  "\t\t\t"  +  gene  .  getFeatureType  (  )  +  "\n"  )  ; 
} 
} 
} 
return   buf  .  toString  (  )  ; 
...
if  (  rna  !=  null  )  { 
String   header  =  (  ">"  +  getSequenceId  (  gene  ,  rna  ,  transcript  )  +  " "  +  (  acc  !=  null  &&  !  acc  .  equals  (  ""  )  ?  "("  +  acc  +  ") "  :  ""  )  +  symbol  +  gene_id  +  "\n"  )  ; 
buf  .  append  (  FastaFile  .  format  (  header  ,  rna  .  getResidues  (  )  ,  50  )  )  ; 
}  else  { 
logger  .  error  (  "ERROR: "  +  transcript  .  getName  (  )  +  " IS NOT TRANSCRIBED??!!??"  +  " ("  +  transcript  .  getOwner  (  )  +  ")"  )  ; 
} 
} 
} 
} 
...
SequenceI   pep  =  transcript  .  getPeptideSequence  (  )  ; 
if  (  pep  !=  null  )  { 
String   header  =  (  ">"  +  getSequenceId  (  gene  ,  pep  ,  transcript  )  +  " "  +  (  acc  !=  null  &&  !  acc  .  equals  (  ""  )  ?  "("  +  acc  +  ") "  :  ""  )  +  symbol  +  gene_id  +  "[prot_desc="  +  getProteinDesc  (  gene  ,  transcript  )  +  "]\n"  )  ; 
if  (  validator  !=  null  )  { 
String   fasta  =  validator  .  patchPeptideCheck  (  gene  ,  transcript  ,  header  ,  report_os  )  ; 
if  (  fasta  !=  null  )  buf  .  append  (  fasta  )  ;  else   omit  .  addElement  (  transcript  )  ; 
}  else   buf  .  append  (  FastaFile  .  format  (  header  ,  pep  .  getResidues  (  )  ,  50  )  )  ; 
}  else  { 
logger  .  error  (  "ERROR: "  +  transcript  .  getName  (  )  +  " DOES NOT TRANSLATE??!!??"  +  " ("  +  transcript  .  getOwner  (  )  +  ")"  )  ; 
} 
} 
} 
return   buf  .  toString  (  )  ; 
...
if  (  transcript  .  isMissing5prime  (  )  )  missing_count  ++  ; 
} 
...
for  (  int   i  =  0  ;  i  <  trans_count  &&  i  ==  missing_count  ;  i  ++  )  { 
Transcript   transcript  =  (  Transcript  )  sf  .  getFeatureAt  (  i  )  ; 
if  (  transcript  .  isMissing3prime  (  )  )  missing_count  ++  ; 
} 
...
if  (  !  syn  .  equals  (  ""  )  &&  syn  .  indexOf  (  "temp"  )  <  0  &&  !  syn  .  equals  (  gene  .  getName  (  )  )  &&  !  syn  .  equals  (  gene  .  getId  (  )  )  )  if  (  gb_type  .  equals  (  "repeat_region"  )  )  { 
...
String   seq_id  =  (  getDbXref  (  curation  .  getRefSequence  (  )  )  .  equals  (  ""  )  ?  curation  .  getRefSequence  (  )  .  getName  (  )  :  getDbXref  (  curation  .  getRefSequence  (  )  )  )  ; 
String   region  =  curation  .  getName  (  )  ; 
int   index  =  region  .  indexOf  (  "."  )  ; 
if  (  index  >  0  )  region  =  region  .  substring  (  0  ,  index  )  ; 
return  (  "gnl|"  +  database  +  "|"  +  seq_id  +  "|gb|"  +  region  )  ; 
} 

public   static   String   getProteinDesc  (  AnnotatedFeatureI   gene  ,  Transcript   transcript  )  { 
if  (  gene  .  size  (  )  ==  1  )  return  (  gene  .  getName  (  )  +  " gene product"  )  ;  else   return  (  gene  .  getName  (  )  +  " gene product from transcript "  +  getSequenceName  (  gene  ,  transcript  .  get_cDNASequence  (  )  ,  transcript  )  )  ; 
} 
...
String   seq_id  =  name  ; 
if  (  !  name  .  equals  (  ""  )  &&  knownToGenbank  (  transcript  )  )  seq_id  =  (  "gnl|"  +  database  +  "|"  +  name  )  ; 
return   seq_id  ; 
} 
...
String   seq_id  =  ""  ; 
if  (  !  name  .  equals  (  ""  )  )  { 
if  (  knownToGenbank  (  transcript  )  )  seq_id  =  (  "gnl|"  +  database  +  "|"  +  name  +  "|gb|"  +  transcript  .  getProperty  (  "protein_id"  )  )  ;  else   seq_id  =  (  "lcl|"  +  name  )  ; 
} 
return   seq_id  ; 
} 
...
try  { 
fireProgressEvent  (  new   ProgressEvent  (  this  ,  new   Double  (  10.0  )  ,  "Finding data..."  )  )  ; 
...
fireProgressEvent  (  new   ProgressEvent  (  this  ,  new   Double  (  15.0  )  ,  "Reading "  +  getInput  (  )  +  "..."  )  )  ; 
GenbankRead   gbio  =  new   GenbankRead  (  )  ; 
logger  .  info  (  "Loading "  +  getInput  (  )  +  "..."  )  ; 
if  (  gbio  .  loadCurationSet  (  curation  ,  new   BufferedReader  (  reader  )  )  )  return   curation  ;  else   return   null  ; 
}  catch  (  Exception   ex2  )  { 
