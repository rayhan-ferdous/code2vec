...
str  =  str  +  "\n"  ; 
String   x  [  ]  =  str  .  split  (  " "  )  ; 
if  (  x  .  length  ==  0  )  fina  .  add  (  orig  )  ;  else  { 
...
public   static   String   lastToHtml  (  String   s  )  { 
s  =  s  .  trim  (  )  ; 
int   n  =  s  .  lastIndexOf  (  " "  )  ; 
if  (  n  <  0  )  return   s  ; 
...
if  (  highlighter  )  combo3  .  setSelectedIndex  (  3  )  ;  else   if  (  transparency  ==  100  )  combo3  .  setSelectedIndex  (  1  )  ;  else   if  (  transparency  ==  60  )  combo3  .  setSelectedIndex  (  2  )  ;  else   combo3  .  setSelectedIndex  (  0  )  ; 
...
cp  .  add  (  item  ,  c  )  ; 
setDialog  (  )  ; 
jw  .  setSize  (  new   Dimension  (  500  ,  320  )  )  ; 
...
if  (  flavor  .  equals  (  flavors  [  0  ]  )  )  return  (  Object  )  data_plain  ;  else   if  (  flavor  .  equals  (  flavors  [  1  ]  )  )  return  (  Object  )  data_html  ;  else   if  (  flavor  .  equals  (  flavors  [  2  ]  )  )  return  (  Object  )  data_jaj  ;  else   throw   new   UnsupportedFlavorException  (  flavor  )  ; 
} 
...
if  (  val  .  equals  (  "$$jarnal"  )  ||  val  .  equals  (  "$$snapshot"  )  ||  val  .  equals  (  "$$pdf"  )  ||  val  .  equals  (  "$$tiff"  )  )  writeFile  (  key  ,  fname  ,  val  )  ;  else  { 
