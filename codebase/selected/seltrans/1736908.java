...
transaction  =  tm  .  beginTransaction  (  )  ; 
if  (  doc  .  getResourceType  (  )  ==  DocumentImpl  .  BINARY_FILE  )  collection  .  removeBinaryResource  (  transaction  ,  broker  ,  doc  )  ;  else   collection  .  removeXMLResource  (  transaction  ,  broker  ,  uri  .  lastSegment  (  )  )  ; 
tm  .  commit  (  transaction  )  ; 
return   true  ; 
}  catch  (  Exception   e  )  { 
if  (  transaction  !=  null  )  tm  .  abort  (  transaction  )  ; 
...
try  { 
if  (  uri  .  endsWith  (  "/"  )  )  throw   new   IOException  (  "It collection, but should be resource: "  +  uri  )  ; 
}  catch  (  Exception   e  )  { 
throw   new   IOException  (  e  )  ; 
} 
XmldbURI   collectionURI  =  uri  .  removeLastSegment  (  )  ; 
collection  =  broker  .  getCollection  (  collectionURI  )  ; 
if  (  collection  ==  null  )  throw   new   IOException  (  "Collection not found: "  +  collectionURI  )  ; 
...
collection  .  addBinaryResource  (  transaction  ,  broker  ,  fileName  ,  is  ,  mimeType  .  getName  (  )  ,  0L  ,  new   Date  (  )  ,  new   Date  (  )  )  ; 
} 
tm  .  commit  (  transaction  )  ; 
}  catch  (  Exception   e  )  { 
tm  .  abort  (  transaction  )  ; 
...
if  (  collection  ==  null  )  throw   new   IOException  (  "Resource not found: "  +  uri  )  ; 
}  else  { 
resource  =  broker  .  getXMLResource  (  uri  ,  Lock  .  READ_LOCK  )  ; 
if  (  resource  ==  null  )  { 
collection  =  broker  .  getCollection  (  uri  )  ; 
...
if  (  append  )  System  .  err  .  println  (  "BUG: OutputStream in append mode!"  )  ; 
...
collection  =  broker  .  getCollection  (  uri  )  ; 
if  (  collection  ==  null  )  collection  =  broker  .  getCollection  (  uri  .  removeLastSegment  (  )  )  ; 
} 
if  (  collection  ==  null  )  throw   new   IOException  (  "Collection not found: "  +  uri  )  ; 
return   collection  ; 
}  catch  (  Exception   e  )  { 
throw   new   IOException  (  e  )  ; 
} 
...
if  (  resource  ==  null  )  return   collection  ;  else   return   resource  .  getCollection  (  )  ; 
} 
...
File  [  ]  children  =  new   File  [  collection  .  getChildCollectionCount  (  broker  )  +  collection  .  getDocumentCount  (  broker  )  ]  ; 
int   j  =  0  ; 
for  (  Iterator  <  XmldbURI  >  i  =  collection  .  collectionIterator  (  broker  )  ;  i  .  hasNext  (  )  ;  j  ++  )  children  [  j  ]  =  new   Resource  (  i  .  next  (  )  )  ; 
