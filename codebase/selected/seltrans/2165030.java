...
import   java  .  util  .  *  ; 
import   com  .  be  .  vo  .  LogVO  ; 
import   com  .  util  .  comparator  .  *  ; 
import   com  .  util  .  table  .  *  ; 

public   class   LogModel   implements   ITableModel  { 

protected   LogVO   fTotal  ; 

protected   LogVO  [  ]  fTableData  ; 
...
LogVO   vo  =  fTableData  [  fSortOrder  [  pRow  ]  ]  ; 
