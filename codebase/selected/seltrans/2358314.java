...
Map  <  Integer  ,  Table  .  Builder  <  ?  extends   Table  >  >  builderMap  =  new   HashMap  <  Integer  ,  Table  .  Builder  <  ?  extends   Table  >  >  (  )  ; 
...
Map  <  Header  ,  WritableFontData  >  tableData  =  new   HashMap  <  Header  ,  WritableFontData  >  (  headers  .  size  (  )  )  ; 
...
for  (  int   tableNumber  =  0  ;  tableNumber  <  this  .  numTables  ;  tableNumber  ++  ,  tableOffset  +=  Offset  .  tableRecordSize  .  offset  )  { 
