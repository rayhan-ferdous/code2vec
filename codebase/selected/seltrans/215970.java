...
public   String   getTypeValue  (  Type   t  ,  String   ref  ,  String   id  ,  String   value  )  throws   GeneratorException  { 
switch  (  t  )  { 
case   BOOL  : 
...
public   String   getTypeGetter  (  Type   t  ,  String   ref  ,  String   id  ,  String   name  )  throws   GeneratorException  { 
return  "public "  +  getTypeName  (  t  ,  ref  ,  id  )  +  " get"  +  CodeHelper  .  upperFirstChar  (  name  )  +  "(){return "  +  name  +  ";};"  ; 
} 

public   String   getTypeSetter  (  Type   t  ,  String   ref  ,  String   id  ,  String   name  )  throws   GeneratorException  { 
return  "public void set"  +  CodeHelper  .  upperFirstChar  (  name  )  +  "("  +  getTypeName  (  t  ,  ref  ,  id  )  +  " a_"  +  name  +  "){ "  +  name  +  "=a_"  +  name  +  ";};"  ; 
} 

public   String   getEqualsCode  (  Type   t  ,  String   ref  ,  String   id  ,  String   v1  ,  String   v2  )  { 
switch  (  t  )  { 
case   BOOL  : 
case   DOUBLE  : 
case   SINT_8  : 
...
public   String   getWriteCode  (  Type   t  ,  String   ref  ,  String   id  ,  String   name  ,  String   writer  )  { 
switch  (  t  )  { 
case   VARUINT  : 
case   BOOL  : 
case   DOUBLE  : 
...
case   BYTES  : 
case   STRING  : 
return   writer  +  ".write"  +  name2writeReadNameSuffix  (  t  )  +  "("  +  name  +  ");"  ; 
case   ENUM  : 
{ 
...
return   CodeHelper  .  upperFirstChar  (  t  .  toString  (  )  .  replace  (  "SINT_"  ,  "INT"  )  .  replace  (  "_"  ,  ""  )  .  toLowerCase  (  )  )  .  replace  (  "Sstring"  ,  "SString"  )  ; 
} 
...
public   static   String   getJavaPackageNameSuffixForGroup  (  PackageGroupTypeWrapper   pgtw  )  { 
return  (  (  pgtw  .  isMainGroup  (  )  )  ?  "packages"  :  "packages_"  +  pgtw  .  getGroupName  (  )  .  toLowerCase  (  )  )  ; 
} 
} 
