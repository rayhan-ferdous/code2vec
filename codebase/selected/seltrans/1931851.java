...
private   LinkedHashMap  <  Channel  ,  Channel  >  rb_setMap  ; 
...
if  (  myProbe   instanceof   EnvelopeProbe  )  myProbe  =  spe  .  getProbe  (  )  ;  else   if  (  myProbe   instanceof   TransferMapProbe  )  myProbe  =  spe  .  getProbe  (  )  ;  else   myProbe  =  spe  .  getProbe  (  )  ; 
model  .  setProbe  (  myProbe  )  ; 
} 
} 
}  ; 
...
Channel   setPV  =  rb_setMap  .  get  (  rbPV  )  ; 
try  { 
double   noise  =  (  ch_noiseMap  .  get  (  rbPV  )  )  .  doubleValue  (  )  ; 
double   offset  =  (  ch_offsetMap  .  get  (  rbPV  )  )  .  doubleValue  (  )  ; 
final   double   setPoint  =  setPV  .  getValDbl  (  )  ; 
final   double   readBack  =  NoiseGenerator  .  setValForPV  (  setPoint  ,  noise  ,  offset  )  ; 
System  .  out  .  println  (  "Ready to put "  +  readBack  +  " to "  +  rbPV  .  getId  (  )  )  ; 
rbPV  .  putValCallback  (  readBack  ,  this  )  ; 
}  catch  (  ConnectionException   e  )  { 
...
if  (  rfCavity   instanceof   gov  .  sns  .  xal  .  smf  .  impl  .  SCLCavity  )  ampSetCh  .  putVal  (  rfCavity  .  getDfltCavAmp  (  )  *  (  (  SCLCavity  )  rfCavity  )  .  getStructureTTF  (  )  )  ;  else   ampSetCh  .  putVal  (  rfCavity  .  getDfltCavAmp  (  )  )  ; 
...
TypeQualifier   typeQualifier  =  QualifierFactory  .  qualifierWithStatusAndTypes  (  true  ,  "QH"  ,  "QV"  ,  "QTH"  ,  "QTV"  ,  "DCH"  ,  "DCV"  ,  "DH"  ,  "PMQH"  ,  "PMQV"  )  ; 
mags  =  getSelectedSequence  (  )  .  getAllNodesWithQualifier  (  typeQualifier  )  ; 
typeQualifier  =  QualifierFactory  .  qualifierWithStatusAndTypes  (  true  ,  "Bnch"  ,  "DTLTank"  ,  "CCL"  ,  "SCLCavity"  )  ; 
