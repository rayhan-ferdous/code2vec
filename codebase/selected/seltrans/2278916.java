...
public   abstract   class   TypedProxyPushSupplierPOA   extends   org  .  omg  .  PortableServer  .  Servant   implements   org  .  omg  .  CORBA  .  portable  .  InvokeHandler  ,  TypedProxyPushSupplierOperations  { 

static   final   String  [  ]  _ob_ids_  =  {  "IDL:omg.org/CosTypedNotifyChannelAdmin/TypedProxyPushSupplier:1.0"  ,  "IDL:omg.org/CosNotifyChannelAdmin/ProxySupplier:1.0"  ,  "IDL:omg.org/CosNotification/QoSAdmin:1.0"  ,  "IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0"  ,  "IDL:omg.org/CosNotifyComm/PushSupplier:1.0"  ,  "IDL:omg.org/CosNotifyComm/NotifySubscribe:1.0"  ,  "IDL:omg.org/CosEventComm/PushSupplier:1.0"  }  ; 

public   TypedProxyPushSupplier   _this  (  )  { 
return   TypedProxyPushSupplierHelper  .  narrow  (  super  .  _this_object  (  )  )  ; 
} 

public   TypedProxyPushSupplier   _this  (  org  .  omg  .  CORBA  .  ORB   orb  )  { 
return   TypedProxyPushSupplierHelper  .  narrow  (  super  .  _this_object  (  orb  )  )  ; 
} 
...
org  .  omg  .  CosNotifyChannelAdmin  .  ProxyType   _ob_r  =  MyType  (  )  ; 
org  .  omg  .  CORBA  .  portable  .  OutputStream   out  =  handler  .  createReply  (  )  ; 
org  .  omg  .  CosNotifyChannelAdmin  .  ProxyTypeHelper  .  write  (  out  ,  _ob_r  )  ; 
return   out  ; 
} 
...
org  .  omg  .  CORBA  .  portable  .  OutputStream   out  =  null  ; 
org  .  omg  .  CosNotifyChannelAdmin  .  ObtainInfoMode   _ob_a0  =  org  .  omg  .  CosNotifyChannelAdmin  .  ObtainInfoModeHelper  .  read  (  in  )  ; 
