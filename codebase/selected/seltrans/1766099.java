...
@  Override 
public   void   reestablishSessionAsync  (  HashMap  <  String  ,  String  >  cookie  )  { 
...
if  (  error  ==  null  )  { 
error  =  new   ImErrorInfo  (  ImErrorInfo  .  UNKNOWN_LOGIN_ERROR  ,  e  .  getMessage  (  )  )  ; 
} 
...
long   keepAlive  =  ImpsUtils  .  parseLong  (  keepAliveTime  ,  mConfig  .  getDefaultKeepAliveInterval  (  )  )  ; 
keepAlive  -=  5  ; 
...
if  (  error  .  getCode  (  )  ==  ImpsConstants  .  STATUS_UNAUTHORIZED  &&  error  .  getPrimitive  (  )  !=  null  )  { 
if  (  mConfig  .  use4wayLogin  (  )  )  { 
...
if  (  mConfig  .  useSmsAuth  (  )  &&  mConfig  .  getDataChannelBinding  (  )  !=  TransportType  .  SMS  )  { 
try  { 
...
shutdownOnError  (  new   ImErrorInfo  (  ImErrorInfo  .  UNSUPPORTED_CIR_CHANNEL  ,  e  .  toString  (  )  )  )  ; 
return  ; 
} 
} 
...
AsyncTransaction   tx  =  new   SimpleAsyncTransaction  (  mTransactionManager  ,  completion  )  ; 
...
throw   new   ImException  (  ImErrorInfo  .  UNSUPPORTED_CIR_CHANNEL  ,  "Unsupported CIR channel binding"  )  ; 
} 
if  (  mCirChannel  !=  null  )  { 
mCirChannel  .  connect  (  )  ; 
} 
...
if  (  code  ==  ImpsErrorInfo  .  SESSION_EXPIRED  ||  code  ==  ImpsErrorInfo  .  FORCED_LOGOUT  ||  code  ==  ImpsErrorInfo  .  INVALID_SESSION  )  { 
shutdownOnError  (  error  )  ; 
return  ; 
} 
} 
...
ArrayList  <  PrimitiveElement  >  presenceSubList  =  ImpsPresenceUtils  .  buildUpdatePresenceElems  (  mUserPresence  ,  presence  ,  mConfig  .  getPresenceMapping  (  )  )  ; 
...
PrimitiveElement   presenceSubList  =  updatePresenceRequest  .  addElement  (  ImpsTags  .  PresenceSubList  )  ; 
...
login  .  addElement  (  ImpsTags  .  TimeToLive  ,  Integer  .  toString  (  mConfig  .  getDefaultKeepAliveInterval  (  )  +  5  )  )  ; 
