...
if  (  textColumnIndexs  ==  null  )  sliceWritePositionData  (  )  ;  else   sliceWritePositionTextData  (  )  ; 
}  else  { 
if  (  textColumnIndexs  ==  null  )  sliceWritePositionScoreData  (  )  ;  else   sliceWritePositionScoreTextData  (  )  ; 
} 
}  else  { 
if  (  scoreColumnIndex  ==  -  1  )  { 
if  (  textColumnIndexs  ==  null  )  sliceWriteRegionData  (  )  ;  else   sliceWriteRegionTextData  (  )  ; 
}  else  { 
if  (  textColumnIndexs  ==  null  )  sliceWriteRegionScoreData  (  )  ;  else   sliceWriteRegionScoreTextData  (  )  ; 
} 
} 
}  catch  (  Exception   e  )  { 
...
if  (  chromOut  .  containsKey  (  chromStrand  )  )  out  =  chromOut  .  get  (  chromStrand  )  ;  else  { 
