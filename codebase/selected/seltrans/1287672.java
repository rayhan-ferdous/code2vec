...
import   at  .  langegger  .  xlwrap  .  map  .  BNodeReplacer  ; 
import   at  .  langegger  .  xlwrap  .  map  .  XLExprDatatype  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  XLExpr  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  E_BlankNode  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  E_Boolean  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  E_Date  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  E_Double  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  E_Long  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  E_String  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  E_URI  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  XLExprNumber  ; 
import   at  .  langegger  .  xlwrap  .  map  .  expr  .  val  .  XLExprValue  ; 
import   at  .  langegger  .  xlwrap  .  map  .  range  .  AnyRange  ; 
import   at  .  langegger  .  xlwrap  .  map  .  range  .  BoxRange  ; 
import   at  .  langegger  .  xlwrap  .  map  .  range  .  CellRange  ; 
import   at  .  langegger  .  xlwrap  .  map  .  range  .  FullSheetRange  ; 
import   at  .  langegger  .  xlwrap  .  map  .  range  .  MultiRange  ; 
import   at  .  langegger  .  xlwrap  .  map  .  range  .  NullRange  ; 
import   at  .  langegger  .  xlwrap  .  map  .  range  .  Range  ; 
import   at  .  langegger  .  xlwrap  .  spreadsheet  .  Cell  ; 
import   at  .  langegger  .  xlwrap  .  spreadsheet  .  TypeAnnotation  ; 
...
if  (  dt  !=  null  &&  dt  .  equals  (  XLExprDatatype  .  instance  )  )  return  (  XLExpr  )  node  .  getLiteralValue  (  )  ;  else   if  (  dt  ==  null  ||  node  .  getLiteralDatatype  (  )  .  equals  (  XSDDatatype  .  XSDstring  )  )  return   new   E_String  (  node  .  getLiteral  (  )  .  toString  (  )  )  ; 
} 
return   null  ; 
} 
