...
private   static   final   SysexHandler   SYS_REQ  =  new   SysexHandler  (  "F0 41 10 16 11 04 *bankNum* *patchNum* 00 01 76 *checkSum* F7"  )  ; 

public   RolandMT32TimbreTempBankDriver  (  final   Device   device  )  { 
super  (  device  ,  "Timbre Temp Bank"  ,  "Fred Jan Kraan"  ,  NS  ,  4  )  ; 
sysexID  =  "F041**16"  ; 
deviceIDoffset  =  0  ; 
