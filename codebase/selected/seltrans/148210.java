...
public   class   FileEffectiveRightsItem   extends   ItemType  { 
...
public   FileEffectiveRightsItem  (  final   int   id  )  { 
this  (  id  ,  null  )  ; 
} 

public   FileEffectiveRightsItem  (  final   int   id  ,  final   StatusEnumeration   status  )  { 
super  (  id  ,  status  )  ; 
...
public   void   setFileReadData  (  final   EntityItemBoolType   file_read_data  )  { 
...
public   void   setFileWriteData  (  final   EntityItemBoolType   file_write_data  )  { 
...
public   void   setFileAppendData  (  final   EntityItemBoolType   file_append_data  )  { 
...
public   void   setFileReadEa  (  final   EntityItemBoolType   file_read_ea  )  { 
...
public   void   setFileWriteEa  (  final   EntityItemBoolType   file_write_ea  )  { 
...
public   void   setFileExecute  (  final   EntityItemBoolType   file_execute  )  { 
...
public   void   setFileDeleteChild  (  final   EntityItemBoolType   file_delete_child  )  { 
...
public   void   setFileReadAttributes  (  final   EntityItemBoolType   file_read_attributes  )  { 
...
public   void   setFileWriteAttributes  (  final   EntityItemBoolType   file_write_attributes  )  { 
