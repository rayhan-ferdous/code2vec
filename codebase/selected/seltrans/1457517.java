...
protected   WritableCacheBuffer  (  byte  [  ]  hash  ,  long   startPos  ,  int   length  ,  SparseDedupFile   df  )  throws   IOException  { 
super  (  hash  ,  startPos  ,  length  ,  true  )  ; 
this  .  df  =  df  ; 
buf  =  new   byte  [  Main  .  CHUNK_LENGTH  ]  ; 
if  (  safeSync  )  { 
blockFile  =  new   File  (  df  .  getDatabaseDirPath  (  )  +  File  .  separator  +  startPos  +  ".chk"  )  ; 
if  (  blockFile  .  exists  (  )  )  { 
...
protected   WritableCacheBuffer  (  DedupChunk   dk  ,  SparseDedupFile   df  )  throws   IOException  { 
super  (  dk  .  getHash  (  )  ,  dk  .  getFilePosition  (  )  ,  dk  .  getLength  (  )  ,  dk  .  isNewChunk  (  )  )  ; 
this  .  df  =  df  ; 
if  (  this  .  isNewChunk  (  )  )  buf  =  new   byte  [  Main  .  CHUNK_LENGTH  ]  ; 
if  (  safeSync  )  { 
blockFile  =  new   File  (  df  .  getDatabaseDirPath  (  )  +  File  .  separator  +  this  .  getFilePosition  (  )  +  ".chk"  )  ; 
if  (  blockFile  .  exists  (  )  )  { 
SDFSLogger  .  getLog  (  )  .  warn  (  "recovering from unexpected close at "  +  this  .  getFilePosition  (  )  )  ; 
buf  =  readBlockFile  (  )  ; 
} 
if  (  this  .  isNewChunk  (  )  )  rafInit  =  true  ; 
} 
...
SDFSLogger  .  getLog  (  )  .  info  (  "Alert ! returned chunk to large "  +  buf  .  length  +  " > "  +  Main  .  CHUNK_LENGTH  )  ; 
} 
}  catch  (  Exception   e  )  { 
buf  =  new   byte  [  Main  .  CHUNK_LENGTH  ]  ; 
SDFSLogger  .  getLog  (  )  .  fatal  (  "unable to get chunk bytes for "  +  this  .  getHash  (  )  +  " at position "  +  this  .  getFilePosition  (  )  ,  e  )  ; 
} 
} 
} 
...
this  .  lock  .  lock  (  )  ; 
if  (  this  .  closed  )  throw   new   BufferClosedException  (  "Buffer Closed"  )  ; 
...
public   void   write  (  byte  [  ]  b  ,  int   pos  )  throws   BufferClosedException  ,  IOException  { 
this  .  lock  .  lock  (  )  ; 
try  { 
...
this  .  lock  .  lock  (  )  ; 
if  (  this  .  flushing  )  { 
SDFSLogger  .  getLog  (  )  .  debug  (  "cannot flush buffer at pos "  +  this  .  getFilePosition  (  )  +  " already flushing"  )  ; 
...
try  { 
this  .  lock  .  lock  (  )  ; 
if  (  !  this  .  flushing  )  SDFSLogger  .  getLog  (  )  .  debug  (  "####"  +  this  .  getFilePosition  (  )  +  " not flushing"  )  ;  else   if  (  this  .  closed  )  { 
SDFSLogger  .  getLog  (  )  .  info  (  this  .  getFilePosition  (  )  +  " already closed"  )  ; 
}  else  { 
this  .  df  .  writeCache  (  this  )  ; 
WritableCacheBuffer   _wb  =  this  .  df  .  flushingBuffers  .  remove  (  this  .  getFilePosition  (  )  )  ; 
if  (  _wb  ==  null  )  { 
SDFSLogger  .  getLog  (  )  .  info  (  this  .  getFilePosition  (  )  +  " not found in flushing buffer"  )  ; 
} 
this  .  closed  =  true  ; 
this  .  flushing  =  false  ; 
} 
...
if  (  this  .  buf  ==  null  )  SDFSLogger  .  getLog  (  )  .  info  (  this  .  getFilePosition  (  )  +  " buffer is null"  )  ; 
return   this  .  buf  ; 
}  finally  { 
this  .  lock  .  unlock  (  )  ; 
} 
