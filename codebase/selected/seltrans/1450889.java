...
config  .  GUIMODE  =  true  ; 
CreateImages  (  )  ; 
if  (  config  .  npl_when_started  ==  1  )  initialNPL  (  config  .  TIVOS  )  ; 
} 
return   jFrame  ; 
} 
...
if  (  looksMap  .  size  (  )  ==  0  )  getAvailableLooks  (  )  ; 
if  (  name  .  equals  (  "default"  )  )  name  =  UIManager  .  getCrossPlatformLookAndFeelClassName  (  )  ;  else   name  =  looksMap  .  get  (  name  )  ; 
try  { 
JDialog   d  =  configMain  .  getDialog  (  )  ; 
...
if  (  jFrame  !=  null  )  if  (  !  jFrame  .  hasFocus  (  )  )  { 
jFrame  .  requestFocus  (  )  ; 
} 
} 
...
if  (  tivoName  .  equals  (  "Remote"  )  )  log  .  error  (  "START JOBS invalid with Remote tab selected."  )  ;  else   tivoTabs  .  get  (  tivoName  )  .  startCB  (  )  ; 
} 
}  )  ; 
...
splitBottom  =  new   JSplitPane  (  JSplitPane  .  VERTICAL_SPLIT  ,  jobPane  ,  messagePane  )  ; 
...
jContentPane  =  new   JSplitPane  (  JSplitPane  .  VERTICAL_SPLIT  ,  topPane  ,  bottomPane  )  ; 
...
if  (  config  .  OS  .  equals  (  "windows"  )  )  autoMenu  .  add  (  getServiceMenu  (  )  )  ;  else   autoMenu  .  add  (  getBackgroundJobMenu  (  )  )  ; 
...
public   void   actionPerformed  (  ActionEvent   e  )  { 
if  (  config_auto  ==  null  )  config_auto  =  new   configAuto  (  )  ; 
...
saveMessagesMenuItem  .  setAccelerator  (  KeyStroke  .  getKeyStroke  (  KeyEvent  .  VK_S  ,  Event  .  CTRL_MASK  ,  true  )  )  ; 
...
configureMenuItem  .  setAccelerator  (  KeyStroke  .  getKeyStroke  (  KeyEvent  .  VK_O  ,  Event  .  CTRL_MASK  ,  true  )  )  ; 
} 
...
refreshEncodingsMenuItem  .  setAccelerator  (  KeyStroke  .  getKeyStroke  (  KeyEvent  .  VK_E  ,  Event  .  CTRL_MASK  ,  true  )  )  ; 
} 
...
if  (  !  file  .  isFile  (  config  .  ffmpeg  )  &&  !  file  .  isFile  (  config  .  mencoder  )  &&  !  file  .  isFile  (  config  .  handbrake  )  )  { 
...
if  (  auto_running  )  { 
int   response  =  JOptionPane  .  showConfirmDialog  (  config  .  gui  .  getJFrame  (  )  ,  question  ,  "Confirm"  ,  JOptionPane  .  YES_NO_OPTION  ,  JOptionPane  .  QUESTION_MESSAGE  )  ; 
...
if  (  remote_gui  !=  null  )  remote_gui  .  setTivoNames  (  )  ; 
}  else  { 
...
if  (  current  !=  null  )  encoding  .  setSelectedItem  (  current  )  ; 
} 
} 
...
String  [  ]  names  =  {  "expires-soon-recording"  ,  "save-until-i-delete-recording"  ,  "in-progress-recording"  ,  "in-progress-transfer"  ,  "expired-recording"  ,  "suggestion-recording"  ,  "folder"  ,  "copy-protected"  ,  "running"  ,  "queued"  }  ; 
URL   url  ; 
...
if  (  line  .  matches  (  "1"  )  )  metadata  .  setSelected  (  true  )  ;  else   metadata  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "decrypt"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  decrypt  .  setSelected  (  true  )  ;  else   decrypt  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "qsfix"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  qsfix  .  setSelected  (  true  )  ;  else   qsfix  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "twpdelete"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  twpdelete  .  setSelected  (  true  )  ;  else   twpdelete  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "ipaddelete"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  ipaddelete  .  setSelected  (  true  )  ;  else   ipaddelete  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "comskip"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  comskip  .  setSelected  (  true  )  ;  else   comskip  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "comcut"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  comcut  .  setSelected  (  true  )  ;  else   comcut  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "captions"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  captions  .  setSelected  (  true  )  ;  else   captions  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "encode"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  encode  .  setSelected  (  true  )  ;  else   encode  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "push"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  push  .  setSelected  (  true  )  ;  else   push  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "custom"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  custom  .  setSelected  (  true  )  ;  else   custom  .  setSelected  (  false  )  ; 
} 
if  (  key  .  equals  (  "toolTips"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  config  .  toolTips  =  1  ;  else   config  .  toolTips  =  0  ; 
} 
if  (  key  .  equals  (  "jobMonitorFullPaths"  )  )  { 
if  (  line  .  matches  (  "1"  )  )  config  .  jobMonitorFullPaths  =  1  ;  else   config  .  jobMonitorFullPaths  =  0  ; 
} 
...
if  (  remote_gui  !=  null  )  remote_gui  .  getPanel  (  )  .  setSelectedIndex  (  value  )  ; 
} 
...
String  [  ]  l  =  line  .  split  (  "="  )  ; 
if  (  l  [  1  ]  .  equals  (  "1"  )  )  { 
if  (  tivoTabs  .  containsKey  (  l  [  0  ]  )  )  tivoTabs  .  get  (  l  [  0  ]  )  .  showFoldersSet  (  true  )  ; 
} 
} 
} 
ifp  .  close  (  )  ; 
...
if  (  centerDivider  !=  -  1  )  jContentPane  .  setDividerLocation  (  centerDivider  )  ; 
if  (  bottomDivider  !=  -  1  )  splitBottom  .  setDividerLocation  (  bottomDivider  )  ; 
}  catch  (  Exception   ex  )  { 
...
if  (  flag  ==  1  )  toolTips  .  setEnabled  (  true  )  ;  else   toolTips  .  setEnabled  (  false  )  ; 
} 
