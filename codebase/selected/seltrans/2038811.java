...
System  .  err  .  println  (  "Usage: java efx.util.Base64 -e|-d inputfile outputfile"  )  ; 
} 
...
System  .  err  .  println  (  "Bad efx.util.Base64 input character at "  +  i  +  ": "  +  source  [  i  ]  +  "(decimal)"  )  ; 
return   null  ; 
} 
} 
...
throw   new   java  .  io  .  IOException  (  "Improperly padded efx.util.Base64 input."  )  ; 
} 
} 
} 
if  (  position  >=  0  )  { 
...
throw   new   java  .  io  .  IOException  (  "Error in efx.util.Base64 code reading stream."  )  ; 
} 
} 
...
throw   new   java  .  io  .  IOException  (  "Invalid character in efx.util.Base64 data."  )  ; 
} 
} 
} 
...
throw   new   java  .  io  .  IOException  (  "efx.util.Base64 input not properly padded."  )  ; 
} 
} 
} 
