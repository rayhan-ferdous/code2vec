...
try  { 
if  (  deleteList  .  size  (  )  >  0  )  num  =  tagsTemplate  (  querySQL  ,  deleteList  )  ; 
}  catch  (  Exception   e  )  { 
e  .  printStackTrace  (  )  ; 
} 
return   num  ; 
...
try  { 
if  (  closedList  .  size  (  )  >  0  )  num  =  this  .  tagsTemplate  (  querySQL  ,  closedList  )  ; 
}  catch  (  Exception   e  )  { 
e  .  printStackTrace  (  )  ; 
} 
return   num  ; 
...
try  { 
if  (  openList  .  size  (  )  >  0  )  num  =  this  .  tagsTemplate  (  querySQL  ,  openList  )  ; 
}  catch  (  Exception   e  )  { 
e  .  printStackTrace  (  )  ; 
} 
return   num  ; 
