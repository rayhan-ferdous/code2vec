...
public   static   byte  [  ]  encodeAndReturnBytes  (  byte  [  ]  source  )  { 
return   encodeAndReturnBytes  (  source  ,  0  ,  source  .  length  ,  NO_OPTIONS  )  ; 
} 
...
public   static   byte  [  ]  encodeAndReturnBytes  (  byte  [  ]  source  ,  int   off  ,  int   len  ,  int   options  )  { 
int   dontBreakLines  =  (  options  &  DONT_BREAK_LINES  )  ; 
boolean   breakLines  =  dontBreakLines  ==  0  ; 
int   len43  =  len  *  4  /  3  ; 
byte  [  ]  outBuff  =  new   byte  [  (  len43  )  +  (  (  len  %  3  )  >  0  ?  4  :  0  )  +  (  breakLines  ?  (  len43  /  MAX_LINE_LENGTH  )  :  0  )  ]  ; 
