...
final   Option   b64  =  new   Option  (  "base64"  ,  false  ,  "Give this option if the stored request/reply should be "  +  "base64 encoded, default is not."  )  ; 
final   Option   verifyopt  =  new   Option  (  "verify"  ,  false  ,  "Give this option if verification of a stored reply should "  +  "be done, work together with inrep and cafile. If given, no "  +  "request to the TSA will happen."  )  ; 
final   Option   printopt  =  new   Option  (  "print"  ,  false  ,  "Prints content of a response"  )  ; 
...
OptionBuilder  .  hasArg  (  )  ; 
OptionBuilder  .  withArgName  (  "file"  )  ; 
OptionBuilder  .  withDescription  (  "Input file containing an earlier stored "  +  "request to use instead of creating a new. "  +  "You must specify the request flag also."  )  ; 
...
formatter  .  printHelp  (  "signclient timestamp <options> <url>"  ,  options  )  ; 
final   StringBuilder   footer  =  new   StringBuilder  (  )  ; 
footer  .  append  (  NL  )  .  append  (  "Sample usages:"  )  .  append  (  NL  )  .  append  (  "a) "  )  .  append  (  COMMAND  )  .  append  (  " -url http://localhost:8080/signserver/tsa?workerName=TimeStampSigner"  )  .  append  (  NL  )  ; 
...
private   List  <  X509Certificate  >  getCertsFromPEM  (  final   String   certFile  )  throws   IOException  ,  CertificateException  { 
...
private   List  <  X509Certificate  >  getCertsFromPEM  (  final   InputStream   certstream  )  throws   IOException  ,  CertificateException  { 
...
final   X509Certificate   x509cert  =  (  X509Certificate  )  cf  .  generateCertificate  (  new   ByteArrayInputStream  (  certbuf  )  )  ; 
ret  .  add  (  x509cert  )  ; 
} 
return   ret  ; 
} 
