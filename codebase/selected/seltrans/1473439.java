package   edu  .  cmu  .  sphinx  .  model  .  acoustic  .  plpsatpleinblF0F  ; 
...
protected   static   final   String   MAP_FILE_VERSION  =  "1.2"  ; 
...
if  (  !  fileNameClasseMllr  .  equals  (  ""  )  )  classeMllr  =  loadClasseMllr  (  fileNameClasseMllr  )  ; 
meanTransformationMatrixPool  =  createDummyMatrixPool  (  "meanTransformationMatrix"  ,  numClasses  )  ; 
meanTransformationVectorPool  =  createDummyVectorPool  (  "meanTransformationMatrix"  ,  numClasses  )  ; 
varianceTransformationMatrixPool  =  createDummyMatrixPool  (  "varianceTransformationMatrix"  ,  1  )  ; 
varianceTransformationVectorPool  =  createDummyVectorPool  (  "varianceTransformationMatrix"  ,  1  )  ; 
...
int  [  ]  res  ; 
Properties   props  =  new   Properties  (  )  ; 
DataInputStream   dis  =  readS3BinaryHeader  (  "letrucimpossibleetquinexistepas"  ,  path  ,  props  )  ; 
String   version  =  props  .  getProperty  (  "version"  )  ; 
if  (  version  ==  null  ||  !  version  .  equals  (  MAP_FILE_VERSION  )  )  throw   new   IOException  (  "Unsupported version in"  +  path  )  ; 
