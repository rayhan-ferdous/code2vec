...
Action   printAction  =  new   AbstractAction  (  "Print..."  ,  getIcon  (  "print.gif"  )  )  { 
...
ZoomAction   zoomOutAction  =  new   ZoomAction  (  "Zoom out"  ,  getIcon  (  "zoomout.gif"  )  ,  0.5  )  ; 

Action   zoomToolAction  =  new   AbstractAction  (  ""  ,  getIcon  (  "zoom.gif"  )  )  { 
...
Action   fitInWindowAction  =  new   AbstractAction  (  "Fit in window"  ,  getIcon  (  "fit.gif"  )  )  { 
...
Action   fullScreenAction  =  new   AbstractAction  (  "Full screen"  ,  getIcon  (  "fullscrn.gif"  )  )  { 
...
Action   nextAction  =  new   AbstractAction  (  "Next"  ,  getIcon  (  "next.gif"  )  )  { 
...
Action   firstAction  =  new   AbstractAction  (  "First"  ,  getIcon  (  "first.gif"  )  )  { 
...
Action   lastAction  =  new   AbstractAction  (  "Last"  ,  getIcon  (  "last.gif"  )  )  { 
...
Action   prevAction  =  new   AbstractAction  (  "Prev"  ,  getIcon  (  "prev.gif"  )  )  { 
...
doThumb  =  useThumbs  ; 
init  (  )  ; 
System  .  out  .  println  (  " print"  +  printAction  )  ; 
} 
...
public   PDFViewer  (  boolean   useThumbs  ,  CreatePdf   createPdf  )  { 
super  (  TITLE  )  ; 
