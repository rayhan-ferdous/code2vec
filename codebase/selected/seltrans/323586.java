...
if  (  getContentType  (  def  )  ==  ContentType  .  DIRECT_SINGLE_ELEMENT  )  (  (  ElementPattern  )  def  )  .  getNameClass  (  )  .  accept  (  nestedContentModelOutput  )  ;  else   visitPattern  (  p  )  ; 
return   VoidValue  .  VOID  ; 
} 
...
if  (  prefix  !=  null  )  buf  .  append  (  prefix  )  .  append  (  ':'  )  ; 
...
if  (  needSep  )  buf  .  append  (  '|'  )  ;  else   needSep  =  true  ; 
...
public   VoidValue   visitRef  (  RefPattern   p  )  { 
Pattern   def  =  getBody  (  p  .  getName  (  )  )  ; 
if  (  getContentType  (  def  )  ==  ContentType  .  DIRECT_SINGLE_ELEMENT  )  (  (  ElementPattern  )  def  )  .  getNameClass  (  )  .  accept  (  this  )  ;  else   paramEntityRef  (  p  )  ; 
return   VoidValue  .  VOID  ; 
} 
...
Pattern   member  =  list  .  get  (  i  )  ; 
ContentType   t  =  getContentType  (  member  )  ; 
if  (  !  t  .  isA  (  ContentType  .  EMPTY  )  )  member  .  accept  (  this  )  ; 
} 
} 
return   VoidValue  .  VOID  ; 
} 
...
if  (  t  .  isA  (  ContentType  .  MIXED_MODEL  )  )  super  .  visitRef  (  p  )  ;  else  { 
buf  .  append  (  '('  )  ; 
super  .  visitRef  (  p  )  ; 
buf  .  append  (  ')'  )  ; 
} 
...
public   VoidValue   visitMixed  (  MixedPattern   p  )  { 
buf  .  append  (  '('  )  ; 
if  (  getContentType  (  p  .  getChild  (  )  )  ==  ContentType  .  EMPTY  )  buf  .  append  (  "#PCDATA)"  )  ;  else  { 
buf  .  append  (  "#PCDATA|"  )  ; 
...
if  (  getAttributeType  (  p  )  !=  AttributeType  .  EMPTY  )  p  .  accept  (  this  )  ; 
} 
...
public   VoidValue   visitComposite  (  CompositePattern   p  )  { 
List  <  Pattern  >  list  =  p  .  getChildren  (  )  ; 
for  (  int   i  =  0  ,  len  =  list  .  size  (  )  ;  i  <  len  ;  i  ++  )  output  (  list  .  get  (  i  )  )  ; 
return   VoidValue  .  VOID  ; 
} 
...
public   VoidValue   visitZeroOrMore  (  ZeroOrMorePattern   p  )  { 
if  (  getAttributeType  (  p  )  !=  AttributeType  .  SINGLE  )  er  .  warning  (  "attribute_occur_approx"  ,  p  .  getSourceLocation  (  )  )  ; 
...
buf  .  append  (  ' '  )  ; 
if  (  ct  ==  ContentType  .  VALUE  )  p  .  getChild  (  )  .  accept  (  valueOutput  )  ;  else  { 
int   typeStart  =  buf  .  length  (  )  ; 
if  (  ct  .  isA  (  ContentType  .  SIMPLE_TYPE  )  ||  ct  ==  ContentType  .  TEXT  )  p  .  getChild  (  )  .  accept  (  topLevelSimpleTypeOutput  )  ;  else   if  (  ct  ==  ContentType  .  EMPTY  )  { 
er  .  warning  (  "empty_attribute_approx"  ,  p  .  getSourceLocation  (  )  )  ; 
buf  .  append  (  "CDATA"  )  ; 
} 
int   typeEnd  =  buf  .  length  (  )  ; 
if  (  isRequired  (  )  &&  len  ==  1  )  buf  .  append  (  " #REQUIRED"  )  ;  else  { 
String   dv  =  getDefaultValue  (  p  )  ; 
if  (  dv  ==  null  )  buf  .  append  (  " #IMPLIED"  )  ;  else  { 
buf  .  append  (  ' '  )  ; 
...
ModelBreaker   breaker  =  new   ModelBreaker  (  buf  .  substring  (  lineStart  ,  typeStart  )  ,  buf  .  substring  (  typeStart  ,  typeEnd  )  ,  buf  .  substring  (  typeEnd  )  ,  lineLength  )  ; 
buf  .  setLength  (  start  )  ; 
...
public   VoidValue   visitChoice  (  ChoicePattern   p  )  { 
if  (  getAttributeType  (  p  )  !=  AttributeType  .  EMPTY  )  er  .  warning  (  "attribute_occur_approx"  ,  p  .  getSourceLocation  (  )  )  ; 
...
if  (  warnDatatypes  )  { 
if  (  !  info  .  isExact  (  )  )  er  .  warning  (  "datatype_approx"  ,  p  .  getType  (  )  ,  info  .  closestType  (  )  ,  p  .  getSourceLocation  (  )  )  ;  else  { 
for  (  Param   param  :  p  .  getParams  (  )  )  er  .  warning  (  "ignore_param"  ,  param  .  getName  (  )  ,  p  .  getType  (  )  ,  p  .  getSourceLocation  (  )  )  ; 
if  (  p  .  getExcept  (  )  !=  null  )  er  .  warning  (  "ignore_except"  ,  p  .  getType  (  )  ,  p  .  getSourceLocation  (  )  )  ; 
} 
} 
...
if  (  warnDatatypes  )  er  .  warning  (  "list_approx"  ,  p  .  getSourceLocation  (  )  )  ; 
buf  .  append  (  "CDATA"  )  ; 
return   VoidValue  .  VOID  ; 
} 
...
if  (  warnDatatypes  )  er  .  warning  (  "value_approx"  ,  type  ,  p  .  getSourceLocation  (  )  )  ; 
buf  .  append  (  type  )  ; 
} 
} 
return   VoidValue  .  VOID  ; 
...
if  (  warnDatatypes  )  er  .  warning  (  "datatype_choice_approx"  ,  p  .  getSourceLocation  (  )  )  ; 
buf  .  append  (  "CDATA"  )  ; 
}  else   super  .  visitChoice  (  p  )  ; 
return   VoidValue  .  VOID  ; 
} 
...
super  .  visitRef  (  p  )  ; 
buf  .  append  (  ')'  )  ; 
}  else   if  (  t  ==  ContentType  .  TEXT  )  buf  .  append  (  "CDATA"  )  ;  else   super  .  visitRef  (  p  )  ; 
return   VoidValue  .  VOID  ; 
} 
} 
...
for  (  int   i  =  0  ,  len  =  list  .  size  (  )  ;  i  <  len  ;  i  ++  )  (  list  .  get  (  i  )  )  .  accept  (  this  )  ; 
} 
...
outputLeadingComments  (  c  )  ; 
outputFollowingComments  (  c  )  ; 
if  (  analysis  .  getPattern  (  )  ==  analysis  .  getGrammarPattern  (  )  )  c  .  getBody  (  )  .  accept  (  nestedContentModelOutput  )  ; 
}  else  { 
if  (  getContentType  (  c  .  getBody  (  )  )  ==  ContentType  .  DIRECT_SINGLE_ELEMENT  )  outputElement  (  (  ElementPattern  )  c  .  getBody  (  )  ,  c  )  ;  else   if  (  !  doneParamEntities  .  contains  (  c  .  getName  (  )  )  )  { 
...
for  (  int   i  =  0  ;  i  <  elementQueue  .  size  (  )  ;  i  ++  )  outputElement  (  elementQueue  .  get  (  i  )  ,  null  )  ; 
elementQueue  .  clear  (  )  ; 
} 
...
if  (  c  ==  null  )  externallyRequiredParamEntities  .  add  (  name  )  ;  else   if  (  c   instanceof   DefineComponent  )  { 
if  (  !  doneParamEntities  .  contains  (  name  )  )  { 
doneParamEntities  .  add  (  name  )  ; 
outputParamEntity  (  (  DefineComponent  )  c  )  ; 
} 
}  else   outputInclude  (  (  IncludeComponent  )  c  )  ; 
} 
...
if  (  doneIncludes  .  contains  (  href  )  )  return  ; 
...
if  (  slash  >=  0  )  uri  =  uri  .  substring  (  slash  +  1  )  ; 
int   dot  =  uri  .  lastIndexOf  (  '.'  )  ; 
if  (  dot  >  0  )  uri  =  uri  .  substring  (  0  ,  dot  )  ; 
if  (  Naming  .  isNcname  (  uri  )  )  entityName  =  uri  ; 
} 
if  (  entityName  ==  null  )  entityName  =  "ent"  ; 
...
if  (  reservedEntityNames  .  contains  (  name  )  )  return   false  ; 
...
buf  .  setLength  (  0  )  ; 
boolean   wrap  =  true  ; 
if  (  t  .  isA  (  ContentType  .  MODEL_GROUP  )  ||  t  .  isA  (  ContentType  .  NOT_ALLOWED  )  ||  t  .  isA  (  ContentType  .  MIXED_ELEMENT_CLASS  )  )  body  .  accept  (  nestedContentModelOutput  )  ;  else   if  (  t  .  isA  (  ContentType  .  MIXED_MODEL  )  )  body  .  accept  (  topLevelContentModelOutput  )  ;  else   if  (  t  .  isA  (  ContentType  .  EMPTY  )  )  { 
attributeOutput  .  output  (  body  )  ; 
wrap  =  false  ; 
}  else   if  (  t  .  isA  (  ContentType  .  ENUM  )  )  body  .  accept  (  nestedSimpleTypeOutput  )  ;  else   if  (  t  .  isA  (  ContentType  .  VALUE  )  )  { 
body  .  accept  (  valueOutput  )  ; 
wrap  =  false  ; 
}  else   if  (  t  .  isA  (  ContentType  .  SIMPLE_TYPE  )  )  body  .  accept  (  topLevelSimpleTypeOutput  )  ; 
...
write  (  suffix  )  ; 
outputNewline  (  )  ; 
}  else   outputModelBreak  (  prefix  ,  replacement  ,  suffix  )  ; 
} 
...
if  (  ct  ==  ContentType  .  EMPTY  )  ;  else   if  (  ct  ==  ContentType  .  MIXED_ELEMENT_CLASS  )  { 
...
if  (  warnDatatypes  )  er  .  warning  (  "data_content_approx"  ,  p  .  getSourceLocation  (  )  )  ; 
buf  .  append  (  "(#PCDATA)"  )  ; 
}  else   if  (  ct  ==  ContentType  .  NOT_ALLOWED  )  return  ;  else   content  .  accept  (  topLevelContentModelOutput  )  ; 
String   contentModel  =  buf  .  length  (  )  ==  0  ?  "EMPTY"  :  buf  .  toString  (  )  ; 
buf  .  setLength  (  0  )  ; 
attributeOutput  .  output  (  content  )  ; 
String   atts  =  buf  .  toString  (  )  ; 
outputRequiredComponents  (  )  ; 
if  (  def  !=  null  )  outputLeadingComments  (  def  )  ; 
outputLeadingComments  (  p  )  ; 
List  <  NameNameClass  >  names  =  NameClassSplitter  .  split  (  p  .  getNameClass  (  )  )  ; 
...
boolean   needXmlns  ; 
if  (  ns  ==  NameClass  .  INHERIT_NS  )  needXmlns  =  false  ;  else   if  (  prefix  ==  null  )  needXmlns  =  true  ;  else   needXmlns  =  !  analysis  .  getAttributeNamespaces  (  content  )  .  contains  (  ns  )  ; 
...
if  (  atts  .  length  (  )  !=  0  )  outputAttributeNamespaces  (  content  )  ; 
write  (  atts  )  ; 
write  (  '>'  )  ; 
outputNewline  (  )  ; 
} 
} 
if  (  def  !=  null  )  outputFollowingComments  (  def  )  ; 
} 
...
for  (  AnnotationChild   child  :  list  )  if  (  child   instanceof   Comment  )  outputComment  (  (  (  Comment  )  child  )  .  getValue  (  )  )  ; 
} 
...
if  (  att  .  getLocalName  (  )  .  equals  (  localName  )  &&  att  .  getNamespaceUri  (  )  .  equals  (  ns  )  )  return   att  .  getValue  (  )  ; 
} 
return   null  ; 
} 
} 
