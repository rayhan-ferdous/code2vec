...
newPostParameters  [  0  ]  =  new   PostParameter  (  "source"  ,  Weibo  .  CONSUMER_KEY  )  ; 
} 
return   httpRequest  (  url  ,  newPostParameters  ,  authenticated  ,  null  )  ; 
} 

protected   Response   httpRequest  (  String   url  ,  PostParameter  [  ]  postParams  ,  boolean   authenticated  ,  String   httpMethod  )  throws   WeiboException  { 
int   retriedCount  ; 
