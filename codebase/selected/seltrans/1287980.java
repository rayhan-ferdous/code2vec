...
import   java  .  util  .  *  ; 
import   com  .  debitors  .  vo  .  BillInpayVO  ; 
import   com  .  util  .  comparator  .  *  ; 
import   com  .  util  .  table  .  *  ; 

public   class   BillInpayModel   implements   ITableModel  { 

protected   BillInpayVO   fTotal  ; 

protected   BillInpayVO  [  ]  fTableData  ; 
...
public   BillInpayModel  (  )  { 
super  (  )  ; 
} 

public   void   setData  (  Object  [  ]  data  )  { 
fTableData  =  (  BillInpayVO  [  ]  )  data  ; 
...
if  (  "inpayID"  .  equals  (  pColumn  )  )  return   new   Long  (  fTotal  .  getInpayID  (  )  )  ; 
...
if  (  "inpayID"  .  equals  (  pColumn  )  )  { 
Sorter   sorter  =  new   Sorter  (  )  ; 
long  [  ]  temp  =  new   long  [  fTableData  .  length  ]  ; 
for  (  int   i  =  0  ;  i  <  temp  .  length  ;  i  ++  )  { 
temp  [  i  ]  =  fTableData  [  i  ]  .  getInpayID  (  )  ; 
} 
fSortOrder  =  sorter  .  sortLong  (  temp  ,  fSortOrder  ,  up  )  ; 
} 
