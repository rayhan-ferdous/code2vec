...
properties  .  setProperty  (  "javax.sip.OUTBOUND_PROXY"  ,  peerHostPort1  +  "/"  +  "udp"  )  ; 
...
properties  .  setProperty  (  "gov.nist.javax.sip.DEBUG_LOG"  ,  "logs/simplesipservlettest_debug_port"  +  port  +  ".txt"  )  ; 
properties  .  setProperty  (  "gov.nist.javax.sip.SERVER_LOG"  ,  "logs/simplesipservlettest_log_port"  +  port  +  ".xml"  )  ; 
...
sipPhoneReceivers  [  0  ]  =  sipStackReceivers  [  0  ]  .  createSipPhone  (  ""  +  System  .  getProperty  (  "org.mobicents.testsuite.testhostaddr"  )  +  ""  ,  SipStack  .  PROTOCOL_UDP  ,  5070  ,  "sip:to@"  +  System  .  getProperty  (  "org.mobicents.testsuite.testhostaddr"  )  +  ""  )  ; 
sipStackReceivers  [  1  ]  =  makeStack  (  SipStack  .  PROTOCOL_UDP  ,  5056  )  ; 
sipPhoneReceivers  [  1  ]  =  sipStackReceivers  [  1  ]  .  createSipPhone  (  ""  +  System  .  getProperty  (  "org.mobicents.testsuite.testhostaddr"  )  +  ""  ,  SipStack  .  PROTOCOL_UDP  ,  5070  ,  "sip:from@"  +  System  .  getProperty  (  "org.mobicents.testsuite.testhostaddr"  )  +  ""  )  ; 
} 
