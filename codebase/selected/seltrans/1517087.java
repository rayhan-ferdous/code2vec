package   no  .  uia  .  sudoku  .  diagram  .  navigator  ; 

import   java  .  util  .  Iterator  ; 
import   no  .  uia  .  sudoku  .  diagram  .  part  .  SudokuDiagramEditorPlugin  ; 
...
public   class   SudokuNavigatorLinkHelper   implements   ILinkHelper  { 
...
IDiagramDocument   document  =  SudokuDiagramEditorPlugin  .  getInstance  (  )  .  getDocumentProvider  (  )  .  getDiagramDocument  (  anInput  )  ; 
if  (  document  ==  null  )  { 
...
if  (  file  !=  null  )  { 
SudokuNavigatorItem   item  =  new   SudokuNavigatorItem  (  diagram  ,  file  ,  false  )  ; 
