...
int   opt  =  JOptionPane  .  showConfirmDialog  (  HTMLEditorPanel  .  this  ,  new   Component  [  ]  {  srcPanel  ,  altPanel  ,  hrefPanel  ,  widthPanel  ,  heightPanel  ,  hSpacePanel  ,  vSpacePanel  ,  borderPanel  ,  alignPanel  }  ,  "Image properties"  ,  JOptionPane  .  OK_CANCEL_OPTION  )  ; 
if  (  opt  ==  JOptionPane  .  OK_OPTION  )  { 
try  { 
...
new   StyledEditorKit  .  FontSizeAction  (  actionName  ,  selectedFontSize  )  .  actionPerformed  (  new   ActionEvent  (  e  .  getSource  (  )  ,  e  .  getID  (  )  ,  actionName  )  )  ; 
getJTextPane  (  )  .  requestFocusInWindow  (  )  ; 
} 
}  )  ; 
} 
