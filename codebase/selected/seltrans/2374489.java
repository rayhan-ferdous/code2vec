...
@  Override 
protected   void   handleChangePassword  (  String   userName  ,  String   passwdNew  )  throws   Exception  { 
getUserServiceSpring  (  )  .  changePassword  (  passwdNew  ,  passwdNew  )  ; 
} 
...
@  Override 
protected   void   handleAddPerson2Department  (  long   departmentId  ,  long   personId  )  throws   Exception  { 
getComponentsServiceSpring  (  )  .  addPerson2Department  (  Long  .  valueOf  (  departmentId  )  ,  Long  .  valueOf  (  personId  )  )  ; 
} 

@  Override 
protected   void   handleAddPerson2Unit  (  int   unitId  ,  long   personId  )  throws   Exception  { 
getComponentsServiceSpring  (  )  .  addPerson2Unit  (  Integer  .  valueOf  (  unitId  )  ,  Long  .  valueOf  (  personId  )  )  ; 
} 

@  Override 
protected   int   handleAddPersonLink2Unit  (  int   unitId  ,  long   personId  ,  int   roleType  )  throws   Exception  { 
try  { 
return   getComponentsServiceSpring  (  )  .  addPersonLink2Unit  (  Integer  .  valueOf  (  unitId  )  ,  Long  .  valueOf  (  personId  )  ,  Integer  .  valueOf  (  roleType  )  )  .  intValue  (  )  ; 
}  catch  (  Exception   exe  )  { 
log  .  error  (  "Error add personlink to unit"  ,  exe  )  ; 
throw   new   UserException  (  "PersonLink could not be applied to Unit: "  +  exe  .  getMessage  (  )  )  ; 
} 
} 

@  Override 
protected   int   handleAddPicture2Unit  (  int   unitId  ,  byte  [  ]  thumbnail  ,  byte  [  ]  picture  ,  String   mimeType  )  throws   Exception  { 
return   getContentServiceSpring  (  )  .  addPicture2Unit  (  Integer  .  valueOf  (  unitId  )  ,  thumbnail  ,  picture  ,  mimeType  ,  ""  ,  ""  )  .  intValue  (  )  ; 
} 
...
@  Override 
protected   void   handleClearSvgCache  (  )  throws   Exception  { 
...
@  Override 
protected   void   handleExportXlsPersonData  (  File   outputFile  )  throws   Exception  { 
try  { 
...
@  Override 
protected   PersonToUnitLinkValue  [  ]  handleGetPersonLinks4Unit  (  int   unitId  )  throws   Exception  { 
PersonToUnitLinkValue  [  ]  plinkarr  =  null  ; 
try  { 
plinkarr  =  getComponentsServiceSpring  (  )  .  getPersonLink4Unit  (  Integer  .  valueOf  (  unitId  )  )  ; 
}  catch  (  Exception   exe  )  { 
log  .  error  (  "Error getting personlinks for unit"  ,  exe  )  ; 
} 
return   plinkarr  ; 
} 
...
@  Override 
protected   Integer   handleImportDocument  (  File   file  ,  int   unitId  ,  String   fileName  ,  String   mimeType  )  throws   Exception  { 
InputStream   fis  =  null  ; 
try  { 
if  (  unitId  <  0  )  unitId  =  0  ; 
fis  =  new   BufferedInputStream  (  new   FileInputStream  (  file  )  )  ; 
return   getContentServiceSpring  (  )  .  importDocument  (  Integer  .  valueOf  (  unitId  )  ,  fileName  ,  mimeType  ,  fis  ,  (  int  )  file  .  length  (  )  )  ; 
}  catch  (  Exception   re  )  { 
...
@  Override 
protected   void   handleImportEditionFromImport  (  File   file  ,  int   unitId  )  throws   Exception  { 
InputStream   fis  =  null  ; 
try  { 
fis  =  new   BufferedInputStream  (  new   FileInputStream  (  file  )  )  ; 
if  (  unitId  <  0  )  unitId  =  0  ; 
getContentServiceSpring  (  )  .  importEdition  (  Integer  .  valueOf  (  unitId  )  ,  fis  )  ; 
}  catch  (  Exception   re  )  { 
...
@  Override 
protected   void   handleRemovePersonLinkFromUnit  (  int   personLinkId  )  throws   Exception  { 
try  { 
getComponentsServiceSpring  (  )  .  removePersonLinkFromUnit  (  Integer  .  valueOf  (  personLinkId  )  )  ; 
}  catch  (  Exception   exe  )  { 
log  .  error  (  "Error removing personlink from unit"  ,  exe  )  ; 
} 
} 
...
@  Override 
protected   void   handleRecreateContent  (  Integer   vcId  )  throws   Exception  { 
getViewServiceSpring  (  )  .  recreateContent  (  vcId  )  ; 
} 
...
@  Override 
protected   void   handleRemovePersonFromUnit  (  Integer   unitId  ,  Long   personId  )  throws   Exception  { 
getComponentsServiceSpring  (  )  .  removePersonFromUnit  (  unitId  ,  personId  )  ; 
} 

@  Override 
protected   void   handleRemovePersonFromDepartment  (  Long   departmentId  ,  Long   personId  )  throws   Exception  { 
getComponentsServiceSpring  (  )  .  removePersonFromDepartment  (  departmentId  ,  personId  )  ; 
} 
