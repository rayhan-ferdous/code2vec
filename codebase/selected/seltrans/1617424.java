...
public   ClassFinder  (  String  ...  realPaths  )  { 
synchronized  (  classpathLocations  )  { 
classpathLocations  =  getClasspathLocations  (  realPaths  )  ; 
} 
} 
...
Logger  .  getLogger  (  ClassFinder  .  class  .  getName  (  )  )  .  finest  (  "classpath="  +  classpath  )  ; 
...
while  (  it  .  hasNext  (  )  )  { 
URL   url  =  it  .  next  (  )  ; 
Logger  .  getLogger  (  ClassFinder  .  class  .  getName  (  )  )  .  finest  (  url  +  "-->"  +  map  .  get  (  url  )  )  ; 
} 
return   map  ; 
} 

private   Map  <  URL  ,  String  >  getClasspathLocations  (  String  ...  realPaths  )  { 
Map  <  URL  ,  String  >  map  =  new   TreeMap  <  URL  ,  String  >  (  URL_COMPARATOR  )  ; 
File   file  =  null  ; 
for  (  String   path  :  realPaths  )  { 
Logger  .  getLogger  (  ClassFinder  .  class  .  getName  (  )  )  .  finest  (  "path="  +  path  )  ; 
file  =  new   File  (  path  )  ; 
include  (  null  ,  file  ,  map  )  ; 
} 
Iterator  <  URL  >  it  =  map  .  keySet  (  )  .  iterator  (  )  ; 
...
Logger  .  getLogger  (  ClassFinder  .  class  .  getName  (  )  )  .  warning  (  "The file: ["  +  file  .  toString  (  )  +  "] is not accessable. "  +  "Possible reasons: Not a JAR file, disk I/O error, file "  +  "reading not permitted. Skipping...\nException thrown is:"  +  e  .  toString  (  )  )  ; 
return  ; 
} 
...
Logger  .  getLogger  (  ClassFinder  .  class  .  getName  (  )  )  .  finest  (  "JAR::"  +  jarURL  .  toExternalForm  (  )  +  entry  .  getName  (  )  )  ; 
...
while  (  it  .  hasNext  (  )  )  { 
URL   url  =  it  .  next  (  )  ; 
Logger  .  getLogger  (  ClassFinder  .  class  .  getName  (  )  )  .  finest  (  url  +  "-->"  +  locations  .  get  (  url  )  )  ; 
...
Logger  .  getLogger  (  ClassFinder  .  class  .  getName  (  )  )  .  finest  (  "package path="  +  path  )  ; 
return   path  ; 
} 
