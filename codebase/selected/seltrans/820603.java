package   oopex  .  toplink_essentials  .  jpax  .  usecases  ; 
...
import   oopex  .  toplink_essentials  .  jpax  .  usecases  .  model  .  Person  ; 
...
System  .  out  .  println  (  "found: "  +  person  +  " with "  +  (  (  oracle  .  toplink  .  essentials  .  ejb  .  cmp3  .  EntityManager  )  entityManager  )  .  getSession  (  )  .  keyFromObject  (  person  )  )  ; 
} 
}  finally  { 
entityManager  .  close  (  )  ; 
} 
