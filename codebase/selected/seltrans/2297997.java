...
private   final   transient   Collection  <  WGRoomInstance  >  singleRoom  ; 
...
if  (  cmd  ==  null  )  throw   new   IllegalArgumentException  (  "Invalid command"  )  ;  else   if  (  cmd  .  equals  (  "place"  )  )  try  { 
...
final   int   dir  ; 
if  (  (  e  .  getModifiers  (  )  &  KeyEvent  .  SHIFT_MASK  )  ==  0  )  dir  =  1  ;  else   dir  =  3  ; 
final   WGRoomInstance   room  =  painter  .  getPlacing  (  )  ; 
...
if  (  current  ==  null  ||  current  .  getSize  (  )  .  equals  (  params  .  getSize  (  )  )  )  startDoing  (  "Importing"  ,  new   Runnable  (  )  { 
...
Utils  .  showWarning  (  mainPanel  ,  "Error while importing:<br>"  +  e  .  getMessage  (  )  )  ; 
}  finally  { 
progressComplete  (  )  ; 
postEvent  (  "drop"  )  ; 
model  .  rebuildList  (  )  ; 
...
}  )  ;  else   Utils  .  showWarning  (  mainPanel  ,  "Room already exists with a different size."  )  ; 
} 
} 
} 
...
painter  .  getInputMap  (  JComponent  .  WHEN_IN_FOCUSED_WINDOW  )  .  put  (  KeyStroke  .  getKeyStroke  (  KeyEvent  .  VK_ESCAPE  ,  0  )  ,  "drop"  )  ; 
painter  .  getInputMap  (  JComponent  .  WHEN_IN_FOCUSED_WINDOW  )  .  put  (  KeyStroke  .  getKeyStroke  (  KeyEvent  .  VK_DELETE  ,  0  )  ,  "delsel"  )  ; 
...
return  !  (  world  !=  null  &&  world  .  isDirty  (  )  &&  Utils  .  showConfirm  (  mainPanel  ,  "World has been changed. Save?"  )  )  ||  saveWorld  (  )  ; 
} 
...
if  (  world  !=  null  &&  world  .  containsRoom  (  selected  .  getRoom  (  )  )  )  Utils  .  showWarning  (  mainPanel  ,  "Cannot delete room; room is in use."  )  ;  else   if  (  Utils  .  showConfirm  (  mainPanel  ,  "Really delete \""  +  selected  .  getName  (  )  +  "\"?"  )  )  { 
...
postEvent  (  "drop"  )  ; 
model  .  rebuildList  (  )  ; 
}  else   Utils  .  showWarning  (  mainPanel  ,  "Cannot delete room from file system."  )  ; 
} 
} 
} 
} 
...
for  (  WGRoomInstance   room  :  world  )  if  (  room  .  getRoom  (  )  .  isHallway  (  )  )  { 
hasHallway  =  true  ; 
break  ; 
} 
if  (  hasHallway  )  { 
...
final   ExportWorldDialog   exportParams  =  new   ExportWorldDialog  (  mainPanel  ,  this  ,  rooms  .  getRoomFinder  (  )  )  ; 
if  (  exportParams  .  show  (  "Export World"  )  ==  AbstractDialog  .  DIALOG_OK  )  startDoing  (  "Exporting"  ,  new   Runnable  (  )  { 
...
Utils  .  showWarning  (  mainPanel  ,  "Error while exporting:<br>"  +  e  .  getMessage  (  )  )  ; 
}  finally  { 
progressComplete  (  )  ; 
} 
...
}  else   Utils  .  showWarning  (  mainPanel  ,  "The world needs at least one hallway to be "  +  "exported."  )  ; 
} 
} 
...
exportDialog  .  setSelectedFile  (  new   File  (  exportDialog  .  getCurrentDirectory  (  )  ,  String  .  format  (  "Template%dx%dx%d.t3d"  ,  size  .  depth  ,  size  .  width  ,  size  .  height  )  )  )  ; 
if  (  exportDialog  .  showSaveDialog  (  mainPanel  )  ==  JFileChooser  .  APPROVE_OPTION  )  try  { 
...
if  (  dialog  .  show  (  "Create Maze"  )  ==  AbstractDialog  .  DIALOG_OK  )  startDoing  (  "Generating Maze"  ,  new   Runnable  (  )  { 
...
final   IntDimension3D   size  =  dialog  .  getSize  (  )  ; 
final   WGRoom   newRoom  =  new   WGRoom  (  name  +  ".t3d"  ,  size  ,  name  ,  "Maze"  )  ; 
final   File   out  =  rooms  .  getRoomFinder  (  )  .  getOutputLocation  (  newRoom  )  ; 
try  { 
final   Maze   maze  =  new   Maze  (  size  .  depth  *  per  ,  size  .  width  *  per  ,  dialog  .  getDifficulty  (  )  ,  dialog  .  getIncline  (  )  )  ; 
maze  .  generate  (  )  ; 
...
if  (  url  !=  null  )  icon  =  new   ImageIcon  (  url  )  ;  else   icon  =  null  ; 
return   icon  ; 
} 
...
if  (  world  !=  null  )  for  (  WGRoomInstance   room  :  world  )  { 
src  =  room  .  getRoom  (  )  ; 
if  (  src  .  getPreviewImage  (  )  ==  null  )  rooms  .  computePreview  (  src  )  ; 
} 
}  finally  { 
postEvent  (  "complete"  )  ; 
} 
...
rooms  .  clearPreviews  (  )  ; 
for  (  WGRoomInstance   room  :  world  )  rooms  .  computePreview  (  room  .  getRoom  (  )  )  ; 
model  .  updateTree  (  )  ; 
...
if  (  !  Utils  .  showConfirm  (  mainPanel  ,  message  .  toString  (  )  )  )  loaded  =  null  ; 
} 
if  (  loaded  !=  null  )  { 
rooms  .  clearPreviews  (  )  ; 
world  =  loaded  ; 
...
painter  .  clearSelection  (  )  ; 
painter  .  setWorld  (  world  )  ; 
if  (  world  !=  null  )  frame  .  setTitle  (  O_TITLE  +  " -- "  +  world  .  getName  (  )  )  ; 
} 
return   opened  ; 
} 
...
if  (  EventQueue  .  isDispatchThread  (  )  )  uiEvent  (  event  )  ;  else   SwingUtilities  .  invokeLater  (  new   Runnable  (  )  { 
...
for  (  WGRoomInstance   room  :  world  )  if  (  room  .  getX  (  )  +  room  .  getDepth  (  )  <=  depth  &&  room  .  getY  (  )  +  room  .  getHeight  (  )  <=  width  )  newWorld  .  addRoom  (  room  )  ;  else  { 
Utils  .  showWarning  (  mainPanel  ,  "Cannot resize world to that size."  )  ; 
finished  =  false  ; 
break  ; 
} 
if  (  finished  )  { 
for  (  WGItem   item  :  world  .  getItems  (  )  )  newWorld  .  addItem  (  item  )  ; 
world  =  newWorld  ; 
painter  .  setWorld  (  world  )  ; 
model  .  updateTree  (  )  ; 
painter  .  clearSelection  (  )  ; 
...
if  (  fileDialog  .  showSaveDialog  (  mainPanel  )  ==  JFileChooser  .  APPROVE_OPTION  )  try  { 
...
final   Action   addRoomAction  =  new   GeneralAction  (  "Add Room..."  ,  "addroom"  ,  KeyEvent  .  VK_R  ,  "Import a new room into the list"  )  ; 
...
delRoomAction  =  new   GeneralAction  (  "Delete Room"  ,  "delroom"  ,  -  1  ,  "Delete the selected room from the list"  )  ; 
delRoomAction  .  setEnabled  (  false  )  ; 
roomPopup  .  add  (  new   JMenuItem  (  delRoomAction  )  )  ; 
editMenu  .  add  (  new   JMenuItem  (  delRoomAction  )  )  ; 
editMenu  .  add  (  new   JMenuItem  (  new   GeneralAction  (  "Select All"  ,  "selectall"  ,  KeyEvent  .  VK_A  ,  "Selects all rooms in the world."  )  )  )  ; 
editMenu  .  addSeparator  (  )  ; 
selectionDelDoors  =  new   GeneralAction  (  "Remove Doors from Selection"  ,  "deldoors"  ,  -  1  ,  "Removes all doors between the selected rooms"  )  ; 
selectionDelDoors  .  setEnabled  (  false  )  ; 
editMenu  .  add  (  new   JMenuItem  (  selectionDelDoors  )  )  ; 
selectionAddDoors  =  new   GeneralAction  (  "Restore Doors to Selection"  ,  "alldoors"  ,  -  1  ,  "Restores all doors between the selected rooms"  )  ; 
selectionAddDoors  .  setEnabled  (  false  )  ; 
editMenu  .  add  (  new   JMenuItem  (  selectionAddDoors  )  )  ; 
editMenu  .  add  (  new   JMenuItem  (  new   GeneralAction  (  "Resize World"  ,  "resize"  ,  KeyEvent  .  VK_I  ,  "Changes the size of the world"  )  )  )  ; 
...
menus  .  add  (  fileMenu  )  ; 
final   Action   newAction  =  new   GeneralAction  (  "New..."  ,  "new"  ,  KeyEvent  .  VK_N  ,  "Creates a new world of the specified size"  )  ; 
stdBar  .  add  (  Utils  .  createToolbarButton  (  newAction  )  )  ; 
fileMenu  .  add  (  new   JMenuItem  (  newAction  )  )  ; 
final   Action   openAction  =  new   GeneralAction  (  "Open"  ,  "open"  ,  KeyEvent  .  VK_O  ,  "Opens a previously created world's XML file"  )  ; 
stdBar  .  add  (  Utils  .  createToolbarButton  (  openAction  )  )  ; 
fileMenu  .  add  (  new   JMenuItem  (  openAction  )  )  ; 
fileMenu  .  addSeparator  (  )  ; 
final   Action   saveAction  =  new   GeneralAction  (  "Save"  ,  "save"  ,  KeyEvent  .  VK_S  ,  "Saves the world as an XML file"  )  ; 
stdBar  .  add  (  Utils  .  createToolbarButton  (  saveAction  )  )  ; 
fileMenu  .  add  (  new   JMenuItem  (  saveAction  )  )  ; 
final   Action   exportAction  =  new   GeneralAction  (  "Export..."  ,  "export"  ,  KeyEvent  .  VK_E  ,  "Exports the world as a T3D file to import into UDK"  )  ; 
stdBar  .  add  (  Utils  .  createToolbarButton  (  exportAction  )  )  ; 
stdBar  .  add  (  new   JToolBar  .  Separator  (  )  )  ; 
fileMenu  .  add  (  new   JMenuItem  (  exportAction  )  )  ; 
fileMenu  .  addSeparator  (  )  ; 
fileMenu  .  add  (  new   JMenuItem  (  new   GeneralAction  (  "Exit"  ,  "exit"  ,  KeyEvent  .  VK_Q  ,  "Closes the world generator"  )  )  )  ; 
} 
...
toolsMenu  .  add  (  new   JMenuItem  (  new   GeneralAction  (  "Refresh Rooms"  ,  "index"  ,  -  1  ,  "Refresh all room data if interface becomes inconsistent or stale"  )  )  )  ; 
final   Action   mifAction  =  new   GeneralAction  (  "Generate MIF..."  ,  "mif"  ,  KeyEvent  .  VK_F  ,  "Generates a MIF from a pre-existing T3D file"  )  ; 
external  .  add  (  new   JMenuItem  (  mifAction  )  )  ; 
stdBar  .  add  (  Utils  .  createToolbarButton  (  mifAction  )  )  ; 
external  .  add  (  new   JMenuItem  (  new   GeneralAction  (  "Victimize Map..."  ,  "victims"  ,  -  1  ,  "Adds victims to a pre-existing T3D file<br>"  +  "To add victims to this world, export it and victimize the generated T3D"  )  )  )  ; 
final   Action   templateAction  =  new   GeneralAction  (  "Template Room..."  ,  "template"  ,  -  1  ,  "Generates a template room for use when designing rooms"  )  ; 
generate  .  add  (  new   JMenuItem  (  templateAction  )  )  ; 
stdBar  .  add  (  Utils  .  createToolbarButton  (  templateAction  )  )  ; 
final   Action   mazeAction  =  new   GeneralAction  (  "Maze..."  ,  "maze"  ,  KeyEvent  .  VK_M  ,  "Generates a maze room"  )  ; 
...
if  (  visible  )  Utils  .  centerWindow  (  frame  )  ; 
...
if  (  cmd  .  equals  (  "addroom"  )  )  addRoom  (  )  ;  else   if  (  cmd  .  equals  (  "alldoors"  )  &&  world  !=  null  )  { 
...
painter  .  repaint  (  )  ; 
}  else   if  (  cmd  .  equals  (  "delroom"  )  )  delRoom  (  )  ;  else   if  (  cmd  .  equals  (  "delsel"  )  )  painter  .  removeSelected  (  )  ;  else   if  (  cmd  .  equals  (  "drop"  )  )  { 
if  (  painter  .  getPlacing  (  )  !=  null  )  { 
objectTree  .  clearSelection  (  )  ; 
painter  .  setPlacing  (  null  )  ; 
}  else   painter  .  clearSelection  (  )  ; 
}  else   if  (  cmd  .  equals  (  "exit"  )  )  exit  (  )  ;  else   if  (  cmd  .  equals  (  "export"  )  )  exportWorld  (  )  ;  else   if  (  cmd  .  equals  (  "index"  )  )  index  (  )  ;  else   if  (  cmd  .  equals  (  "maze"  )  )  generateMaze  (  )  ;  else   if  (  cmd  .  equals  (  "mif"  )  )  generateMIF  (  )  ;  else   if  (  cmd  .  equals  (  "new"  )  &&  confirmClose  (  )  )  newWorld  (  )  ;  else   if  (  cmd  .  equals  (  "open"  )  &&  confirmClose  (  )  )  openWorld  (  )  ;  else   if  (  cmd  .  equals  (  "resize"  )  )  resizeWorld  (  )  ;  else   if  (  cmd  .  equals  (  "save"  )  )  saveWorld  (  )  ;  else   if  (  cmd  .  equals  (  "selectall"  )  )  painter  .  selectAll  (  )  ;  else   if  (  cmd  .  equals  (  "template"  )  )  generateTemplate  (  )  ;  else   if  (  cmd  .  equals  (  "victims"  )  )  victimize  (  )  ; 
} 
...
if  (  dialog  .  show  (  "Add Victims"  )  ==  AbstractDialog  .  DIALOG_OK  )  startDoing  (  "Victimizing"  ,  new   Runnable  (  )  { 

public   void   run  (  )  { 
bgProgress  .  setIndeterminate  (  true  )  ; 
try  { 
Victimizer  .  victimize  (  exportDialog  .  getSelectedFile  (  )  ,  dialog  .  getVictimCount  (  )  ,  dialog  .  getCompatMode  (  )  )  ; 
}  catch  (  IOException   e  )  { 
...
if  (  e  .  isAddedPath  (  )  )  { 
if  (  sel  ==  null  )  delRoomAction  .  setEnabled  (  false  )  ;  else  { 
...
found  =  false  ; 
for  (  WGRoomContainer   container  :  root  .  getRoomList  (  )  )  if  (  container  .  getSize  (  )  .  equals  (  room  .  getSize  (  )  )  &&  !  container  .  isPlaceable  (  )  )  { 
...
for  (  TreeModelListener   l  :  listenerList  )  l  .  treeStructureChanged  (  evt  )  ; 
painter  .  setPlacing  (  null  )  ; 
} 
