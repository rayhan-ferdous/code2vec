...
se  .  mdh  .  mrtc  .  saveccm  .  diagram  .  part  .  SaveccmDiagramEditorPlugin  .  getInstance  (  )  .  logError  (  "Failed to delete validation markers"  ,  e  )  ; 
} 
} 
...
se  .  mdh  .  mrtc  .  saveccm  .  diagram  .  part  .  SaveccmDiagramEditorPlugin  .  getInstance  (  )  .  logError  (  "Failed to create validation marker"  ,  e  )  ; 
} 
return   marker  ; 
} 
} 
