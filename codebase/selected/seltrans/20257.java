...
public   class   ExplodeRemoteData   extends   FtsRemoteUndoableDataObject   implements   ExplodeDataModel  ,  ClipableData  ,  ClipboardOwner  { 
...
remoteCall  (  REMOTE_REMOVE  ,  removeIndex  )  ; 
...
for  (  ExplodeDataListener   listener  :  listeners  )  listener  .  objectAdded  (  spec  ,  index  )  ; 
} 

private   void   notifyObjectDeleted  (  Object   spec  ,  int   oldIndex  )  { 
for  (  ExplodeDataListener   listener  :  listeners  )  listener  .  objectDeleted  (  spec  ,  oldIndex  )  ; 
} 

private   void   notifyObjectChanged  (  Object   spec  )  { 
for  (  ExplodeDataListener   listener  :  listeners  )  listener  .  objectChanged  (  spec  )  ; 
} 

private   void   notifyObjectMoved  (  Object   spec  ,  int   oldIndex  ,  int   newIndex  )  { 
for  (  ExplodeDataListener   listener  :  listeners  )  listener  .  objectMoved  (  spec  ,  oldIndex  ,  newIndex  )  ; 
} 
...
copy  (  )  ; 
beginUpdate  (  )  ; 
for  (  ScrEvent   aEvent  :  ExplodeSelection  .  getCurrent  (  )  .  getSelected  (  )  )  removeEvent  (  aEvent  )  ; 
endUpdate  (  )  ; 
} 
...
Toolkit  .  getDefaultToolkit  (  )  .  getSystemClipboard  (  )  .  setContents  (  ExplodeSelection  .  getCurrent  (  )  ,  this  )  ; 
} 
...
private   java  .  util  .  List  <  ExplodeDataListener  >  listeners  =  new   LinkedList  <  ExplodeDataListener  >  (  )  ; 
