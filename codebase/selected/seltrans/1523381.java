...
StringBuffer   queryThreads  =  new   StringBuffer  (  "update Threads as t set t.attachment = 0 "  )  ; 
StringBuffer   queryPosts  =  new   StringBuffer  (  "update Posts as t set t.attachment = 0 "  )  ; 
StringBuffer   deleteAttachments  =  new   StringBuffer  (  "delete from Attachments as t"  )  ; 
int   num  =  -  1  ; 
try  { 
