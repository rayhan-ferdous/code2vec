...
if  (  imdbid  <  0  )  throw   new   IllegalArgumentException  (  "Illegal IMDb ID: "  +  imdbid  )  ; 
Document   dom  =  fetchResource  (  "Movie.imdbLookup"  ,  String  .  format  (  "tt%07d"  ,  imdbid  )  ,  locale  ,  REQUEST_LIMIT  )  ; 
...
translated  ,  adult  ,  language  ,  original_name  ,  name  ,  type  ,  id  ,  imdb_id  ,  url  ,  overview  ,  votes  ,  rating  ,  tagline  ,  certification  ,  released  ,  runtime 
} 
...
if  (  person  .  isDirector  (  )  )  return   person  .  getName  (  )  ; 
} 
return   null  ; 
} 
...
name  ,  character  ,  job  ,  thumb  ,  department 
} 
