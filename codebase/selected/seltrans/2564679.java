...
if  (  this  .  iface  !=  null  )  this  .  iface  .  TorrentDownloaderEvent  (  this  .  state  ,  this  )  ;  else   if  (  this  .  state  ==  STATE_ERROR  )  System  .  err  .  println  (  this  .  error  )  ; 
} 
...
if  (  (  !  this  .  isAlive  (  )  )  ||  (  this  .  file  ==  null  )  )  this  .  file  =  new   File  (  this  .  directoryname  ,  filename  )  ; 
return   this  .  file  ; 
} 
...
if  (  !  this  .  isAlive  (  )  )  { 
if  (  path  !=  null  )  this  .  directoryname  =  path  ; 
