...
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Using local HTTP session to store local state. Channel ("  +  channel  .  getName  (  )  +  ")"  )  ; 
} 
...
exchange  .  getOut  (  )  .  getHeaders  (  )  .  put  (  "org.atricore.idbus.http.Set-Cookie."  +  name  ,  state  .  getRemoteVariable  (  name  )  +  ";Path=/"  )  ; 
} 
} 
} 
...
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Using Provider State ID "  +  localStateId  +  " from cookie "  +  localStateVarName  )  ; 
...
if  (  retryCount  >  0  )  lState  =  ctx  .  retrieve  (  localStateId  ,  retryCount  ,  getRetryDelay  (  )  )  ;  else   lState  =  ctx  .  retrieve  (  localStateId  )  ; 
if  (  lState  ==  null  )  { 
lState  =  ctx  .  createState  (  )  ; 
localStateId  =  lState  .  getId  (  )  ; 
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Created new local state for provider "  +  p  .  getName  (  )  +  ". Channel ("  +  channel  .  getName  (  )  +  ") "  +  localStateId  )  ; 
}  else  { 
if  (  logger  .  isDebugEnabled  (  )  )  logger  .  debug  (  "Found local state for provider "  +  p  .  getName  (  )  +  ". Channel ("  +  channel  .  getName  (  )  +  ") "  +  lState  .  getId  (  )  )  ; 
} 
} 
...
if  (  exchange  .  getIn  (  )  .  getHeader  (  "http.requestMethod"  )  .  equals  (  "POST"  )  )  params  .  putAll  (  getParameters  (  (  InputStream  )  exchange  .  getIn  (  )  .  getBody  (  )  )  )  ; 
...
protected   Html   createHtmlAjaxPostMessage  (  String   url  ,  String   relayState  ,  String   msgName  ,  String   msgValue  )  throws   Exception  { 
Html   html  =  createHtmlBaseMessage  (  )  ; 
Body   body  =  html  .  getBody  (  )  ; 
Form   form  =  new   Form  (  )  ; 
form  .  setMethod  (  "post"  )  ; 
...
title  .  setContent  (  "JOSSO 2 - Processing ..."  )  ; 
...
processingP  .  getContent  (  )  .  add  (  "You'll get redirected shortly, please wait ..."  )  ; 
processingP  .  getContent  (  )  .  add  (  br  )  ; 
processingP  .  getContent  (  )  .  add  (  br  )  ; 
...
if  (  retryCountStr  ==  null  )  return  -  1  ; 
...
if  (  retryDelayStr  ==  null  )  return  -  1  ; 
