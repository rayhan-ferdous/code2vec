...
tokenizer  .  nextToken  (  )  ; 
if  (  (  tokenizer  .  ttype  ==  EnhancedStreamTokenizer  .  TT_WORD  )  ||  (  tokenizer  .  ttype  ==  DBConstants  .  quoteChar  )  )  name  =  tokenizer  .  sval  ;  else   throw  (  new   DBParseException  (  "Invalid info field name..."  ,  tokenizer  ,  fileName  )  )  ; 
tokenizer  .  nextToken  (  )  ; 
if  (  tokenizer  .  ttype  ==  DBConstants  .  quoteChar  )  value  =  tokenizer  .  sval  ;  else   throw  (  new   DBParseException  (  "Invalid info field value..."  ,  tokenizer  ,  fileName  )  )  ; 
DBFieldData   fd  =  new   DBFieldData  (  name  ,  value  )  ; 
fd  .  setComment  (  comment  )  ; 
comment  =  nullString  ; 
rd  .  addInfoField  (  fd  )  ; 
...
tokenizer  .  nextToken  (  )  ; 
if  (  (  tokenizer  .  ttype  ==  EnhancedStreamTokenizer  .  TT_WORD  )  ||  (  tokenizer  .  ttype  ==  DBConstants  .  quoteChar  )  )  vec  .  addElement  (  tokenizer  .  sval  )  ;  else   Console  .  getInstance  (  )  .  println  (  "Warning: error found in file '"  +  fileName  +  "', line "  +  tokenizer  .  lineno  (  )  +  " near token '"  +  tokenizer  .  sval  +  "':\n\tinvalid '"  +  DBD_ENTRY_STR  +  "' entry. Quoted DBD filename expected..."  )  ; 
