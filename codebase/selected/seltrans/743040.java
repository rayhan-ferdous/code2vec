...
try  { 
tr  =  session  .  beginTransaction  (  )  ; 
Query   query  =  session  .  createQuery  (  "from Members m where m.username = :memberName and m.groupid in ("  +  groupIds  +  ")"  )  ; 
...
try  { 
tr  =  session  .  beginTransaction  (  )  ; 
Profilefields   profile  =  (  Profilefields  )  session  .  get  (  Profilefields  .  class  ,  filedId  )  ; 
tr  .  commit  (  )  ; 
return   profile  ; 
}  catch  (  HibernateException   e  )  { 
if  (  tr  !=  null  )  { 
...
try  { 
tr  =  session  .  beginTransaction  (  )  ; 
Query   query  =  session  .  createQuery  (  "from Access as a where a.id.fid=? and a.id.uid=?"  )  ; 
...
new   Exception  (  "��ʾҪ���µĻ���еĲ�����ȷ������ "  +  "extcredits1, extcredits2, extcredits3,extcredits4, "  +  "extcredits5, extcredits6, extcredits7,extcredits8 �е�����һ����"  )  ; 
} 
session  .  update  (  member  )  ; 
} 
tr  .  commit  (  )  ; 
