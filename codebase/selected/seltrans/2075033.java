...
public   class   ObjectInputStreamTest   extends   junit  .  framework  .  TestCase   implements   Serializable  { 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  "Verifies the protected ObjectInputStream() constructor."  ,  method  =  "ObjectInputStream"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  method  =  "ObjectInputStream"  ,  args  =  {  java  .  io  .  InputStream  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks IOException."  ,  method  =  "ObjectInputStream"  ,  args  =  {  java  .  io  .  InputStream  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  method  =  "available"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks IOException."  ,  method  =  "available"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  ""  ,  method  =  "defaultReadObject"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Verifies enableResolveObject(boolean)."  ,  method  =  "enableResolveObject"  ,  args  =  {  boolean  .  class  }  ) 
public   void   test_enableResolveObjectB  (  )  throws   IOException  { 
BasicObjectInputStream   bois  =  new   BasicObjectInputStream  (  )  ; 
assertFalse  (  "Test 1: Object resolving must be disabled by default."  ,  bois  .  enableResolveObject  (  true  )  )  ; 
assertTrue  (  "Test 2: enableResolveObject did not return the previous value."  ,  bois  .  enableResolveObject  (  false  )  )  ; 
} 




@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  method  =  "read"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks Exceptions."  ,  method  =  "read"  ,  args  =  {  byte  [  ]  .  class  ,  int  .  class  ,  int  .  class  }  ) 
...
@  TestTargets  (  {  @  TestTargetNew  (  method  =  "readFields"  ,  args  =  {  }  ,  level  =  TestLevel  .  COMPLETE  )  ,  @  TestTargetNew  (  method  =  "writeFields"  ,  args  =  {  }  ,  clazz  =  ObjectOutputStream  .  class  ,  level  =  TestLevel  .  COMPLETE  )  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  method  =  "readFully"  ,  args  =  {  byte  [  ]  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks IOException."  ,  method  =  "readFully"  ,  args  =  {  byte  [  ]  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  method  =  "readFully"  ,  args  =  {  byte  [  ]  .  class  ,  int  .  class  ,  int  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks Exceptions."  ,  method  =  "readFully"  ,  args  =  {  byte  [  ]  .  class  ,  int  .  class  ,  int  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  method  =  "readLine"  ,  args  =  {  }  ) 
...
@  SuppressWarnings  (  "deprecation"  ) 
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks IOException."  ,  method  =  "readLine"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  ""  ,  method  =  "readObject"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  "Verifies readObjectOverride()."  ,  method  =  "readObjectOverride"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  "Verifies readStreamHeader()."  ,  method  =  "readStreamHeader"  ,  args  =  {  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  "Verifies resolveProxyClass(String[])."  ,  method  =  "resolveProxyClass"  ,  args  =  {  java  .  lang  .  String  [  ]  .  class  }  ) 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  method  =  "skipBytes"  ,  args  =  {  int  .  class  }  ) 
...
ois  .  read  (  buf  ,  0  ,  5  )  ; 
ois  .  close  (  )  ; 
assertEquals  (  "Skipped incorrect bytes"  ,  testString  .  substring  (  5  ,  10  )  ,  new   String  (  buf  ,  0  ,  5  )  )  ; 
try  { 
...
@  TestTargetNew  (  level  =  TestLevel  .  PARTIAL_COMPLETE  ,  notes  =  "Checks IOException."  ,  method  =  "skipBytes"  ,  args  =  {  int  .  class  }  ) 
...
if  (  dir  ==  null  )  throw   new   Exception  (  "System property java.io.tmpdir not defined."  )  ; 
...
public   BasicObjectInputStream  (  InputStream   input  )  throws   StreamCorruptedException  ,  IOException  { 
super  (  input  )  ; 
} 
...
public   Object   readObjectOverride  (  )  throws   OptionalDataException  ,  ClassNotFoundException  ,  IOException  { 
...
public   static   class   ObjectInputStreamWithReadDesc1   extends   ObjectInputStream  { 

public   ObjectInputStreamWithReadDesc1  (  InputStream   is  )  throws   IOException  { 
super  (  is  )  ; 
} 
...
@  TestTargetNew  (  level  =  TestLevel  .  SUFFICIENT  ,  notes  =  "No IOException testing since this seems not to be thrown."  ,  method  =  "resolveClass"  ,  args  =  {  java  .  io  .  ObjectStreamClass  .  class  }  ) 
...
@  TestTargets  (  {  @  TestTargetNew  (  method  =  "readClassDescriptor"  ,  args  =  {  }  ,  level  =  TestLevel  .  PARTIAL_COMPLETE  )  ,  @  TestTargetNew  (  method  =  "writeClassDescriptor"  ,  args  =  {  ObjectStreamClass  .  class  }  ,  clazz  =  ObjectOutputStream  .  class  ,  level  =  TestLevel  .  COMPLETE  )  }  ) 
...
byte  [  ]  bytes  =  baos  .  toByteArray  (  )  ; 
ByteArrayInputStream   bais  =  new   ByteArrayInputStream  (  bytes  )  ; 
ObjectInputStreamWithReadDesc1   ois  =  new   ObjectInputStreamWithReadDesc1  (  bais  )  ; 
...
@  TestTargetNew  (  level  =  TestLevel  .  COMPLETE  ,  notes  =  ""  ,  method  =  "registerValidation"  ,  args  =  {  java  .  io  .  ObjectInputValidation  .  class  ,  int  .  class  }  ) 
...
Class  <  ?  >  classes  [  ]  =  new   Class  [  ]  {  byte  .  class  ,  short  .  class  ,  int  .  class  ,  long  .  class  ,  boolean  .  class  ,  char  .  class  ,  float  .  class  ,  double  .  class  }  ; 
