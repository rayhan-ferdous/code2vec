...
import   java  .  util  .  *  ; 
import   com  .  eshop  .  vo  .  ProductCategoryTreeVO  ; 
import   com  .  util  .  comparator  .  *  ; 
import   com  .  util  .  table  .  *  ; 

public   class   ProductCategoryTreeModel   implements   ITableModel  { 

protected   ProductCategoryTreeVO   fTotal  ; 

protected   ProductCategoryTreeVO  [  ]  fTableData  ; 
...
public   ProductCategoryTreeModel  (  )  { 
super  (  )  ; 
} 

public   void   setData  (  Object  [  ]  data  )  { 
fTableData  =  (  ProductCategoryTreeVO  [  ]  )  data  ; 
...
ProductCategoryTreeVO   vo  =  fTableData  [  fSortOrder  [  pRow  ]  ]  ; 
