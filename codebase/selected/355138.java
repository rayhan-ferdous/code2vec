...
public class OficioRemisionBean implements SessionBean {
    ...
    private String SENTENCIA = "INSERT INTO BZOFREM (" + "REM_OFANY, REM_OFOFI, REM_OFNUM, REM_OFFEC, REM_CONT, REM_SALANY, REM_SALOFI, REM_SALNUM, REM_NULA, REM_NULMTD, REM_NULUSU, REM_NULFEC, " + "REM_ENTFEC, REM_ENTDES, REM_ENTUSU, REM_ENTMTD, REM_ENTANY, REM_ENTOFI, REM_ENTNUM" + ") VALUES (?,?,?, ?,?,?, ?,?,?, ?,?,?, ?,?,?, ?,?,?, ?)";

    private String SENTENCIA_UPDATE = "UPDATE BZOFREM " + "SET REM_OFFEC=?, REM_CONT=?, REM_SALANY=?, REM_SALOFI=?, REM_SALNUM=?, REM_NULA=?, REM_NULMTD=?, REM_NULUSU=?, REM_NULFEC=?, " + "REM_ENTFEC=?, REM_ENTDES=?, REM_ENTUSU=?, REM_ENTMTD=?, REM_ENTANY=?, REM_ENTOFI=?, REM_ENTNUM=? " + " WHERE REM_OFANY=? AND REM_OFOFI=? AND REM_OFNUM=?";
