...
public abstract class ProxySupplierPOA extends org.omg.PortableServer.Servant implements org.omg.CORBA.portable.InvokeHandler, ProxySupplierOperations {

    static final String[] _ob_ids_ = { "IDL:omg.org/CosNotifyChannelAdmin/ProxySupplier:1.0", "IDL:omg.org/CosNotification/QoSAdmin:1.0", "IDL:omg.org/CosNotifyFilter/FilterAdmin:1.0" };

    public ProxySupplier _this() {
        return ProxySupplierHelper.narrow(super._this_object());
    }

    public ProxySupplier _this(org.omg.CORBA.ORB orb) {
        return ProxySupplierHelper.narrow(super._this_object(orb));
    }
