...
public class RegistrationBean implements Serializable {
    ...
    private static final transient Logger logger = new Logger(RegistrationBean.class);

    private static final transient String END_REGISTRATION_VIEW_ID = "/xhtml/session/endRegistration.jsf";

    private static final transient String END_RESET_PASSWORD_VIEW_ID = "/xhtml/session/endResetPassword.jsf";

    private static final transient String MODIFY_PERSONAL_DATA_VIEW_ID = "/xhtml/secured/modifyPersonalData.jsf";
