...
import misusecase.diagram.edit.parts.MisuseCaseEditPart;
...
public class SeaMonsterDiagramEditorUtil {
    ...
    public static Resource createDiagram(URI diagramURI, IProgressMonitor progressMonitor) {
        ...
        AbstractTransactionalCommand command = new AbstractTransactionalCommand(editingDomain, Messages.SeaMonsterDiagramEditorUtil_CreateDiagramCommandLabel, Collections.EMPTY_LIST) {
            ...
            protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
                SeaMonster.MisuseCase model = createInitialModel();
                attachModelToResource(model, diagramResource);
                Diagram diagram = ViewService.createDiagram(model, MisuseCaseEditPart.MODEL_ID, SeaMonsterDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
                if (diagram != null) {
                ...
                try {
                    diagramResource.save(misusecase.diagram.part.SeaMonsterDiagramEditorUtil.getSaveOptions());
                } catch (IOException e) {
	 ...
	 * @generated
	 */
    private static SeaMonster.MisuseCase createInitialModel() {
        return SeaMonster.SeaMonsterFactory.eINSTANCE.createMisuseCase();
    }
	 ...
	 * @generated
	 */
    private static void attachModelToResource(SeaMonster.MisuseCase model, Resource resource) {
