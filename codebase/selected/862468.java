...
import java.util.*;
import com.creditors.vo.PaymentViewVO;
import com.util.comparator.*;
import com.util.table.*;

public class PaymentViewModel implements ITableModel {

    protected PaymentViewVO fTotal;

    protected PaymentViewVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        PaymentViewVO vo = fTableData[fSortOrder[pRow]];
