package org.xulbooster.eclipse.ui.utils.dialog;
 ...
 * @since 2.1
 */
public class ResourceListFilterDialog extends SelectionDialog {
     ...
     */
    public ResourceListFilterDialog(Shell parentShell, IResource[] resources) {
        super(parentShell);
     ...
     */
    public ResourceListFilterDialog(Shell parentShell, IContainer container, int typeMask) {
        super(parentShell);
