 ...
 * <p>
 * FileUtils: a utility class that contains static methods for handling files
 * and directories.
 * <p>
 * Created on 12 ao�t 2005
 * 
 * @author Ocquidant
 */
public final class FileUtils {
    ...
    * @return if path starts with dir, then the rest of the path, else path <br>
    *         <br>
    *         <b>Examples</b>:
    *         <li><code>relPath("c:\\MyHome\\dev", "c:\\MyHome\\dev\\src\\java")</code>
    *         returns "src\\java";</li>
    *         <li><code>relPath("/home/zaphod", "/home/zaphod/jbuilder8/samples/welcome")</code>
    *         returns "jbuilder8/samples/welcome";</li>
    *         <li><code>relPath("/home/zaphod", "/home/ford/jbuilder8")</code>
    *         returns "/home/ford/jbuilder8".</li>
    */
    ...
    /**
    * Having a directory and file path (relative or absolute) calculates full
    * path
    * 
    * @param currentDir directory path
    * @param filepath file path, relative or not
    * @return full file path <br>
    *         <br>
    *         <b>Examples</b>:
    *         <li><code>path("c:\\MyHome\\dev", "src\\java")</code> returns
    *         "c:\\MyHome\\dev\\src\\java";</li>
    *         <li><code>path("/root/inetd", "/home/zaphod/jbuilder8/samples/welcome")</code>
    *         returns "/home/zaphod/jbuilder8/samples/welcome";</li>
    *         <li><code>path("\\Program FileUtils", "c:\\MyHome\\dev")</code>
    *         returns "c:\\MyHome\\dev".</li>
    */
    ...
    *         <br>
    *         <b>Examples</b>:
    *         <li><code>splitPath("/home/zaphod/jbuilder8/samples/welcome")</code>
    *         returns {"/home/zaphod/jbuilder8/samples", "welcome"};</li>
    *         <li><code>splitPath("src.java")</code> returns {".",
    *         "src.java"};</li>
    *         <li><code>splitPath("MyHome\\dev")</code> returns {"MyHome",
    *         "dev"}.</li>
    */
    ...
    * 
    * @param file
    * @return directory path Unlike java.io.File.getParent(), never returns null
    ...
    *         <li><code>dirname(new File("MyHome\\dev"))</code> returns
    *         "MyHome".</li>
    */
    ...
    *         <br>
    *         <b>Examples</b>:
    *         <li><code>dirname("/home/zaphod/jbuilder11/samples/welcome")</code>
    *         returns "/home/zaphod/jbuilder8/samples";</li>
    ...
    *         <br>
    *         <b>Example</b>:
    *         <li><code>filename("/home/zaphod/jbuilder11/samples/welcome")</code>
    *         returns "welcome".</li>
    */
    ...
    * @return List&lt;String> of absolute filepaths <br>
    *   <br>
    *   <b>Example</b>:
    *   <li><code>find(new File("."), Pattern.compile(".*les\\.java$")))</code>
    *   returns Arrays.asList(new String[] {new
    *   File("FileUtils.java").getCanonicalPath()}).</li>
    */
    ...
    *         <br>
    *         <b>Example</b>:
    *         <li><code>find(".", Pattern.compile(".*les\\.java$")))</code>
    *         returns Arrays.asList(new String[] {"FileUtils.java"}).</li>
    */
    ...
    *         Arrays.asList(new String[] {"FileUtils.java"}).</li>
    */
    ...
    /**
    * Finds latest file or directory or one of these which name matches a
    * pattern
    * 
    * @param subdir where to look
    * @param pattern to match
    ...
    * 
    * @param file
    * @return file modification time as a string <br>
    *         <br>
    *         <b>Example</b>:
    *         <li><code>lastModified(new File("src/com/javatools/util/Objects.java"))</code>
    *         returns "something".</li>
    */
    ...
    */
    ...
    /**
    * Deletes a file or a directory (with all its contents, they say it is
    * dangerous)
    * 
    * @param filename
    ...
    *         <br>
    *         <b>Bad Example</b>:
    *         <li><code>deleteFile("/etc")</code> returns true if the program
    *         runs as root.</li>
    */
    ...
    * exist, they are created too. If the file exists, it is overwritten, unless
    * <code>append</code> is <b>true</b>. <code>append</code> determines
    ...
    * @return int buffer size adjusted by Moore's law: "double it every three
    *         years"
    */
    ...
    * @return file contents as a string, or null if error occurred <br>
    *         <br>
    *         <b>Example</b>:
    *         <li><code>readStringFromFile("../src/com/myjavatools/utils/FileUtils.java")</code>
    *         returns a string starting with "/**\r\n * &lt;p>Title:
    *         MyJavaTools: FileUtils handling Tools&lt;/p>\r\n*".</li>
    */
    ...
    * @return file contents as byte array, or null if error occurred <br>
    *         <br>
    *         <b>Example</b>:
    ...
    *         <br>
    *         <b>Example</b>:
    *         <li><code>readBytesFromFile("../src/com/myjavatools/utils/FileUtils.java")</code>
    ...
    */
    ...
    /**
    * <p>
    * Description: The interface is used to define filters for filtering data in
    * pipes. Filters, similar to those in JSPs, can modify the bytes going from
    * one end of the pipe to another, or just sniff them and act based on
    * results - e.g. count bytes, calculate crc, you name it.
    * </p>
    */
    ...
    /**
    * <p>
    * Description: Buffering filter stores some data, and these data can be
    * retrieved later.
    * 
    * @see #ByteFilter
    */
    public interface BufferingFilter extends ByteFilter {
        ...
        /**
       * gets data stored as a result of filtering; no assumption regarding the
       * nature of the data.
       * 
       * @return byte[]
       */
    ...
    /**
    * pipes data from input stream to output stream, possibly pumping them
    * through the filter (if any)
    * 
    * @param in InputStream the source of data
    * @param out OutputStream where the output goes, filtered if filter is
    *           present, or unfiltered otherwise
    * @param isBlocking boolean whether input is blocking (in this case the
    *           maximum amount is read in one operation; for nonblocking
    *           in.available() determines how many bytes can be read)
    * @param filter ByteFilter the filter that applies to data; can be null
    * @throws IOException when input or output fails see the test for examples
    */
    ...
    * @param out Writer where the output goes, filtered if filter is present, or
    *           unfiltered otherwise
    * @return boolean true if successful, false otherwise see the test for
    *         examples
    */
    ...
    * abstract pathname. The reason for this specific method is Java bug
    * 4243868: http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=4243868 It
    * does not always work without the trick...
    * 
    ...
    * @param left
    * @param right
    * @return -1 if left file is older or shorter or "smaller" than right 0 if
    *         files are equal 1 if right file is older or shorter or "smaller"
    *         than left <br>
    *         <br>
    *         <b>Example</b>:
    *         <li><code>copy(new File(myHomeDir, "contents.xml"), new File(mySite, "contents.rss");<br>
    * compare(new File(myHomeDir, "contents.xml"), new File(mySite, "contents.rss")</code>
    *         returns -1 </li>
    */
    ...
    /**
    * synchronizes two directories, <code>left/what</code> and
    * <code>right/what</code>
    * 
    ...
    * @return boolean true if success <br>
    *         <br>
    *         <b>Example</b>:
    ...
    * @return boolean true if success, false otherwise <br>
    *         <br>
    *         <b>Example</b>:
    ...
    */
    ...
    /**
    * installs files from a resource archive Reads a specified resource for
    * aspecified class, unzips it to a specified directory
    * 
    * @param clazz Class the class whose package contains the archive as a
    *           resource
    * @param resourceArchiveName String the name of resource containing the
    *           archive
    ...
    */
    ...
    /**
    * returns an Iterable&lt;Byte> enclosure that scans over the bytes returned
    * by InputStream
    * 
    * @param is InputStream the stream to scan
    * @return Iterable&lt;Byte> the enclosure The Iterator returned by the
    *         Iterable is a singleton; you cannot expect to get a fresh Iterator
    *         by calling iterator() several times. <br>
    *         <br>
    *         <b>Example</b>:<br>
    *         <br>
    *         <code>
    ...
    * @return Iterable&lt;Byte> the Iterable <br>
    *         <br>
    *         <b>Example</b>:<br>
    *         <br>
    *         <code><pre>
    ...
    */
    ...
    /**
    * returns an Iterable&lt;Character> enclosure that scans over the characters
    * returned by Reader
    * 
    * @param reader Reader the reader to scan
    * @return Iterable&lt;Character> the Iterable enclosure The Iterator
    *         returned by the Iterable is a singleton; you cannot expect to get
    *         a fresh Iterator by calling iterator() several times. <br>
    *         Usage example:<br>
    *         <br>
    *         <code>
    ...
    * 
    * @param file File the file to scan
    * @return Iterable&lt;Character> the Iterable <br>
    *         Usage example:<br>
    *         <br>
    *         <code>
    ...
    */
    ...
    /**
    * returns an Iterable&lt;String> enclosure that scans over the lines
    * returned by Reader
    * 
    * @param reader Reader the reader to scan
    * @return Iterable&lt;String> the Iterable enclosure The Iterator returned
    *         by the Iterable is a singleton; you cannot expect to get a fresh
    *         Iterator by calling iterator() several times. <br>
    *         Usage example:<br>
    *         <br>
    *         <code>
    ...
    * 
    * @param file File the file to scan
    * @return Iterable&lt;String> the Iterable Usage example: <code>
    ...
    */
    ...
    /**
    * Returns an Iterable&lt;File> that scans, recursively, through the
    * directory structure. Traversal order is depth-first, preorder
    * 
    * @param folder File starting directory
    * @return Iterable&lt;File> the tree scanner Usage examples: <code>
    ...
    */
    ...
    /**
    * Returns an Iterable&lt;File> that scans, recursively, through the
    * directory structure. Traversal order is depth-first, postorder
    * 
    * @param folder File starting directory
    * @return Iterable&lt;File> the tree scanner Usage examples: <code>
    ...
    * @return Iterable&lt;File> the scanner <br>
    *         Usage example:<br>
    *         <br>
    *         <code>
...
/**
 * FolderIterator is an Iterator that walks over the tree of subfolders in a
 * folder Traversal order is depth-first; can be preorder or postorder. To do
 * breadth-first, we would need a queue; you are welcome to implement it - I do
 * not remember ever requiring breadth-first traversal order for file folders
 * since the time I learned about file folders, which was long ago.
 * 
...
final class FolderIterator implements Iterator<File> {
    ...
    */
    ...
    /**
    * returns a FolderIterator to walk through directory tree, depth-first,
    * preorder, accepting only files that FileFilter filter accepts.
    * 
    * @param folder File
    ...
    */
    ...
    /**
    * returns a FolderIterator to walk through directory tree, depth-first,
    * postorder, accepting only files that FileFilter filter accepts.
    * 
    * @param folder File
    * @param FileFilter filter
    * @return FolderIterator
...
/**
 * EmptyIterator is a helper class that does not contain any elements and throws
 * an exception when next() is called. The exception message can be customized.
 * 
 * @version 5.0
 */
