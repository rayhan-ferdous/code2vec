package ch.hsr.orm.model.diagram.navigator;
 ...
 * @generated
 */
public class OrmmetaNavigatorLinkHelper implements ILinkHelper {
    ...
    public IStructuredSelection findSelection(IEditorInput anInput) {
        IDiagramDocument document = OrmmetaDiagramEditorPlugin.getInstance().getDocumentProvider().getDiagramDocument(anInput);
        if (document == null) {
        ...
        if (file != null) {
            OrmmetaNavigatorItem item = new OrmmetaNavigatorItem(diagram, file, false);
