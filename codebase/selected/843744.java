...
public class RingingImpl extends AsteriskActionStepImpl implements Ringing {
   ...
   * <!-- end-user-doc -->
    ...
    public SafiCall getCall1() {
        if (call1 != null && call1.eIsProxy()) {
            ...
            if (call1 != oldCall1) {
                if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActionstepPackage.RINGING__CALL1, oldCall1, call1));
            }
        }
        return call1;
    }
   ...
   * <!-- end-user-doc -->
    ...
    public void setCall1(SafiCall newCall1) {
        ...
        call1 = newCall1;
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.RINGING__CALL1, oldCall1, call1));
    }
   ...
   * <!-- end-user-doc -->
    ...
    public void setDuration(int newDuration) {
        ...
        if (eNotificationRequired()) eNotify(new ENotificationImpl(this, Notification.SET, ActionstepPackage.RINGING__DURATION, oldDuration, duration));
    }
        ...
        if (baseClass == CallConsumer1.class) {
            switch(baseFeatureID) {
                case CallPackage.CALL_CONSUMER1__CALL1:
                    return ActionstepPackage.RINGING__CALL1;
                default:
                    return -1;
            }
        }
