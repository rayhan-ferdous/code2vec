...
import java.util.*;
import com.creditors.vo.TAViewVO;
import com.util.comparator.*;
import com.util.table.*;

public class TAViewModel implements ITableModel {

    protected TAViewVO fTotal;

    protected TAViewVO[] fTableData;
    ...
    public Object getValueAt(int pRow, String pColumn) {
        TAViewVO vo = fTableData[fSortOrder[pRow]];
