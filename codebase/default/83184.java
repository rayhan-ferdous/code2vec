...
public class TableSorter extends AbstractFilter {
    ...
    public int compareRowsByColumn(int row1, int row2, int column) {
        ...
        if (type == Integer.class) {
            int n1 = ((Integer) data.getValueAt(row1, column)).intValue();
            int n2 = ((Integer) data.getValueAt(row2, column)).intValue();
            if (n1 < n2) {
                return -1;
            } else if (n1 > n2) {
                return 1;
            ...
            if (JNConfig.debugging) {
                System.out.println("Being asked to compare unknown type: " + type);
            }
            if (result < 0) return -1; else if (result > 0) return 1; else return 0;
        }
    }
