...
public class DescriptionGenerator extends Doclet {
    ...
    static class XMLGenerator {
        ...
        void dump() throws TransformerFactoryConfigurationError, FileNotFoundException, TransformerException {
            ...
            t.transform(new DOMSource(mDoc), new StreamResult(new FileOutputStream(file)));
        }
        ...
        void mergeEmptySuites(Node suiteElem) {
            ...
            if (suiteChildren.size() > 1) {
                ...
                String newName = getAttribute(suiteElem, ATTRIBUTE_NAME) + "." + getAttribute(child, ATTRIBUTE_NAME);
        ...
        void appendSuiteToElement(Node elem, TestClass testSuite) {
            ...
            for (Node child : children) {
                String childName = child.getAttributes().getNamedItem(ATTRIBUTE_NAME).getNodeValue();
            ...
            if (cases.isEmpty()) {
                ...
                for (TestMethod caze : cases) {
                    ...
                    if (caze.mDescription != null && !caze.mDescription.equals("")) {
                        caseNode.appendChild(mDoc.createElement(TAG_DESCRIPTION)).setTextContent(caze.mDescription);
                    }
                }
            }
        }
        ...
        Collection<TestMethod> getTestMethods(ClassDoc clazz) {
            ...
            while (iterator.hasNext()) {
                ...
                if (name.startsWith("test")) {
                    cases.add(new TestMethod(name, method.commentText(), controller, knownFailure, isBroken));
                }
            }
            return cases;
        }
    ...
    static class TestMethod {
         ...
         */
        TestMethod(String name, String description, String controller, String knownFailure, boolean isBroken) {
            mName = name;
