...
public   class   pspdiffDialog   extends   TinyCGIBase   implements   ActionListener  ,  Runnable  { 
...
if  (  e  .  getSource  (  )  ==  closeButton  )  closeWindow  (  )  ;  else   if  (  e  .  getSource  (  )  ==  compareButton  )  compare  (  )  ;  else   if  (  e  .  getSource  (  )  ==  browseA  )  browseFile  (  fileA  )  ;  else   if  (  e  .  getSource  (  )  ==  browseB  )  browseFile  (  fileB  )  ;  else   if  (  cancelButton  !=  null  &&  e  .  getSource  (  )  ==  cancelButton  )  userCancelled  =  true  ; 
} 
...
if  (  currentTaskLabel  !=  null  )  currentTaskLabel  .  setText  (  filename  )  ; 
} 
...
for  (  int   i  =  files  .  length  ;  i  --  >  0  ;  )  if  (  !  "."  .  equals  (  files  [  i  ]  )  &&  !  ".."  .  equals  (  files  [  i  ]  )  )  filenames  .  add  (  files  [  i  ]  )  ; 
} 
