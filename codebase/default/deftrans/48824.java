...
ThreadLock  .  getInstance  (  )  .  getLock  (  )  ; 
try  { 
showReportPage  (  urlData  ,  outStream  )  ; 
}  finally  { 
ThreadLock  .  getInstance  (  )  .  releaseLock  (  )  ; 
} 
return  ; 
...
if  (  si  !=  null  )  { 
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "info.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "schedulelist.html"  )  ; 
