...
if  (  referer  ==  null  ||  !  referer  .  getPath  (  )  .  endsWith  (  script  )  )  useCaution  (  )  ; 
} 
if  (  referer  ==  null  )  { 
useCaution  (  )  ; 
} 
if  (  !  referer  .  getProtocol  (  )  .  equals  (  "http"  )  &&  !  referer  .  getProtocol  (  )  .  equals  (  "https"  )  )  { 
useCaution  (  )  ; 
} 
...
private   void   redirectTo  (  String   filename  ,  File   result  )  throws   TinyCGIException  { 
if  (  !  nameIsSafe  (  result  )  )  throw   new   TinyCGIException  (  403  ,  "Forbidden"  )  ; 
try  { 
...
if  (  remoteRequest  ||  forceRedirect  ||  "redirect"  .  equals  (  docOpenSetting  )  )  out  .  print  (  "Location: "  +  result  .  toURL  (  )  +  "\r\n\r\n"  )  ;  else  { 
