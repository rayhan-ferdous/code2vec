...
try  { 
FileInputStream   fileStream  =  new   FileInputStream  (  dataPath  +  "server.prop"  )  ; 
serverProp  .  load  (  fileStream  )  ; 
fileStream  .  close  (  )  ; 
}  catch  (  Exception   e  )  { 
...
FileInputStream   fileStream  =  new   FileInputStream  (  "version.prop"  )  ; 
verProp  .  load  (  fileStream  )  ; 
...
fos  =  new   FileOutputStream  (  this  .  getProperty  (  "path.data"  )  +  File  .  separator  +  "AgentMap.sof"  )  ; 
...
DllWrapper   wrapper  =  new   DllWrapper  (  )  ; 
String   dataPath  =  wrapper  .  getAllUserPath  (  )  ; 
FileOutputStream   fileStream  =  new   FileOutputStream  (  dataPath  +  "server.prop"  )  ; 
serverProp  .  store  (  fileStream  ,  "TV Scheduler Pro Server Properties"  )  ; 
fileStream  .  close  (  )  ; 
} 
...
ObjectOutputStream   oos  =  null  ; 
if  (  timesBytes  ==  null  )  { 
fos  =  new   FileOutputStream  (  this  .  getProperty  (  "path.data"  )  +  File  .  separator  +  "Times.sof"  )  ; 
oos  =  new   ObjectOutputStream  (  fos  )  ; 
}  else  { 
