...
public   OsProcess  (  String   ProgramName  ,  String   args  [  ]  ,  String   mainClass  ,  String   classesNeededFilename  ,  String   classpath  ,  Debugger   debugger  )  { 
...
public   OsProcess  (  int   processID  ,  String   mainClass  ,  String   classesNeededFilename  ,  String   classpath  ,  Debugger   debugger  )  throws   OsProcessException  { 
this  .  debugger  =  debugger  ; 
...
if  (  isExit  (  e  .  status  )  )  System  .  out  .  println  (  "Program has exited."  )  ;  else   if  (  isKilled  (  e  .  status  )  )  System  .  out  .  println  (  System  .  currentTimeMillis  (  )  +  ": Program terminated by user."  )  ; 
} 
} 
...
int   threadPointer  ; 
try  { 
VM_Field   field  =  bmap  .  findVMField  (  "com.ibm.JikesRVM.VM_Scheduler"  ,  "threads"  )  ; 
int   address  =  mem  .  readTOC  (  field  .  getOffset  (  )  )  ; 
int   arraySize  =  mem  .  read  (  address  +  VM_ObjectModel  .  getArrayLengthOffset  (  )  )  ; 
...
field  =  bmap  .  findVMField  (  "com.ibm.JikesRVM.VM_Processor"  ,  "readyQueue"  )  ; 
int   fieldOffset  =  field  .  getOffset  (  )  ; 
...
try  { 
VM_Field   field  =  bmap  .  findVMField  (  "com.ibm.JikesRVM.VM_Scheduler"  ,  queueName  )  ; 
