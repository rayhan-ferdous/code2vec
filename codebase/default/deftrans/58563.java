...
public   class   GenericListIteratorWriter  { 
...
System  .  out  .  println  (  "\n"  +  msg  +  "\nUsage:"  +  "\njostraca java.lang.GenericListIterator listiterator-spec-file.txt"  +  "\njostraca java.lang.GenericListIterator Name"  +  "\njostraca java.lang.GenericListIterator Name package.name"  +  "\n"  )  ; 
System  .  exit  (  1  )  ; 
} 
...
GenericListIteratorWriter   codeWriter  =  new   GenericListIteratorWriter  (  )  ; 
try  { 
...
String   noFirstArgMsg  =  "Please specify ListIterator name and package or listiterator-spec-file.txt."  ; 
...
_setFileNameSuffix  (  "ListIterator.java"  )  ; 
...
_insert  (  type  )  ; 
_insert  (  "ListIterator for Java 1.3 */\npublic class "  )  ; 
_insert  (  type  )  ; 
_insert  (  "ListIterator extends "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Iterator {\n\n  ListIterator iListIterator;\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "ListIterator( ListIterator rListIterator ) {\n    super( rListIterator );\n    iListIterator = rListIterator;\n  }\n\n  public void add( "  )  ; 
_insert  (  type  )  ; 
_insert  (  " r"  )  ; 
_insert  (  type  )  ; 
_insert  (  " ) {\n    "  )  ; 
