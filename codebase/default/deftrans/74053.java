...
public   class   GenericListWriter  { 
...
System  .  out  .  println  (  "\n"  +  msg  +  "\nUsage:"  +  "\njostraca java.lang.GenericList list-spec-file.txt"  +  "\njostraca java.lang.GenericList Name"  +  "\njostraca java.lang.GenericList Name package.name"  +  "\n"  )  ; 
System  .  exit  (  1  )  ; 
} 
...
GenericListWriter   codeWriter  =  new   GenericListWriter  (  )  ; 
try  { 
...
String   noFirstArgMsg  =  "Please specify List name and package or list-spec-file.txt."  ; 
...
_insert  (  type  )  ; 
_insert  (  "List for Java 1.3 */\npublic class "  )  ; 
_insert  (  type  )  ; 
_insert  (  "List extends "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection {\n\n  private List iList;\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "List( List rList ) {\n    super( rList );\n    iList = rList;\n  }\n\n\n  public void add( int rIndex, "  )  ; 
_insert  (  type  )  ; 
_insert  (  " r"  )  ; 
_insert  (  type  )  ; 
_insert  (  " ) {\n    "  )  ; 
...
_insert  (  ";\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iList.add( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n  public boolean addAll( "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection ) {\n    return iList.addAll( r"  )  ; 
_insert  (  type  )  ; 
...
_insert  (  ";\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iList.contains( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n  public boolean containsAll( "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection ) {\n    return iList.containsAll( r"  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection.getCollection() );\n  }\n\n  public boolean equals( Object rObject ) {\n    if( rObject instanceof "  )  ; 
_insert  (  type  )  ; 
_insert  (  "List ) {\n      return iList.equals( (("  )  ; 
_insert  (  type  )  ; 
_insert  (  "List)rObject).getList() );\n    }\n    else {\n      return false;\n    }\n  }\n\n  public int hashCode() {\n    return iList.hashCode();\n  }\n\n  public int indexOf( "  )  ; 
_insert  (  type  )  ; 
_insert  (  " r"  )  ; 
_insert  (  type  )  ; 
_insert  (  " ) {\n    "  )  ; 
...
_insert  (  ";\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iList.indexOf( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n  public boolean isEmpty() {\n    return iList.isEmpty();\n  }\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Iterator iterator() {\n    return new "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Iterator( iList.iterator() );\n  }\n\n  public int lastIndexOf( "  )  ; 
_insert  (  type  )  ; 
_insert  (  " r"  )  ; 
_insert  (  type  )  ; 
_insert  (  " ) {\n    "  )  ; 
...
_insert  (  ";\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iList.lastIndexOf( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "ListIterator listIterator() {\n    return new "  )  ; 
_insert  (  type  )  ; 
_insert  (  "ListIterator( iList.listIterator() );\n  }\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "ListIterator listIterator( int rIndex ) {\n    return new "  )  ; 
_insert  (  type  )  ; 
_insert  (  "ListIterator( iList.listIterator( rIndex ) );\n  }\n\n  public "  )  ; 
_insert  (  type  )  ; 
...
_insert  (  ";\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iList.remove( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n  public boolean removeAll( "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection ) {\n    return iList.removeAll( r"  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection.getCollection() );\n  }\n\n  public boolean retainAll( "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection ) {\n    return iList.retainAll( r"  )  ; 
_insert  (  type  )  ; 
_insert  (  "Collection.getCollection() );\n  }\n\n  public int size() {\n    return iList.size();\n  }\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "List subList( int rFromIndex, int rToIndex ) {\n    return new "  )  ; 
_insert  (  type  )  ; 
_insert  (  "List( iList.subList( rFromIndex, rToIndex ) );\n  }\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "[] toArray() {\n    return toArray( new "  )  ; 
_insert  (  type  )  ; 
_insert  (  "[] {} );\n  }    \n\n  public "  )  ; 
