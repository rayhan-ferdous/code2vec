...
out  .  append  (  "</td></tr>\n"  )  ; 
value  =  store  .  getProperty  (  "schedule.noaachan"  )  ; 
out  .  append  (  "<tr><td align='left'>No Channel in Matchlist Name</td><td>"  )  ; 
options  =  new   HashMap  <  String  ,  String  >  (  )  ; 
options  .  put  (  "0"  ,  "False"  )  ; 
options  .  put  (  "1"  ,  "True"  )  ; 
out  .  append  (  htmlDropMenu  (  options  ,  "schedule.noaachan"  ,  value  ,  ""  )  )  ; 
out  .  append  (  "</td><td><img style='cursor:hand;cursor:pointer;' border=0 src='/images/help24.png' alt='help' align='absmiddle' onClick=\"showHelp('schedule.noaaChan');\" width='24' height='24'>"  )  ; 
out  .  append  (  "</td></tr>\n"  )  ; 
out  .  append  (  "<tr><td colspan='3' align='left' style='border: 1px solid rgb(255, 255, 255);'>"  )  ; 
