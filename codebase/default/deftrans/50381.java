...
if  (  studyUIDSuffix  !=  null  )  ds  .  putUI  (  Tags  .  StudyInstanceUID  ,  ds  .  getString  (  Tags  .  StudyInstanceUID  ,  ""  )  +  studyUIDSuffix  )  ; 
if  (  seriesUIDSuffix  !=  null  )  ds  .  putUI  (  Tags  .  SeriesInstanceUID  ,  ds  .  getString  (  Tags  .  SeriesInstanceUID  ,  ""  )  +  seriesUIDSuffix  )  ; 
if  (  instUIDSuffix  !=  null  )  ds  .  putUI  (  Tags  .  SOPInstanceUID  ,  ds  .  getString  (  Tags  .  SOPInstanceUID  ,  ""  )  +  instUIDSuffix  )  ; 
} 
...
pollDirSrv  .  setOpenRetryPeriod  (  Integer  .  parseInt  (  cfg  .  getProperty  (  "poll-retry-open"  ,  "60"  )  )  *  1000L  )  ; 
