...
public   String   umaxlevels  [  ]  =  {  translate  (  "umaxlevel.5"  )  ,  translate  (  "umaxlevel.6"  )  ,  translate  (  "umaxlevel.7"  )  ,  translate  (  "umaxlevel.8"  )  ,  translate  (  "umaxlevel.9"  )  ,  translate  (  "umaxlevel.10"  )  }  ; 
...
public   String   unb_pagess  [  ]  =  {  translate  (  "unb_pages.0"  )  ,  translate  (  "unb_pages.1"  )  ,  translate  (  "unb_pages.2"  )  ,  translate  (  "unb_pages.3"  )  ,  translate  (  "unb_pages.4"  )  ,  translate  (  "unb_pages.5"  )  ,  translate  (  "unb_pages.6"  )  }  ; 

private   int   radius  =  0  ; 

public   int   colourtext  =  1  ; 

public   String   colourtexts  [  ]  =  {  translate  (  "colourtext.0"  )  ,  translate  (  "colourtext.1"  )  }  ; 

public   int   colouroption  =  0  ; 

public   String   colouroptions  [  ]  =  {  translate  (  "colouroption.0"  )  ,  translate  (  "colouroption.1"  )  ,  translate  (  "colouroption.2"  )  }  ; 
...
public   String   dateformats  [  ]  =  {  translate  (  "dateformat.0"  )  ,  translate  (  "dateformat.1"  )  ,  translate  (  "dateformat.2"  )  }  ; 
...
public   String   uenc_choices  [  ]  =  {  translate  (  "uenc_choice.0"  )  ,  translate  (  "uenc_choice.1"  )  ,  translate  (  "uenc_choice.2"  )  }  ; 

public   int   ufont_name  =  0  ; 

public   String   ufont_names  [  ]  =  {  translate  (  "ufont_name.0"  )  ,  translate  (  "ufont_name.1"  )  ,  translate  (  "ufont_name.2"  )  ,  translate  (  "ufont_name.3"  )  ,  translate  (  "ufont_name.4"  )  ,  translate  (  "ufont_name.5"  )  }  ; 
...
numindilines  +=  pCell  .  add  (  put_full_name  (  person  ,  0  ,  1  ,  getel  (  levellength  ,  level  )  )  +  getDateString  (  birth  (  person  )  ,  death  (  person  )  ,  dateformat  )  ,  numindilines  )  ; 
writer  .  print  (  pCell  .  get  (  ahnen  ,  info  )  )  ; 
} 
if  (  printmarr  )  { 
if  (  marrest  &&  false  )  { 
...
if  (  offset  >=  intarray  .  length  )  return   0  ;  else   return   intarray  [  offset  ]  ; 
} 
