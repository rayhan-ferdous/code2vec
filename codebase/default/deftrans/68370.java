...
item  =  it  ; 
try  { 
minSpace  =  Integer  .  parseInt  (  store  .  getProperty  (  "Capture.minSpace"  )  )  ; 
}  catch  (  Exception   e  )  { 
} 
} 
...
long   freeSpace  =  new   File  (  capFile  .  getParent  (  )  )  .  getFreeSpace  (  )  /  (  1024  *  1024  )  ; 
if  (  freeSpace  <  minSpace  )  { 
item  .  setState  (  ScheduleItem  .  RESTART  )  ; 
item  .  setStatus  (  "Restarting"  )  ; 
item  .  log  (  "Minimum free space limit hit : "  +  freeSpace  +  " "  +  capFileName  )  ; 
System  .  out  .  println  (  this  +  " : Minimum free space limit hit : "  +  freeSpace  +  " "  +  capFileName  )  ; 
...
long   freeSpace  =  new   File  (  capFile  .  getAbsoluteFile  (  )  .  getParent  (  )  )  .  getFreeSpace  (  )  ; 
...
long   freeSpace  =  new   File  (  capPath  )  .  getFreeSpace  (  )  /  (  1024  *  1024  )  ; 
if  (  sizeEstimation  >  0  )  item  .  log  (  "Size Estimation ("  +  sizeEstimation  +  ")"  )  ; 
if  (  freeSpace  !=  0  &&  (  (  freeSpace  -  sizeEstimation  )  >  (  minSpace  *  2  )  )  )  { 
item  .  log  (  "Using Path("  +  pathIndex  +  ") "  +  capPath  +  " "  +  freeSpace  )  ; 
System  .  out  .  println  (  this  +  " : Using Path("  +  pathIndex  +  ") "  +  capPath  +  " "  +  freeSpace  )  ; 
return   capPath  ; 
}  else  { 
item  .  log  (  "Not enough space("  +  pathIndex  +  ") "  +  capPath  +  " "  +  freeSpace  )  ; 
System  .  out  .  println  (  this  +  " : Not enough space("  +  pathIndex  +  ") "  +  capPath  +  " "  +  freeSpace  )  ; 
} 
} 
...
item  .  log  (  "No path found with enough free space ("  +  minSpace  +  ")"  )  ; 
System  .  out  .  println  (  this  +  " : No path found with enough free space ("  +  minSpace  +  ")"  )  ; 
} 
}  catch  (  Exception   e  )  { 
...
public   void   deleteCapture  (  long   minSize  )  { 
