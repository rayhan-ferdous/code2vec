...
public   final   int   FILE_SIZE  =  520000  ; 
...
if  (  acqtimestart  ==  -  1  )  { 
IJ  .  log  (  "AcquisitionTime tag not found in "  +  img  .  getTitle  (  )  )  ; 
return   false  ; 
} 
...
if  (  dot  ==  -  1  )  { 
IJ  .  log  (  "Unable to parse AcquisitionTime tag in "  +  img  .  getTitle  (  )  )  ; 
return   false  ; 
} 
...
if  (  imnumstart  ==  -  1  )  { 
IJ  .  log  (  "ImageNumber tag not found in "  +  img  .  getTitle  (  )  )  ; 
return   false  ; 
} 
int   imnumend  =  infoProperty  .  indexOf  (  "0020,00"  ,  (  imnumstart  +  2  )  )  ; 
if  (  imnumend  ==  -  1  )  { 
IJ  .  log  (  "Unable to parse ImageNumber tag in "  +  img  .  getTitle  (  )  )  ; 
return   false  ; 
} 
...
if  (  imtimestart  ==  -  1  )  { 
IJ  .  log  (  "ImageTime tag not found in "  +  img  .  getTitle  (  )  )  ; 
return   false  ; 
} 
