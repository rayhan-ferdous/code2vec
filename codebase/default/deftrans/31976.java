...
public   class   FullGenericVectorWriter  { 
...
System  .  out  .  println  (  "\n"  +  msg  +  "\nUsage:"  +  "\njostraca java.lang.FullGenericVector vector-spec-file.txt"  +  "\njostraca java.lang.FullGenericVector Name"  +  "\njostraca java.lang.FullGenericVector Name package.name"  +  "\n"  )  ; 
System  .  exit  (  1  )  ; 
} 
...
FullGenericVectorWriter   codeWriter  =  new   FullGenericVectorWriter  (  )  ; 
try  { 
...
String   noFirstArgMsg  =  "Please specify Vector name and package or vector-spec-file.txt."  ; 
...
_setFileNameSuffix  (  "Vector.java"  )  ; 
...
_insert  (  ctype  )  ; 
_insert  (  "Collection ) {\n    iVector = new Vector( "  )  ; 
makeParameter  (  ctype  ,  "Collection"  )  ; 
_insert  (  " );\n  }\n\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Vector( int rInitialCapacity ) {\n    iVector = new Vector( rInitialCapacity );\n  }\n\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Vector( int rInitialCapacity, int rCapacityIncrement ) {\n    iVector = new Vector( rInitialCapacity, rCapacityIncrement );\n  }\n\n\n  public void add( int rIndex, "  )  ; 
_insert  (  type  )  ; 
_insert  (  " rValue ) {\n    "  )  ; 
_insert  (  type  )  ; 
_insert  (  " value_"  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iVector.add( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n\n  public synchronized boolean addAll( "  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection ) {\n    return iVector.addAll( "  )  ; 
makeParameter  (  ctype  ,  "Collection"  )  ; 
_insert  (  " );\n  }\n\n\n  public synchronized boolean addAll( int rIndex, "  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection ) {\n    return iVector.addAll( rIndex, "  )  ; 
makeParameter  (  ctype  ,  "Collection"  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    iVector.addElement( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n\n  public int capacity() {\n    return iVector.capacity();\n  }\n\n\n  public void clear() {\n    iVector.clear();\n  }\n\n\n  public synchronized Object clone() {\n    return new "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Vector( (Vector)iVector.clone() );\n  }\n\n\n  public boolean contains( "  )  ; 
_insert  (  type  )  ; 
_insert  (  " rValue ) {\n    "  )  ; 
_insert  (  type  )  ; 
_insert  (  " value_"  )  ; 
...
_insert  (  " new "  )  ; 
_insert  (  typeObject  )  ; 
_insert  (  "[ rArray.length ];\n    iVector.copyInto( objectArray_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n\n    "  )  ; 
_insert  (  type  )  ; 
_insert  (  "[] "  )  ; 
...
_insert  (  "\n\n  }\n\n\n  public synchronized "  )  ; 
_insert  (  type  )  ; 
_insert  (  " elementAt( int rIndex ) {\n    Object object = iVector.elementAt( rIndex );\n    "  )  ; 
...
_insert  (  "( iVector.elements() );\n  }\n\n\n  public synchronized void ensureCapacity( int rMinCapacity ) {\n    iVector.ensureCapacity( rMinCapacity );\n  }\n\n\n  public synchronized boolean equals( Object rObject ) {\n    if( rObject instanceof "  )  ; 
_insert  (  type  )  ; 
_insert  (  "Vector ) {\n      return iVector.equals( (("  )  ; 
_insert  (  type  )  ; 
_insert  (  "Vector)rObject).getVector() );\n    } \n    else {\n      return iVector.equals( rObject );\n    }\n  }\n\n\n  public synchronized "  )  ; 
_insert  (  type  )  ; 
_insert  (  " firstElement() {\n    Object object = iVector.firstElement();\n    "  )  ; 
inlineObjectValue  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return value_"  )  ; 
_insert  (  type  )  ; 
_insert  (  ";    \n  }\n\n\n  public synchronized "  )  ; 
_insert  (  type  )  ; 
_insert  (  " get( int rIndex ) {\n    Object object = iVector.get( rIndex );\n    "  )  ; 
inlineObjectValue  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return value_"  )  ; 
_insert  (  type  )  ; 
_insert  (  ";    \n  }\n\n\n  public synchronized int hashCode() {\n    return iVector.hashCode();\n  }\n\n\n  public int indexOf( "  )  ; 
_insert  (  type  )  ; 
_insert  (  " rValue ) {\n    "  )  ; 
_insert  (  type  )  ; 
_insert  (  " value_"  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iVector.indexOf( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n  public synchronized int indexOf( "  )  ; 
_insert  (  type  )  ; 
_insert  (  " rValue, int rIndex ) {\n    "  )  ; 
_insert  (  type  )  ; 
_insert  (  " value_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " = rValue;\n    "  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    iVector.insertElementAt( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  ", rIndex );\n  }\n\n\n  public boolean isEmpty() {\n    return iVector.isEmpty();\n  }\n\n\n  public synchronized "  )  ; 
_insert  (  type  )  ; 
_insert  (  " lastElement() {\n    Object object = iVector.lastElement();\n    "  )  ; 
inlineObjectValue  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return value_"  )  ; 
_insert  (  type  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iVector.lastIndexOf( object_"  )  ; 
_insert  (  type  )  ; 
...
_insert  (  ", rIndex );\n  }\n\n\n  public synchronized "  )  ; 
_insert  (  type  )  ; 
_insert  (  " remove( int rIndex ) {\n    Object object = iVector.remove( rIndex );\n    "  )  ; 
inlineObjectValue  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return value_"  )  ; 
_insert  (  type  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iVector.remove( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n\n  public synchronized boolean removeAll( "  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection ) {\n    return iVector.removeAll( "  )  ; 
makeParameter  (  ctype  ,  "Collection"  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    return iVector.removeElement( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  " );\n  }\n\n\n  public synchronized void removeElementAt( int rIndex ) {\n    iVector.removeElementAt( rIndex );\n  }\n\n\n  public synchronized boolean retainAll( "  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection r"  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Collection ) {\n    return iVector.retainAll( "  )  ; 
makeParameter  (  ctype  ,  "Collection"  )  ; 
_insert  (  " );\n  }\n\n\n  public synchronized "  )  ; 
_insert  (  type  )  ; 
_insert  (  " set( int rIndex, "  )  ; 
_insert  (  type  )  ; 
_insert  (  " rValue ) {\n    "  )  ; 
_insert  (  type  )  ; 
_insert  (  " value_"  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    Object object = iVector.set( rIndex, object_"  )  ; 
_insert  (  type  )  ; 
...
_insert  (  " = rValue;\n    "  )  ; 
inlineMakeObject  (  type  ,  typeObject  )  ; 
_insert  (  "\n    iVector.setElementAt( object_"  )  ; 
_insert  (  type  )  ; 
_insert  (  ", rIndex );\n  }\n\n\n  public synchronized void setSize( int rNewSize ) {\n    iVector.setSize( rNewSize );\n  }\n\n\n  public int size() {\n\treturn iVector.size();\n  }\n\n\n  public "  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "List subList( int rFromIndex, int rToIndex ) {\n    "  )  ; 
newContainer  =  0  <  ctype  .  length  (  )  ?  "new "  +  ctype  +  "List"  :  ""  ; 
_insert  (  "\n    return "  )  ; 
_insert  (  newContainer  )  ; 
_insert  (  "( iVector.subList( rFromIndex, rToIndex ) );\n  }\n\n\n  public "  )  ; 
_insert  (  type  )  ; 
_insert  (  "[] toArray() {\n    return toArray( new "  )  ; 
_insert  (  type  )  ; 
_insert  (  "[] {} );\n  }    \n\n\n  public "  )  ; 
...
_insert  (  type  )  ; 
_insert  (  "Vector:\"+iVector.toString();\n  }\n\n\n  public synchronized void trimToSize() {\n    iVector.trimToSize();\n  }\n\n\n  public Vector getVector() {\n    return iVector;\n  }\n\n\n  /* Methods which java.lang.Vector inherits << */\n\n  public "  )  ; 
_insert  (  ctype  )  ; 
_insert  (  "Iterator iterator() {\n    "  )  ; 
newContainer  =  0  <  ctype  .  length  (  )  ?  "new "  +  ctype  +  "Iterator"  :  ""  ; 
_insert  (  "\n    return "  )  ; 
_insert  (  newContainer  )  ; 
_insert  (  "( iVector.iterator() );\n  }\n\n\n  /* Methods which java.lang.Vector inherits >> */\n\n\n\n  private "  )  ; 
_insert  (  type  )  ; 
