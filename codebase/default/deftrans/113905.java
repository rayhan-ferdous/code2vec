...
static   boolean   showFPRsPreference  =  false  ; 
...
public   Debugger  (  int   bp  ,  String   runner  ,  boolean   rawMode  ,  boolean   interpreted  ,  String   init_macro  ,  JDPCommandInterface   console  ,  boolean   _viewBoot  )  { 
Platform  .  init  (  )  ; 
...
ret  .  append  (  "  showFPRs = "  )  ; 
if  (  showFPRsPreference  )  ret  .  append  (  " true\n"  )  ;  else   ret  .  append  (  " false\n"  )  ; 
jdp_console  .  writeOutput  (  ret  .  toString  (  )  )  ; 
...
if  (  args  [  1  ]  .  equals  (  "true"  )  )  showFPRsPreference  =  true  ;  else   if  (  args  [  1  ]  .  equals  (  "false"  )  )  showFPRsPreference  =  false  ;  else  { 
...
if  (  hexString  .  startsWith  (  "0x"  )  ||  hexString  .  startsWith  (  "0X"  )  )  hexString  =  hexString  .  substring  (  2  )  ;  else  { 
