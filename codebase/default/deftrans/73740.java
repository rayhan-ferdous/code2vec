...
return  ; 
}  else   if  (  "21"  .  equals  (  urlData  .  getParameter  (  "action"  )  )  )  { 
outStream  .  write  (  nownextEPG  (  urlData  )  )  ; 
return  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-sourceSettings.html"  )  ; 
...
String   email  =  urlData  .  getParameter  (  "email"  )  ; 
if  (  reload  !=  null  &&  reload  .  equals  (  "1"  )  )  { 
guide  .  loadXMLTV  (  buff  ,  0  )  ; 
} 
if  (  rescan  !=  null  &&  rescan  .  equals  (  "1"  )  )  { 
...
String   emailServer  =  store  .  getProperty  (  "email.server"  )  ; 
String   emailTo  =  store  .  getProperty  (  "email.to"  )  ; 
String   emailFrom  =  store  .  getProperty  (  "email.from"  )  ; 
String   emailFromName  =  store  .  getProperty  (  "email.from.name"  )  ; 
if  (  emailTo  ==  null  ||  emailServer  ==  null  ||  emailFrom  ==  null  ||  emailTo  .  length  (  )  <  1  ||  emailServer  .  length  (  )  <  1  ||  emailFrom  .  length  (  )  <  1  )  { 
}  else  { 
...
private   byte  [  ]  xmlEPG  (  HTTPurl   urlData  ,  HashMap   headers  )  throws   Exception  { 
...
String   sInfo  =  ""  ; 
sInfo  =  "<a target='_imdb' href='http://www.imdb.com/Find?select=All&for="  +  URLEncoder  .  encode  (  item  .  getName  (  )  .  replaceAll  (  " "  ,  "+"  )  ,  "UTF-8"  )  +  "'>IMDB</a>&nbsp;\n"  ; 
...
buff  .  append  (  "</table>\n"  )  ; 
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-details.html"  )  ; 
...
GuideStore   guide  =  GuideStore  .  getInstance  (  )  ; 
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-reload.html"  )  ; 
outStream  .  write  (  template  .  getPageBytes  (  )  )  ; 
StringBuffer   buff  =  new   StringBuffer  (  )  ; 
guide  .  loadXMLTV  (  buff  ,  1  )  ; 
