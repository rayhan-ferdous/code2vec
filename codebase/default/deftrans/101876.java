...
Vector   items  =  matchList  .  getMatchList  (  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-matchListEditText.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-watchlist-matches.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-watchlist-report.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-watchlist.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "ImportForm.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-rescan.html"  )  ; 
...
buff  .  append  (  "<td nowrap valign='top'>"  +  conf  .  getReason  (  )  +  "</td>"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-auto-addform.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-questionDelete.html"  )  ; 
...
Vector   items  =  epgMatcher  .  getMatchListNames  (  )  ; 
String   names  =  ""  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-auto-add.html"  )  ; 
template  .  replaceAll  (  "$list"  ,  buff  .  toString  (  )  )  ; 
return   template  .  getPageBytes  (  )  ; 
} 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-autoAddAddConfirmation.html"  )  ; 
GuideStore   guide  =  GuideStore  .  getInstance  (  )  ; 
HashMap  <  String  ,  EpgMatchList  >  matchLists  =  store  .  getMatchLists  (  )  ; 
String   itemID  =  urlData  .  getParameter  (  "itemID"  )  ; 
String   wsChan  =  urlData  .  getParameter  (  "chan"  )  ; 
...
store  .  saveMatchList  (  null  )  ; 
Vector   autoAddItems  =  store  .  getEpgMatchList  (  )  ; 
...
Vector   matches  =  store  .  getEpgMatchList  (  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-matchLists.html"  )  ; 
...
PageTemplate   template  =  new   PageTemplate  (  store  .  getProperty  (  "path.template"  )  .  replace  (  '\\'  ,  File  .  separatorChar  )  +  File  .  separator  +  "epg-matchListEdit.html"  )  ; 
