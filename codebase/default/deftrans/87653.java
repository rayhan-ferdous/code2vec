...
buff  .  append  (  "<OPTION VALUE=\"4\""  )  ; 
if  (  item  .  getField  (  )  ==  EpgMatchListItem  .  FIELD_SUBTITLE  )  buff  .  append  (  " selected"  )  ; 
buff  .  append  (  ">Subtitle</OPTION>\n"  )  ; 
...
buff  .  append  (  "<OPTION VALUE=\"5\""  )  ; 
if  (  item  .  getField  (  )  ==  EpgMatchListItem  .  FIELD_TITSUBDESC  )  buff  .  append  (  " selected"  )  ; 
buff  .  append  (  ">Title,Subtitle Or Description</OPTION>\n"  )  ; 
...
boolean   NoAAChan  =  store  .  getProperty  (  "Schedule.noaachan"  )  .  equals  (  "1"  )  ; 
if  (  NoAAChan  )  { 
matchListName  =  name  ; 
} 
...
int   spanType  =  -  1  ; 
try  { 
spanType  =  Integer  .  parseInt  (  urlData  .  getParameter  (  "span_type"  )  )  ; 
}  catch  (  Exception   e  )  { 
} 
if  (  spanFromHour  >  -  1  &&  spanFromMin  >  -  1  &&  spanToHour  >  -  1  &&  spanToMin  >  -  1  &&  spanType  >  -  1  )  { 
newItem  .  setSpanData  (  spanFromHour  ,  spanFromMin  ,  spanToHour  ,  spanToMin  ,  spanType  )  ; 
matchItems  .  add  (  newItem  )  ; 
store  .  saveMatchList  (  null  )  ; 
} 
} 
...
buff  .  append  (  "title"  )  ; 
}  else   if  (  item  .  getField  (  )  ==  EpgMatchListItem  .  FIELD_SUBTITLE  )  { 
buff  .  append  (  "subtitle"  )  ; 
}  else   if  (  item  .  getField  (  )  ==  EpgMatchListItem  .  FIELD_DESCRIPTION  )  { 
buff  .  append  (  "description"  )  ; 
}  else   if  (  item  .  getField  (  )  ==  EpgMatchListItem  .  FIELD_TITSUBDESC  )  { 
buff  .  append  (  "title, subtitle or description"  )  ; 
...
buff  .  append  (  "</b> Type <b>"  +  store  .  intToStr  (  item  .  getSpanType  (  )  )  .  substring  (  1  ,  2  )  )  ; 
if  (  item  .  getSpanType  (  )  !=  0  )  buff  .  append  (  "</b> (Duration)"  )  ;  else   buff  .  append  (  "</b> (Start)"  )  ; 
buff  .  append  (  "</td>"  )  ; 
