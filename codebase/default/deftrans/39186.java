...
private   byte  [  ]  addMatchList  (  HTTPurl   urlData  ,  HashMap   headers  )  throws   Exception  { 
int   index  =  -  1  ; 
try  { 
...
private   byte  [  ]  delMatchList  (  HTTPurl   urlData  ,  HashMap   headers  )  throws   Exception  { 
int   index  =  -  1  ; 
try  { 
index  =  Integer  .  parseInt  (  urlData  .  getParameter  (  "index"  )  )  ; 
}  catch  (  Exception   e  )  { 
...
private   byte  [  ]  showDelMatchList  (  HTTPurl   urlData  ,  HashMap   headers  )  throws   Exception  { 
int   index  =  -  1  ; 
try  { 
index  =  Integer  .  parseInt  (  urlData  .  getParameter  (  "index"  )  )  ; 
}  catch  (  Exception   e  )  { 
...
private   byte  [  ]  showAddMatchList  (  HTTPurl   urlData  ,  HashMap   headers  )  throws   Exception  { 
int   index  =  -  1  ; 
try  { 
index  =  Integer  .  parseInt  (  urlData  .  getParameter  (  "index"  )  )  ; 
}  catch  (  Exception   e  )  { 
...
private   byte  [  ]  getAutoAddTable  (  HTTPurl   urlData  ,  HashMap   headers  )  throws   Exception  { 
Vector   list  =  store  .  getEpgMatchList  (  )  ; 
EpgMatch   epgMatcher  =  null  ; 
String   start  =  urlData  .  getParameter  (  "start"  )  ; 
