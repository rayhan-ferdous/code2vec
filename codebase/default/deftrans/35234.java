...
root  .  setAttribute  (  "hour"  ,  new   Integer  (  cal  .  get  (  Calendar  .  HOUR_OF_DAY  )  )  .  toString  (  )  )  ; 
root  .  setAttribute  (  "day"  ,  new   Integer  (  cal  .  get  (  Calendar  .  DATE  )  )  .  toString  (  )  )  ; 
root  .  setAttribute  (  "month"  ,  new   Integer  (  cal  .  get  (  Calendar  .  MONTH  )  +  1  )  .  toString  (  )  )  ; 
root  .  setAttribute  (  "year"  ,  new   Integer  (  cal  .  get  (  Calendar  .  YEAR  )  )  .  toString  (  )  )  ; 
Element   itemEl  =  null  ; 
Text   text  =  null  ; 
...
itemEl  =  doc  .  createElement  (  "catagory"  )  ; 
...
if  (  createdFrom  !=  null  &&  createdFrom  .  matches  (  item  )  )  { 
...
String   addLink  =  "/servlet/KBScheduleDataRes?action=11"  +  "&channel="  +  URLEncoder  .  encode  (  wsChan  ,  "UTF-8"  )  +  "&id="  +  item  .  toString  (  )  ; 
...
String   autoAddString  =  "/servlet/KBAutoAddRes?action=13&itemID="  +  id  +  "&chan="  +  URLEncoder  .  encode  (  wsChan  ,  "UTF-8"  )  ; 
