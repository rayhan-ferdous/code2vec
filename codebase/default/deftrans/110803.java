...
char   c  =  e  .  getKeyChar  (  )  ; 
String   mods  =  ""  ; 
mods  =  KeyEvent  .  getKeyModifiersText  (  e  .  getModifiers  (  )  )  ; 
if  (  mods  .  length  (  )  >  0  )  { 
append  (  mods  )  ; 
} 
if  (  i  ==  'O'  &&  e  .  getModifiers  (  )  ==  e  .  CTRL_DOWN_MASK  )  { 
append  (  "Ctrl + O"  )  ; 
} 
if  (  i  ==  e  .  VK_T  )  { 
if  (  e  .  isControlDown  (  )  )  { 
append  (  "Ctrl + T"  )  ; 
String   resp  =  JOptionPane  .  showInputDialog  (  this  ,  "New URL or Search: "  )  ; 
append  (  "goto url: "  +  resp  )  ; 
if  (  resp  .  contains  (  " "  )  )  { 
